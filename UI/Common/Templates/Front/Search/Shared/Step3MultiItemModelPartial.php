...
<div class="content item-model-wrap">
    ...
    <div class="col5 item-select">
        <label class="checkbox">
            <input type="checkbox" name="item_model_ids[]" value="<?=esc_attr($itemModel['item_model_id']);?>"<?=$itemModel['print_checked'];?> class="required" />
            <span><?=esc_html($lang['LANG_CHOOSE_TEXT']);?></span>
        </label>
    </div>
</div>