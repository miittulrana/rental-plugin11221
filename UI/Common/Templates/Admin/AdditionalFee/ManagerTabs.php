...
?>
<div class="car-rental-additional-fees-admin fleet-management-tabbed-admin <?=esc_attr($extCSS_Prefix);?>tabbed-admin fleet-management-tabbed-admin-wide <?=esc_attr($extCSS_Prefix);?>tabbed-admin-wide fleet-management-tabbed-admin <?=esc_attr($extCSS_Prefix);?>tabbed-admin bg-cyan">
	<?php if ($errorMessage != ""): ?>
    ...
    <div class="body">
		...
		<div class="modern-tabs modern-tabs-pos-top-left modern-tabs-anim-flip modern-tabs-response-to-icons">
			<input type="radio" name="modern-tabs"<?=(!empty($tabs['additional-fees']) ? ' checked="checked"' : '');?> id="modern-tab1" class="modern-tab-content-1">
			<label for="modern-tab1"><span><span><i class="fa fa-money" aria-hidden="true"></i>Additional Fees</span></span></label>

			<ul>
                <li class="modern-tab-content-1">
                    <div class="typography">
                        <?php include 'Shared/AdditionalFeesPartial.php'; ?>
                    </div>
                </li>
			</ul>
		</div>
