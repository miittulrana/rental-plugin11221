...
<form action="<?=esc_url($blockFormAction);?>" method="POST" class="block-form">
    <table cellpadding="0" cellspacing="7" border="0" align="left" class="extra-block-input-table">
        <tr>
            <td>
                <strong>Location:<span class="is-required">*</span></strong>
            </td>
            <td>
        ...
        <tr>
            <td></td>
            <td><input type="submit" name="search_for_block" value="Search for <?=esc_html($lang['LANG_MULTIPLE_VEHICLE_TITLE']);?> to block" class="save-button"/></td>
        </tr>
    </table>
</form>
<script type="text/javascript">
