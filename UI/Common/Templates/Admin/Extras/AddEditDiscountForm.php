...
<div id="container-inside">
    ...
    <input type="button" value="Back To Extras Discount List" onclick="window.location.href='<?=esc_js($backToListURL);?>'" class="button-back"/>
    <hr />
