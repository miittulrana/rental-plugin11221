...
?>
<h1>
    <span><?=esc_html($lang['LANG_FLEET_MODEL_PRICES_DISCOUNTS_IN_ADVANCE']);?></span>&nbsp;&nbsp;
    <input class="add-new" type="button" value="Add New Discount Plan" onclick="window.location.href='<?=esc_js($addNewAdvanceDiscountURL);?>'" />
</h1>
<table class="display advance-datatable" border="0" style="width:100%">
    ...
    <tbody><?=$adminBookingInAdvanceDiscountGroups;?></tbody>
</table>
<p>
