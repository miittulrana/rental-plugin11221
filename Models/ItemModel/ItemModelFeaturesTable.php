...
final class ItemModelFeaturesTable extends AbstractTable implements TableInterface
{
    /**
    ...
    {
        parent::__construct($paramConf, $paramLang, $paramConf->getPrefix(), "item_features", $paramBlogId);
    }
