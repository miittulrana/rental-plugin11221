...
final class OptionsTable extends AbstractTable implements TableInterface
{
    /**
    ...
    {
        parent::__construct($paramConf, $paramLang, $paramConf->getPrefix(), "options", $paramBlogId);
    }
