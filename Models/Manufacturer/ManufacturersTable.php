...
final class ManufacturersTable extends AbstractTable implements TableInterface
{
    /**
    ...
    {
        parent::__construct($paramConf, $paramLang, $paramConf->getPrefix(), "manufacturers", $paramBlogId);
    }
