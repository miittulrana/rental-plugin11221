...
final class ItemModelPostType extends AbstractStack implements StackInterface, PostTypeInterface
{
    private $conf 	                = null;
    private $lang 		            = null;
    private $debugMode 	            = 0;
    ...
    public function register($paramSlug, $paramMenuPosition)
    {
        ...
        $labels = array(
            'name'                => $this->lang->getText('LANG_ITEM_MODEL_POST_LABEL_NAME_TEXT'),
            'singular_name'       => $this->lang->getText('LANG_ITEM_MODEL_POST_LABEL_SINGULAR_NAME_TEXT'),
            'menu_name'           => $this->lang->getText('LANG_ITEM_MODEL_POST_LABEL_MENU_NAME_TEXT'),
            'parent_item_colon'   => $this->lang->getText('LANG_ITEM_MODEL_POST_LABEL_PARENT_ITEM_COLON_TEXT'),
            'all_items'           => $this->lang->getText('LANG_ITEM_MODEL_POST_LABEL_ALL_ITEMS_TEXT'),
            'view_item'           => $this->lang->getText('LANG_ITEM_MODEL_POST_LABEL_VIEW_ITEM_TEXT'),
            'add_new_item'        => $this->lang->getText('LANG_ITEM_MODEL_POST_LABEL_ADD_NEW_ITEM_TEXT'),
            'add_new'             => $this->lang->getText('LANG_ITEM_MODEL_POST_LABEL_ADD_NEW_TEXT'),
            'edit_item'           => $this->lang->getText('LANG_ITEM_MODEL_POST_LABEL_EDIT_ITEM_TEXT'),
            'update_item'         => $this->lang->getText('LANG_ITEM_MODEL_POST_LABEL_UPDATE_ITEM_TEXT'),
            'search_items'        => $this->lang->getText('LANG_ITEM_MODEL_POST_LABEL_SEARCH_ITEMS_TEXT'),
            'not_found'           => $this->lang->getText('LANG_ITEM_MODEL_POST_LABEL_NOT_FOUND_TEXT'),
            'not_found_in_trash'  => $this->lang->getText('LANG_ITEM_MODEL_POST_LABEL_NOT_FOUND_IN_TRASH_TEXT'),
        );

        // Set other options for Custom Post Type
        $args = array(
            'description'         => $this->lang->getText('LANG_ITEM_MODEL_POST_DESCRIPTION_TEXT'),
            'labels'              => $labels,
