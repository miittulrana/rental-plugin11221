...
final class ManagerRole extends AbstractStack implements StackInterface, RoleInterface
{
    private $conf           = null;
    private $lang 		    = null;
    private $debugMode 	    = 0;
	...
	public function __construct(ConfigurationInterface &$paramConf, LanguageInterface &$paramLang)
	{
        ...
        $this->roleName = $this->conf->getPluginPrefix().'manager';
	}
    ...
    public function add()
    {
        $roleResult = add_role($this->roleName, $this->lang->getText('LANG_MANAGER_TEXT'), $this->getCapabilities());
