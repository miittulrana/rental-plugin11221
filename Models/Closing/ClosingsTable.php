...
final class ClosingsTable extends AbstractTable implements TableInterface
{
    /**
    ...
    {
        parent::__construct($paramConf, $paramLang, $paramConf->getPrefix(), "closed_dates", $paramBlogId);
    }
