...
final class Partner extends AbstractStack implements StackInterface, WP_UserInterface
{
    private $conf           = null;
    private $lang 		    = null;
    private $debugMode 	    = 0;
	...
	public function __construct(ConfigurationInterface &$paramConf, LanguageInterface &$paramLang, $paramWP_UserId)
	{
		...
		$this->roleName = $this->conf->getExtPrefix().'partner';
