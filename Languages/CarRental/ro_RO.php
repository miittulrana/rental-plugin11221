...
return array(
    ...
    // Admin - Global
    'LANG_ORDERS_VIEW_TEXT' => 'Vezi Rezervari',
    'LANG_ORDERS_VIEW_UNPAID_TEXT' => 'Vezi Rezervarile Neplatite',
    'LANG_ORDERS_NONE_YET_TEXT' => 'Nicio Rezervare Inca',
    'LANG_ORDER_DETAILS_TEXT' => 'Detalii Rezervare',
    'LANG_CUSTOMER_DETAILS_FROM_DB_TEXT' => 'Detalii Client (Ultima versiune din baza de date)',
    'LANG_ORDER_STATUS_TEXT' => 'Status Rezervare',
    'LANG_ORDER_STATUS_UPCOMING_TEXT' => 'Upcoming',
    'LANG_ORDER_STATUS_DEPARTED_TEXT' => 'Plecat',
    'LANG_ORDER_STATUS_COMPLETED_EARLY_TEXT' => 'Completed Early',
    'LANG_ORDER_STATUS_COMPLETED_TEXT' => 'Completed',
    'LANG_ORDER_STATUS_ACTIVE_TEXT' => 'Activ',
    'LANG_ORDER_STATUS_CANCELLED_TEXT' => 'Anulata',
    'LANG_ORDER_STATUS_PAID_TEXT' => 'Platita',
    'LANG_ORDER_STATUS_UNPAID_TEXT' => 'Neplatita',
    'LANG_ORDER_STATUS_REFUNDED_TEXT' => 'Rambursata',
    'LANG_INVOICE_PRINT_TEXT' => 'Printeaza Factura',
    'LANG_CUSTOMER_BACK_TO_ORDERS_LIST_TEXT' => 'Inapoi la Lista Rezervarilor Clientilor',
    ...
    'LANG_PRICING_REGULAR_PRICE_TEXT' => 'Pret Normal',
    'LANG_PRICE_TYPE_TEXT' => 'Tip Pret',
    ...
    'LANG_CALENDAR_NO_CALENDARS_FOUND_TEXT' => 'Nu a fost gasit niciun calendar pentru perioada de timp selectata',
    'LANG_PAGE_SELECT_TEXT' => ' - Choose page - ',
    'LANG_SELECT_EMAIL_TYPE_TEXT' => '--- Selectati Tip Email ---',
...
and when plugin is network-enabled in multisite mode',
    ...
    'LANG_ITEM_NOT_AVAILABLE_FOR_ORDERING_TEXT' => 'Aceasta masina nu este disponibila for reservation.',

    // Manufacturer Element
    'LANG_MANUFACTURER_TEXT' => 'Producator',
    'LANG_MANUFACTURER_ID_TEXT' => 'Producator Id',
    'LANG_MANUFACTURER_IDS_TEXT' => 'Producator Ids',
    'LANG_MANUFACTURER_SELECT_TEXT' => 'Producator:',
    'LANG_MANUFACTURER_SELECT2_TEXT' => '- Select Producator -', // MB
    'LANG_MANUFACTURER_ADD_EDIT_TEXT' => 'Add / Edit Producator',

    // Class Element
    'LANG_CLASS_TEXT' => 'Clasa',
    'LANG_CLASS_ID_TEXT' => 'Clasa Id',
    'LANG_CLASS_IDS_TEXT' => 'Clasa Ids',
    'LANG_CLASS_SELECT_TEXT' => 'Clasa:',
    'LANG_CLASS_SELECT2_TEXT' => '- Select Clasa -', // MB
    'LANG_CLASS_ADD_NEW_TEXT' => 'Add New Clasa',
    'LANG_CLASS_LIST_TEXT' => 'Clasa List',
    ...
    'LANG_LOCATION_STATUS_OPEN_TEXT' => 'Deschis',
    'LANG_LOCATION_STATUS_CLOSED_TEXT' => 'Inchis',
    ...
    // Ext - Popular
    'LANG_ITEM_MODEL_TEXT' => 'Model auto',
    'LANG_EXTRA_TEXT' => 'Extra',
    'LANG_RENTAL_OPTION_TEXT' => 'Optiune Inchiriere',
    'LANG_ITEM_MODELS_TEXT' => 'Model auto',
    'LANG_ITEMS_TEXT' => 'Masini',
    'LANG_EXTRAS_TEXT' => 'Extras',
    'LANG_RENTAL_OPTIONS_TEXT' => 'Optiuni Inchiriere',
    'LANG_ITEM_MODEL_SHOW_TEXT' => 'Vezi masina model',
    'LANG_COUPON_TEXT' => 'Coupon',

    // Search Element
    'LANG_SEARCH_TEXT' => 'Cauta',
    'LANG_SEARCH_DEFAULT_SEARCH_PAGE_URL_SLUG_TEXT' => 'search', // Latin letters only
    'LANG_TAX_WITH_TEXT' => 'with TVA',
    'LANG_TAX_WITHOUT_TEXT' => 'w/o TVA',
    'LANG_TAX_SHORT_TEXT' => 'TVA',
    'LANG_DEPOSIT_TEXT' => 'Depozit',
    'LANG_DISCOUNT_TEXT' => 'Discount',
    'LANG_PREPAYMENT_TEXT' => 'Suma Preplatita',
    'LANG_ITEM_MODELS_NONE_AVAILABLE_TEXT' => 'Nicio masina disponibila',
    'LANG_ITEM_MODELS_NONE_AVAILABLE_IN_THIS_CLASS_TEXT' => 'Nicio masina disponibila in aceasta clasa',
    'LANG_ITEMS_NONE_AVAILABLE_TEXT' => 'Nicio masina disponibila',
    'LANG_ITEMS_NONE_AVAILABLE_IN_THIS_CLASS_TEXT' => 'Nicio masina disponibila in aceasta clasa',
    'LANG_EXTRAS_NONE_AVAILABLE_TEXT' => 'Niciun extras disponibil',
    ...
    'LANG_ORDER_MARK_PAID_TEXT' => 'Marcheaza ca Platita',
    'LANG_ORDER_MARK_COMPLETED_EARLY_TEXT' => 'Mark Completed Early',
    'LANG_ORDER_REFUND_TEXT' => 'Ramburseaza Plata',
    'LANG_LOCATION_SELECT2_TEXT' => '-- Selecteaza Locatie --',
    'LANG_LOCATIONS_ALL_TEXT' => 'All Locations',
    'LANG_PRICING_DAILY_TEXT' => 'Zilnic',
    'LANG_PRICING_HOURLY_TEXT' => 'Cu ora',
    'LANG_PRICING_PER_ORDER2_TEXT' => 'Per Rezervare',
    'LANG_PRICING_COMBINED_DAILY_AND_HOURLY_TEXT' => 'Combinat - Zilnic &amp; Cu ora',
    'LANG_PRICING_PER_ORDER_TEXT' => 'rezervare',
    ...
    'LANG_ORDER_TEXT' => 'Rezervare',
    'LANG_PICKUP_TEXT' => 'Ridicare',
    'LANG_RETURN_TEXT' => 'Returnare',
    'LANG_INFORMATION_TEXT' => 'Informatii',
    'LANG_CITY_AND_LOCATION_TEXT' => 'Oras &amp; Locatie:',
    'LANG_SEARCH_PICKUP_CITY_AND_LOCATION_SELECT_TEXT' => 'Alege Oras si Locatie:',
    'LANG_SEARCH_PICKUP_CITY_AND_LOCATION_SELECT2_TEXT' => '- Select Alege Oras si Locatie -', // MB
    'LANG_SEARCH_RETURN_CITY_AND_LOCATION_SELECT_TEXT' => 'Returneaza Oras & Locatie:',
    'LANG_SEARCH_RETURN_CITY_AND_LOCATION_SELECT2_TEXT' => '- Select Returneaza Oras & Locatie -', // MB
    'LANG_ORDER_PERIOD_SELECT_TEXT' => 'Perioada Rezervare:',
    'LANG_ORDER_PERIOD_SELECT2_TEXT' => ' - Select Period -', // MB
    'LANG_COUPON_CODE_TEXT' => 'Coupon code',
    'LANG_ORDER_CODE_INPUT_TEXT' => 'Am un numar de rezervare:',
    'LANG_ORDER_CODE_INPUT2_TEXT' => '- Am un numar de rezervare -', // MB
    'LANG_COUPON_CODE_INPUT_TEXT' => 'I have coupon code:',
    'LANG_COUPON_CODE_INPUT2_TEXT' => '- I have coupon code -', // MB
    'LANG_LOCATION_PICKUP_TEXT' => 'Locatie Ridicare',
    'LANG_LOCATION_RETURN_TEXT' => 'Locatie Returnare',
    'LANG_ALL_BODY_TYPES_DROPDOWN_TEXT' => '---- Toate Tipurile ----',
    'LANG_ALL_TRANSMISSION_TYPES_DROPDOWN_TEXT' => '---- Toate Transmisiile ----',
    'LANG_SELECT_PICKUP_LOCATION_TEXT' => '-- Selecteaza Locatie Ridicare --',
    'LANG_SELECT_RETURN_LOCATION_TEXT' => '-- Selecteaza Locatie Returnare --',
    'LANG_PICKUP_DATE_TEXT' => 'Data Ridicare',
    'LANG_RETURN_DATE_TEXT' => 'Data Returnare',
    ...
    'LANG_LOCATION_PICKUP_SELECT_ERROR_TEXT' => 'Va rugam selectati locatie ridicare.',
    'LANG_LOCATION_RETURN_SELECT_ERROR_TEXT' => 'Va rugam selectati locatie returnare.',
    'LANG_SHOW_ITEM_DESCRIPTION_TEXT' => 'Afisati descriere masina',
    'LANG_ORDER_UPDATE_MY_ORDER_TEXT' => 'Actualizeaza Rezervarea Mea',
    'LANG_CANCEL_ORDER_TEXT' => 'Anuleaza Rezervarea',
    'LANG_ORDER_CHANGE_DATE_TIME_AND_LOCATION_TEXT' => 'Schimba Data, Timp &amp; Locatie',
    'LANG_ORDER_CHANGE_ORDERED_ITEM_MODELS_TEXT' => 'Schimba Masini',
    'LANG_ORDER_CHANGE_ORDERED_ITEMS_TEXT' => 'Schimba Masini',
    'LANG_CHANGE_EXTRAS_TEXT' => 'Schimba Extras',
    'LANG_CHANGE_RENTAL_OPTIONS_TEXT' => 'Schimba Optiuni Inchiriere',
    'LANG_IN_THIS_LOCATION_TEXT' => 'In acest domeniu',
    'LANG_AFTERHOURS_PICKUP_IS_NOT_ALLOWED_TEXT' => 'Nu este permis',
    'LANG_AFTERHOURS_RETURN_IS_NOT_ALLOWED_TEXT' => 'Nu este permis',

    // Search step no. 3 - search results
    'LANG_DISTANCE_AWAY_TEXT' => '%s away',
    'LANG_ORDER_DATA_TEXT' => 'Detalii Rezervare',
    'LANG_ORDER_CODE_TEXT' => 'Cod Rezervare',
    'LANG_ORDER_CODE2_TEXT' => 'Cod rezervare', // Uppercase lowercase
    'LANG_ORDER_EDIT_TEXT' => 'editeaza',
    'LANG_ORDER_VIEW_DETAILS_TEXT' => 'View Reservation Details',
    'LANG_ORDER_PICKUP_TEXT' => 'Ridica',
    'LANG_ORDER_BUSINESS_HOURS_TEXT' => 'Ore de lucru:',
    'LANG_ORDER_FEE_TEXT' => 'Tarif:',
    'LANG_ORDER_RETURN_TEXT' => 'Returneaza',
    'LANG_ORDER_NIGHTLY_RATE_TEXT' => 'dupa orele',
    'LANG_ORDER_AFTERHOURS_TEXT' => 'dupa orele',
    'LANG_ORDER_EARLY_TEXT' => 'Early',
    'LANG_ORDER_LATE_TEXT' => 'Late',
    'LANG_ORDER_AFTERHOURS_PICKUP_TEXT' => 'Ridicare dupa orele',
    'LANG_ORDER_AFTERHOURS_PICKUP_IMPOSSIBLE_TEXT' => 'Imposibil',
    'LANG_ORDER_AFTERHOURS_RETURN_TEXT' => 'Returnare dupa orele',
    'LANG_ORDER_AFTERHOURS_RETURN_IMPOSSIBLE_TEXT' => 'Imposibil',
    'LANG_SEARCH_RESULTS_TEXT' => 'Rezultat Cautare',

    // Search step no. 4 - booking options
    'LANG_SELECT_RENTAL_OPTIONS_TEXT' => 'Alege Optiuni Inchiriere',
    'LANG_SELECTED_ITEMS_TEXT' => 'Masini Selectate',
    'LANG_FOR_DEPENDANT_ITEM_TEXT' => ' (for %s)',
    'LANG_NO_EXTRAS_AVAILABLE_CLICK_CONTINUE_TEXT' => 'Niciun Extras de Masini Disponibil. Click pe butonul Continua.',

    // Search step no. 5 - booking details
    'LANG_PICKUP_DATE_AND_TIME_TEXT' => 'Data &amp; Timp Ridicare',
    'LANG_RETURN_DATE_AND_TIME_TEXT' => 'Data &amp; Timp Returnare',
    'LANG_UNIT_PRICE_TEXT' => 'Pret Unitate',
    'LANG_LOCATION_PICKUP_FEE_TEXT' => 'Taxa Ridicare',
    'LANG_LOCATION_PICKUP_FEE2_TEXT' => 'Taxa ridicare', // Uppercase lowercase
    'LANG_LOCATION_RETURN_FEE_TEXT' => 'Taxa Returnare',
    'LANG_LOCATION_RETURN_FEE2_TEXT' => 'Taxa returnare', // Uppercase lowercase
    'LANG_LOCATION_NIGHTLY_RATE_APPLIED_TEXT' => '(Tarif de noapte aplicat)',
    'LANG_ITEMS_QUANTITY_SUFFIX_TEXT' => 'masina(a)',
    'LANG_EXTRAS_QUANTITY_SUFFIX_TEXT' => 'extra(s)',
    'LANG_PAY_NOW_OR_AT_PICKUP_TEXT' => 'Plateste Acum / la Ridicare',
    'LANG_PAYMENT_PAY_NOW_TEXT' => 'Plateste Acum',
    'LANG_PAYMENT_PAY_AT_PICKUP_TEXT' => 'Plateste la Ridicare',
    ...
    'LANG_ORDER_RENTAL_DETAILS_TEXT' => 'Detalii Inchiriere',
    'LANG_PAYMENT_GROSS_TOTAL_TEXT' => 'Sub Total',
    'LANG_PAYMENT_GRAND_TOTAL_TEXT' => 'Total',
    'LANG_CUSTOMER_DETAILS_TEXT' => 'Detalii Client',
    'LANG_CUSTOMER_SEARCH_FOR_EXISTING_TEXT' => 'Detalii Client Existent',
    'LANG_CUSTOMER_EXISTING_TEXT' => 'Client Existent',
    ...
    'LANG_CUSTOMER_FETCH_DETAILS_TEXT' => 'Adu Detalii',
    'LANG_CUSTOMER_OR_ENTER_DETAILS_TEXT' => 'Sau introduceti detalii noi',
    'LANG_CUSTOMER_TEXT' => 'Client',
    'LANG_CUSTOMER_SELECT_TEXT' => 'Select Customer',
    'LANG_CITY_TEXT' => 'Oras',
    'LANG_STATE_TEXT' => 'Stat',
    'LANG_COUNTRY_TEXT' => 'Tara',
    'LANG_ADDITIONAL_COMMENTS_TEXT' => 'Comentarii Aditionale',
    'LANG_CUSTOMER_ID_TEXT' => 'ID Client',
    ...
    'LANG_PAYMENT_PAY_BY_SHORT_TEXT' => 'Platit de',
    'LANG_SEARCH_I_AGREE_WITH_TERMS_AND_CONDITIONS_TEXT' => 'Sunt de acord cu Termenii si Conditiile',
    'LANG_TERMS_AND_CONDITIONS_TEXT' => 'Termeni &amp; Conditii',
    'LANG_FIELD_REQUIRED_TEXT' => 'Acest camp este obligatoriu',

    // Search step no. 6 - process booking
    'LANG_PAYMENT_DETAILS_TEXT' => 'Detalii Plata',
    'LANG_PAYMENT_OPTION_TEXT' => 'Platit de ',
    'LANG_PAYMENT_PROCESSING_TEXT' => 'Plata se proceseaza...',
    'LANG_ORDER_PLEASE_WAIT_UNTIL_WILL_BE_PROCESSED_TEXT' => 'Va rugam asteptati, comanda dvs. va fi procesata...',

    // display-booking-confirm.php
    'LANG_STEP5_PAY_ONLINE_TEXT' => 'Platita Online',
    'LANG_STEP5_PAY_AT_PICKUP_TEXT' => 'Plateste la Ridicare',
    'LANG_ORDER_RECEIVED_YOUR_CODE_S_TEXT' => 'Rezervare Received. Cod Rezervare %s.',
    'LANG_ORDER_CONFIRMED_YOUR_CODE_S_TEXT' => 'Rezervare Confirmata. Cod Rezervare %s.',
    'LANG_ORDER_UPDATED_YOUR_CODE_S_TEXT' => 'Rezervare Updated. Cod Rezervare %s.',
    'LANG_INVOICE_SENT_TO_YOUR_EMAIL_ADDRESS_TEXT' => 'Factura a fost trimisa la adresa dvs. de email',

    // display-booking-failure.php
    'LANG_ORDER_FAILURE_TEXT' => 'Eroare Rezervare',
    'LANG_SEARCH_ALL_ITEM_MODELS_TEXT' => 'Cauta toate Masinile',
    ...
    'LANG_DAY_PRICE_TEXT' => 'Pret / zi', // Not used
    'LANG_HOUR_PRICE_TEXT' => 'Pret / ora', // Not used
    'LANG_NO_ITEM_MODELS_IN_THIS_CATEGORY_TEXT' => 'Nu sunt masini in aceasta categorie',
    'LANG_PRICE_FOR_DAY_FROM_TEXT' => 'Pret pentru o zi incepand cu',
    'LANG_PRICE_FOR_HOUR_FROM_TEXT' => 'Pret pentru o ora incepand cu',
    'LANG_PRICE_WITH_APPLIED_TEXT' => 'cu aplicare',
    'LANG_WITH_APPLIED_DISCOUNT_TEXT' => 'discount',

    // class.ItemsAvailability.php
    'LANG_MONTH_DAY_TEXT' => 'Day',
    'LANG_MONTH_DAYS_TEXT' => 'Days',
    'LANG_ITEMS_AVAILABILITY_FOR_TEXT' => 'Disponibilitate Masini pentru',
    ...
    'LANG_ITEMS_AVAILABILITY_THIS_MONTH_TEXT' => 'Disponibilitate Masini Luna in Curs', // Not used
    'LANG_ITEMS_AVAILABILITY_NEXT_MONTH_TEXT' => 'Disponibilitate Masini Luna Urmatoare', // Not used
    'LANG_ITEM_MODEL_ID_TEXT' => 'ID:',
    'LANG_TOTAL_ITEMS_TEXT' => 'Total masini:',

    // class.ExtrasAvailability.php
    'LANG_EXTRAS_AVAILABILITY_FOR_TEXT' => 'Disponibilitate Extras Availability Pentru',
    ...
    'LANG_EXTRAS_AVAILABILITY_THIS_MONTH_TEXT' => 'Disponibilitate Extras Luna in Curs', // Not used
    'LANG_EXTRAS_AVAILABILITY_NEXT_MONTH_TEXT' => 'Disponibilitate Extras Luna Urmatoare', // Not used
    'LANG_EXTRA_ID_TEXT' => 'ID',
    'LANG_TOTAL_EXTRAS_TEXT' => 'Total extras:',

    // class.ItemModelsController.php
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME1_TEXT' => 'Carburant',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL1_TEXT' => 'Carburant',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME2_TEXT' => 'Cutie Viteze',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL2_TEXT' => 'Cutie Viteze',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME3_TEXT' => 'Consume Carburant',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL3_TEXT' => 'Consume Carburant',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME4_TEXT' => 'Capacitate Pasageri',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL4_TEXT' => 'Capacitate Pasageri',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME5_TEXT' => 'Capacitate motor',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL5_TEXT' => 'Capacitate motor',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME6_TEXT' => 'Bagaj max',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL6_TEXT' => 'Bagaj max',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME7_TEXT' => 'Usi',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL7_TEXT' => 'Usi',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME8_TEXT' => 'Kilometri',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL8_TEXT' => 'Kilometri',
    'LANG_PRICING_PRICE_FROM_TEXT' => 'Pret de la',
    'LANG_PRICING_INQUIRE_TEXT' => 'Call',
    'LANG_PRICING_GET_A_QUOTE_TEXT' => 'Get a quote',
    'LANG_FEATURES_TEXT' => 'Caracteristici',
    'LANG_PRICING_GET_IT_TEXT' => 'Rezerva',

    // class.LocationsController.php
    'LANG_LOCATIONS_BUSINESS_HOURS_TEXT' => 'Business Hours',
    'LANG_LOCATION_FEES_TEXT' => 'Taxe Locatie',
    ...
    'LANG_ITEM_MODEL_MINIMUM_ALLOWED_AGE_TEXT' => 'Varsta minima Sofer',
    'LANG_ITEM_MODEL_MAXIMUM_ALLOWED_AGE_TEXT' => 'Maximum Driver Age',
    'LANG_ITEM_MODEL_MIN_ALLOWED_AGE_TEXT' => 'Varsta minima Sofer',
    ...
    'LANG_ITEM_MODEL_ADDITIONAL_INFORMATION_TEXT' => 'Informatii Aditionale',
    ...
    'LANG_ITEM_MODEL_VISIT_PAGE_TEXT' => 'Afiseaza descrierea Masinii',
    ...
    'LANG_ORDER_S_CANCELLED_SUCCESSFULLY_TEXT' => 'Rezervarea %s anulata cu succes.',
    'LANG_ORDER_NOT_CANCELLED_CODE_S_DOES_NOT_EXIST_TEXT' => 'Rezervarea nu a fost realizata. Reservation code %s - does not exist.',

    // template.Step8EditBooking.php
    'LANG_SEARCH_CHANGE_ORDER_TEXT' => 'Schimba
rezervare',
    'LANG_SEARCH_CHANGE_ORDER2_TEXT' => 'Schimba Rezervare',
    'LANG_ORDER_NO_CODE_ERROR_TEXT' => 'Introduceti numar rezervare!',

    // Errors
    'LANG_ERROR_REQUIRED_FIELD_TEXT' => 'Camp obligatoriu',
    'LANG_ERROR_IS_EMPTY_TEXT' => 'este gol',
    'LANG_ERROR_SLIDER_CANT_BE_DISPLAYED_TEXT' => 'Slider can\'t be displayed',
    'LANG_CUSTOMER_DETAILS_NOT_FOUND_ERROR_TEXT' => 'Detaliile nu au fost gasite. Va rugam sa va Inregistrati.',
    'LANG_ERROR_CUSTOMER_DETAILS_NO_ERROR_TEXT' => 'Nicio eroare',
    ...
    'LANG_ERROR_ORDER_DOES_NOT_EXIST_TEXT' => 'nu exista',
    'LANG_ITEM_MODELS_PLEASE_SELECT_AT_LEAST_ONE_ITEM_MODEL_ERROR_TEXT' => 'Selectati cel putin o masina',
    'LANG_ITEMS_PLEASE_SELECT_AT_LEAST_ONE_ITEM_ERROR_TEXT' => 'Selectati cel putin o masina',
    'LANG_ERROR_SEARCH_ENGINE_DISABLED_TEXT' => 'Ne pare rau, rezervarile online nu sunt disponibile momentan. Va rugam incercati mai tarziu.',
    'LANG_SEARCH_OUT_BEFORE_IN_ERROR_TEXT' => 'Ne pare rau dar ati introdus criterii de cautare invalide. Va rugam incercati cu criterii de cautare valide.',
    'LANG_SEARCH_MINIMUM_DURATION_CANT_BE_LESS_THAN_S_ERROR_TEXT' => 'Numarul minim de nopti nu ar trebui sa fie mai mic de %s.',
    'LANG_SEARCH_ERROR_PLEASE_MODIFY_YOUR_SEARCH_CRITERIA_TEXT' => 'Va rugam modificati criteriile de cautare.',
    'LANG_ERROR_PICKUP_IS_NOT_POSSIBLE_ON_TEXT' => 'Rezervarea nu este posibila pentru data de ridicare:',
    'LANG_ERROR_PLEASE_MODIFY_YOUR_PICKUP_TIME_BY_WEBSITE_TIME_TEXT' => 'Va rugam modificati criteriile de cautare in conformitate cu data &amp; timpul curent locatiei rezervarii.',
    'LANG_ERROR_CURRENT_DATE_TIME_TEXT' => 'Data si timpul locatiei rezervarii:',
    ...
    'LANG_ERROR_PICKUP_DATE_CANT_BE_LESS_THAN_RETURN_DATE_TEXT' => 'Data &amp; Timpul Ridicarii nu pot fi mai mici decat cele ale Returnarii. Va rugam selectati Data si Timpul corecte pentru Ridicare si Returnare.',
    'LANG_ERROR_PICKUP_LOCATION_IS_CLOSED_AT_THIS_DATE_TEXT' => 'Locatia Ridicarii %s la adresa %s este inchisa la aceasta data (%s).',
    'LANG_ERROR_PICKUP_LOCATION_IS_CLOSED_AT_THIS_TIME_TEXT' => 'Locatia Ridicarii %s la adresa %s este inchisa la aceasta ora (%s).',
    'LANG_ERROR_RETURN_LOCATION_IS_CLOSED_AT_THIS_DATE_TEXT' => 'Locatia Returnarii %s la adresa %s este inchisa la aceasta data (%s).',
    'LANG_ERROR_RETURN_LOCATION_IS_CLOSED_AT_THIS_TIME_TEXT' => 'Locatia Returnarii %s la adresa %s este inchisa la aceasta ora (%s).',
    'LANG_ERROR_AFTERHOURS_PICKUP_LOCATION_IS_CLOSED_AT_THIS_TIME_TEXT' => 'Locatia de ridicare pentru ore tarzii este %s la adresa %s dar acea locatie este inchisa la acea ora.',
    'LANG_ERROR_AFTERHOURS_RETURN_LOCATION_IS_CLOSED_AT_THIS_TIME_TEXT' => 'Locatia de returnare este %s la adresa %s dar acea locatie este inchisa la acea ora.',
    ...
    'LANG_ERROR_AFTERHOURS_PICKUP_LOCATION_OPEN_HOURS_ARE_TEXT' => 'Orele tarzii ale locatiei de ridicare sunt %s.',
    'LANG_ERROR_AFTERHOURS_RETURN_LOCATION_OPEN_HOURS_ARE_TEXT' => 'Orele tarzii ale locatiei de returnare sunt %s.',
    'LANG_ERROR_AFTERHOURS_PICKUP_IS_NOT_ALLOWED_AT_LOCATION_TEXT' => 'Ridicarea la ore tarzii nu se poate efectua la aceasta locatie.',
    'LANG_ERROR_AFTERHOURS_RETURN_IS_NOT_ALLOWED_AT_LOCATION_TEXT' => 'Returnarea la ore tarzii nu se poate efectua la aceasta locatie.',
    'LANG_SEARCH_MAXIMUM_DURATION_CANT_BE_MORE_THAN_S_ERROR_TEXT' => 'Perioada maxima de rezervare nu poate fi mai mare de %s.',
    'LANG_ORDER_INVALID_CODE_ERROR_TEXT' => 'Cod rezervare invalid sau acest cod nu mai exista.',
    ...
    'LANG_ORDER_NO_S_PICKED_UP_ERROR_TEXT' => 'Rezervarea Nr. %s deja marcata ca plecata, si nu mai este valabila pentru editare.',
    'LANG_ORDER_NO_S_CANCELLED_ERROR_TEXT' => 'Rezervarea Nr. %s a fost anulata.',
    'LANG_ORDER_NO_S_REFUNDED_ERROR_TEXT' => 'Rezervarea Nr. %s a fost deja rambursata si nu mai este valabila.',
    'LANG_ERROR_PAYMENT_METHOD_IS_NOT_YET_IMPLEMENTED_TEXT' => 'Eroare: Ati incercat sa platiti printr-o metoda de plata care nu este valabila in acest sistem.',
    'LANG_ORDER_OTHER_ERROR_TEXT' => 'Alta eroare de rezervare. Daca vedeti acest mesaj va rusam sa contactati administratorul site-ului.',
    ...
    'LANG_PAYMENT_METHOD_DEFAULT_BANK_TEXT' => 'Transfer Bancar',
    'LANG_PAYMENT_METHOD_DEFAULT_BANK_DETAILS_TEXT' => 'Detaliile Bancare',
    'LANG_PAYMENT_METHOD_DEFAULT_PAY_OVER_THE_PHONE_TEXT' => 'Platiti prin Telefon',
    'LANG_PAYMENT_METHOD_DEFAULT_PAY_ON_ARRIVAL_TEXT' => 'Plateste la Ridicare',
    'LANG_PAYMENT_METHOD_DEFAULT_PAY_ON_ARRIVAL_DETAILS_TEXT' => 'Credit Card Necesar',
    'LANG_EMAIL_DEFAULT_DEAR_TEXT' => 'Draga',
    'LANG_EMAIL_DEFAULT_REGARDS_TEXT' => 'Salutari',
    ...
    'LANG_SEARCH_PICKUP_DATE_SELECT_ERROR_TEXT' => 'Introduceti Data Ridicare',
    ...
    'LANG_SEARCH_RETURN_DATE_SELECT_ERROR_TEXT' => 'Introduceti Data Returnare',
    ...
    'LANG_SEARCH_TRY_DIFFERENT_DATE_OR_CRITERIA_ERROR_TEXT' => 'Nu sunt masini disponibile. Va rugam sa introduceti o alta perioada de timp sau modificati criteriile de cautare.',
...
(New WP User)',
    ...
    'LANG_SETTINGS_DEFAULT_ITEM_MODEL_URL_SLUG_TEXT' => 'masini-model', // Latin letters only
    ...
    'LANG_SETTINGS_DEFAULT_TERMS_AND_CONDITIONS_PAGE_TITLE_TEXT' => 'Termeni de Utilizare pentru Inchiriere Autovehicul',
    'LANG_SETTINGS_DEFAULT_TERMS_AND_CONDITIONS_PAGE_CONTENT_TEXT' => 'Trebuie sa urmati indicatiile si termenii pentru inchirierea unui autovehicul.',
    ...
    'LANG_TRANSACTION_ID_TEXT' => 'ID Tranzactie',
    ...
    'LANG_TRANSACTION_PAYER_EMAIL_TEXT' => 'E-Mail Platitor',
