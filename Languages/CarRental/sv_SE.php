...
return array(
    ...
    // Admin - Global
    'LANG_ORDERS_VIEW_TEXT' => 'Se reservation',
    'LANG_ORDERS_VIEW_UNPAID_TEXT' => 'Obetalda reservationer',
    'LANG_ORDERS_NONE_YET_TEXT' => 'Finns inga reservationer.',
    'LANG_ORDER_DETAILS_TEXT' => 'Reservations detaljer',
    'LANG_CUSTOMER_DETAILS_FROM_DB_TEXT' => 'Kunduppgifter (Senaste från databasen)',
    'LANG_ORDER_STATUS_TEXT' => 'Reservation Status',
    'LANG_ORDER_STATUS_UPCOMING_TEXT' => 'Upcoming',
    'LANG_ORDER_STATUS_DEPARTED_TEXT' => 'Har hämtat',
    ...
    'LANG_ORDER_STATUS_CANCELLED_TEXT' => 'Annulerad',
    'LANG_ORDER_STATUS_PAID_TEXT' => 'Bokad',
    'LANG_ORDER_STATUS_UNPAID_TEXT' => 'Resevationsförfrågan',
    'LANG_ORDER_STATUS_REFUNDED_TEXT' => 'Återbetald',
    'LANG_INVOICE_PRINT_TEXT' => 'Skriv ut kvitto',
    'LANG_CUSTOMER_BACK_TO_ORDERS_LIST_TEXT' => 'Tillbaka till kund\'s listan',
    ...
    'LANG_PRICING_REGULAR_PRICE_TEXT' => 'Vanligt pris',
    'LANG_PRICE_TYPE_TEXT' => 'Pristyp',
    ...
    'LANG_CALENDAR_NO_CALENDARS_FOUND_TEXT' => 'Ingen kalender hittad',
    'LANG_PAGE_SELECT_TEXT' => ' - Choose page - ',
    'LANG_SELECT_EMAIL_TYPE_TEXT' => '--- Välj mailtyp ---',
...
and when plugin is network-enabled in multisite mode',
    ...
    'LANG_ITEM_NOT_AVAILABLE_FOR_ORDERING_TEXT' => 'Bilen är inte tillgänglig for reservation.',

    // Manufacturer Element
    'LANG_MANUFACTURER_TEXT' => 'Tillverkare',
    'LANG_MANUFACTURER_ID_TEXT' => 'Tillverkare Id',
    'LANG_MANUFACTURER_IDS_TEXT' => 'Tillverkare Ids',
    'LANG_MANUFACTURER_SELECT_TEXT' => 'Tillverkare:',
    'LANG_MANUFACTURER_SELECT2_TEXT' => '- Select Tillverkare -', // MB
    'LANG_MANUFACTURER_ADD_EDIT_TEXT' => 'Add / Edit Tillverkare',

    // Class Element
    'LANG_CLASS_TEXT' => 'Klass',
    'LANG_CLASS_ID_TEXT' => 'Klass Id',
    'LANG_CLASS_IDS_TEXT' => 'Klass Ids',
    'LANG_CLASS_SELECT_TEXT' => 'Klass:',
    'LANG_CLASS_SELECT2_TEXT' => '- Select Klass -', // MB
    'LANG_CLASS_ADD_NEW_TEXT' => 'Add New Klass',
    'LANG_CLASS_LIST_TEXT' => 'Klass List',
    ...
    'LANG_LOCATION_STATUS_OPEN_TEXT' => 'Öppet',
    'LANG_LOCATION_STATUS_CLOSED_TEXT' => 'Stängt',
    ...
    'LANG_ITEMS_AVAILABILITY_SEARCH_RESULTS_TEXT' => 'Car Calendar Search Results',
    'LANG_EXTRAS_AVAILABILITY_SEARCH_TEXT' => 'Extras Calendar Search Results',
    ...
    // Ext - Popular
    'LANG_ITEM_MODEL_TEXT' => 'Bil modell',
    'LANG_EXTRA_TEXT' => 'Extra',
    'LANG_RENTAL_OPTION_TEXT' => 'Bokningsalternativ',
    'LANG_ITEM_MODELS_TEXT' => 'Bilar model',
    'LANG_ITEMS_TEXT' => 'Bilar',
    'LANG_EXTRAS_TEXT' => 'Extra tillbehör',
    'LANG_RENTAL_OPTIONS_TEXT' => 'Bokningsalternativ',
    'LANG_ITEM_MODEL_SHOW_TEXT' => 'Visa bil model',
    'LANG_COUPON_TEXT' => 'Coupon',

    // Search Element
    'LANG_SEARCH_TEXT' => 'Sök',
    'LANG_SEARCH_DEFAULT_SEARCH_PAGE_URL_SLUG_TEXT' => 'search', // Latin letters only
    'LANG_TAX_WITH_TEXT' => 'med skatt',
    'LANG_TAX_WITHOUT_TEXT' => 'utan skatt',
    'LANG_TAX_SHORT_TEXT' => 'Skatt',
    'LANG_DEPOSIT_TEXT' => 'Deposition',
    'LANG_DISCOUNT_TEXT' => 'Rabatt',
    'LANG_PREPAYMENT_TEXT' => 'Förskottsbetalning',
    'LANG_ITEM_MODELS_NONE_AVAILABLE_TEXT' => 'Inga tillgängliga bilar',
    'LANG_ITEM_MODELS_NONE_AVAILABLE_IN_THIS_CLASS_TEXT' => 'Inga tillgängliga bilar i denna klass',
    'LANG_ITEMS_NONE_AVAILABLE_TEXT' => 'Inga tillgängliga bilar',
    'LANG_ITEMS_NONE_AVAILABLE_IN_THIS_CLASS_TEXT' => 'Inga tillgängliga bilar i denna klass',
    'LANG_EXTRAS_NONE_AVAILABLE_TEXT' => 'Inga tillbehör tillgängligt',
    ...
    'LANG_ORDER_MARK_PAID_TEXT' => 'Markera som betald',
    'LANG_ORDER_MARK_COMPLETED_EARLY_TEXT' => 'Mark Completed Early',
    'LANG_ORDER_REFUND_TEXT' => 'Återbetalning',
    'LANG_LOCATION_SELECT2_TEXT' => '-- Välj plats --',
    'LANG_LOCATIONS_ALL_TEXT' => 'Var som helst',
    'LANG_PRICING_DAILY_TEXT' => 'Daglig',
    'LANG_PRICING_HOURLY_TEXT' => 'Tim',
    'LANG_PRICING_PER_ORDER2_TEXT' => 'Per Reservation',
    'LANG_PRICING_COMBINED_DAILY_AND_HOURLY_TEXT' => 'Kombinerad - Daglig &amp; Tim',
    ...
    'LANG_PICKUP_TEXT' => 'Upphämtning',
    'LANG_RETURN_TEXT' => 'Återlämning',
    'LANG_INFORMATION_TEXT' => 'Information',
    'LANG_CITY_AND_LOCATION_TEXT' => 'Stad &amp; Adress:',
    'LANG_SEARCH_PICKUP_CITY_AND_LOCATION_SELECT_TEXT' => 'Stad och Adress för hämtning:',
    'LANG_SEARCH_PICKUP_CITY_AND_LOCATION_SELECT2_TEXT' => '- Select Stad och Adress för hämtning -', // MB
    'LANG_SEARCH_RETURN_CITY_AND_LOCATION_SELECT_TEXT' => 'Stad och Adress för återlämning:',
    'LANG_SEARCH_RETURN_CITY_AND_LOCATION_SELECT2_TEXT' => '- Select Stad och Adress för återlämning -', // MB
    'LANG_ORDER_PERIOD_SELECT_TEXT' => 'Reservations Period:',
    'LANG_ORDER_PERIOD_SELECT2_TEXT' => ' - Select Period -', // MB
    'LANG_COUPON_CODE_TEXT' => 'Coupon code',
    'LANG_ORDER_CODE_INPUT_TEXT' => 'Ange bokningsnummer:',
    'LANG_ORDER_CODE_INPUT2_TEXT' => '- Ange bokningsnummer -', // MB
    'LANG_COUPON_CODE_INPUT_TEXT' => 'I have coupon code:',
    'LANG_COUPON_CODE_INPUT2_TEXT' => '- I have coupon code -', // MB
    'LANG_LOCATION_PICKUP_TEXT' => 'Hämta hos',
    'LANG_LOCATION_RETURN_TEXT' => 'Lämna hos',
    'LANG_ALL_BODY_TYPES_DROPDOWN_TEXT' => '---- Alla typer ----',
    'LANG_ALL_TRANSMISSION_TYPES_DROPDOWN_TEXT' => '---- Alla överförningar ----',
    'LANG_SELECT_PICKUP_LOCATION_TEXT' => '-- Välj plats --',
    'LANG_SELECT_RETURN_LOCATION_TEXT' => '-- Välj plats --',
    'LANG_PICKUP_DATE_TEXT' => 'Datum för hämtning',
    'LANG_RETURN_DATE_TEXT' => 'Datum för att återlämna',
    'LANG_ORDER_NO_PERIOD_SELECTED_ERROR_TEXT' => 'Var god och välj boknings period!',
    ...
    'LANG_ORDER_UPDATE_MY_ORDER_TEXT' => 'Uppdatera min reservation',
    'LANG_CANCEL_ORDER_TEXT' => 'Avbryt reservation',
    'LANG_ORDER_CHANGE_DATE_TIME_AND_LOCATION_TEXT' => 'Byt datum, tid &amp; plats',
    'LANG_ORDER_CHANGE_ORDERED_ITEM_MODELS_TEXT' => 'Byt bil/ar',
    'LANG_ORDER_CHANGE_ORDERED_ITEMS_TEXT' => 'Byt bil/ar',
    'LANG_CHANGE_EXTRAS_TEXT' => 'Byta tillbehör',
    'LANG_CHANGE_RENTAL_OPTIONS_TEXT' => 'Byt hyr alternativ',
    'LANG_IN_THIS_LOCATION_TEXT' => 'Tillgängligt för återlämning i nyckelinkast',
    'LANG_AFTERHOURS_PICKUP_IS_NOT_ALLOWED_TEXT' => 'Icke tillgängligt',
    'LANG_AFTERHOURS_RETURN_IS_NOT_ALLOWED_TEXT' => 'Icke tillgängligt',

    // Search step no. 3 - search results
    'LANG_DISTANCE_AWAY_TEXT' => '%s away',
    'LANG_ORDER_DATA_TEXT' => 'Reservations detaljer',
    'LANG_ORDER_CODE_TEXT' => 'Reservations nummer',
    'LANG_ORDER_CODE2_TEXT' => 'Reservations nummer', // Uppercase lowercase
    'LANG_ORDER_EDIT_TEXT' => 'redigera',
    'LANG_ORDER_VIEW_DETAILS_TEXT' => 'View Reservation Details',
    'LANG_ORDER_PICKUP_TEXT' => 'Hämta',
    'LANG_ORDER_BUSINESS_HOURS_TEXT' => 'Öppettider',
    'LANG_ORDER_FEE_TEXT' => 'Avgift',
    'LANG_ORDER_RETURN_TEXT' => 'Lämna',
    'LANG_ORDER_NIGHTLY_RATE_TEXT' => 'Stängt',
    'LANG_ORDER_AFTERHOURS_TEXT' => 'Efter stängning',
    'LANG_ORDER_EARLY_TEXT' => 'Early',
    'LANG_ORDER_LATE_TEXT' => 'Late',
    'LANG_ORDER_AFTERHOURS_PICKUP_TEXT' => 'Hämta efter stängning',
    'LANG_ORDER_AFTERHOURS_PICKUP_IMPOSSIBLE_TEXT' => 'Ej möjligt att hämta bil när det är stängt',
    'LANG_ORDER_AFTERHOURS_RETURN_TEXT' => 'Lämna efter stängning',
    'LANG_ORDER_AFTERHOURS_RETURN_IMPOSSIBLE_TEXT' => 'Ej möjligt att återlämna bil',
    'LANG_SEARCH_RESULTS_TEXT' => 'Sökresultat',

    // Search step no. 4 - booking options
    'LANG_SELECT_RENTAL_OPTIONS_TEXT' => 'Välj reservations alternativ',
    'LANG_SELECTED_ITEMS_TEXT' => 'Valda bilar',
    'LANG_FOR_DEPENDANT_ITEM_TEXT' => ' (for %s)',
    'LANG_NO_EXTRAS_AVAILABLE_CLICK_CONTINUE_TEXT' => 'Det finns inga extratillbehör. Klicka på fortsätt.',

    // Search step no. 5 - booking details
    'LANG_PICKUP_DATE_AND_TIME_TEXT' => 'Datum &amp; Tid för hämtning',
    'LANG_RETURN_DATE_AND_TIME_TEXT' => 'Datum &amp; Tid för återlämning',
    'LANG_UNIT_PRICE_TEXT' => 'Styckpris',
    'LANG_LOCATION_PICKUP_FEE_TEXT' => 'Avgift för Hämtning',
    'LANG_LOCATION_PICKUP_FEE2_TEXT' => 'Avgift för hämtning', // Uppercase lowercase
    'LANG_LOCATION_RETURN_FEE_TEXT' => 'Avgift för återlämning',
    'LANG_LOCATION_RETURN_FEE2_TEXT' => 'Avgift för återlämning', // Uppercase lowercase
    'LANG_LOCATION_NIGHTLY_RATE_APPLIED_TEXT' => '(Nattlig räntesats applicerad)',
    'LANG_ITEMS_QUANTITY_SUFFIX_TEXT' => 'bil(ar)',
    'LANG_EXTRAS_QUANTITY_SUFFIX_TEXT' => 'extratillbehör',
    'LANG_PAY_NOW_OR_AT_PICKUP_TEXT' => 'Betala nu / när du hämtar',
    'LANG_PAYMENT_PAY_NOW_TEXT' => 'Betala nu',
    'LANG_PAYMENT_PAY_AT_PICKUP_TEXT' => 'Betala när du hämtar',
    'LANG_PAYMENT_PAY_LATER_OR_ON_RETURN_TEXT' => 'Betala senare / när du lämnar',
    'LANG_PAYMENT_PAY_LATER_TEXT' => 'Betala senare',
    'LANG_PAYMENT_PAY_ON_RETURN_TEXT' => 'Betala när du lämnar',
    'LANG_ORDER_RENTAL_DETAILS_TEXT' => 'Reservations detaljer',
    'LANG_PAYMENT_GROSS_TOTAL_TEXT' => 'Delsumma',
    'LANG_PAYMENT_GRAND_TOTAL_TEXT' => 'Totalsumma',
    'LANG_CUSTOMER_DETAILS_TEXT' => 'Kunduppgifter',
    'LANG_CUSTOMER_SEARCH_FOR_EXISTING_TEXT' => 'Befintlig kund? Sök efter dina uppgifter.',
    'LANG_CUSTOMER_EXISTING_TEXT' => 'Befintlig kund',
    ...
    'LANG_CUSTOMER_FETCH_DETAILS_TEXT' => 'Hämta kunduppgifter',
    'LANG_CUSTOMER_OR_ENTER_DETAILS_TEXT' => 'Eller skapa ett konto',
    'LANG_CUSTOMER_TEXT' => 'Kund',
    'LANG_CUSTOMER_SELECT_TEXT' => 'Select Customer',
    'LANG_CITY_TEXT' => 'Stad',
    'LANG_STATE_TEXT' => 'Län',
    'LANG_COUNTRY_TEXT' => 'Land',
    'LANG_ADDITIONAL_COMMENTS_TEXT' => 'Person / organisations nummer',
    'LANG_CUSTOMER_ID_TEXT' => 'Kund ID',
    ...
    'LANG_PAYMENT_PAY_BY_SHORT_TEXT' => 'Betala via',
    'LANG_SEARCH_I_AGREE_WITH_TERMS_AND_CONDITIONS_TEXT' => 'villkoren',
    'LANG_TERMS_AND_CONDITIONS_TEXT' => 'Villkor',
    'LANG_FIELD_REQUIRED_TEXT' => 'Obligatoriskt.',

    // Search step no. 6 - process booking
    'LANG_PAYMENT_DETAILS_TEXT' => 'Betalningsdetaljer',
    'LANG_PAYMENT_OPTION_TEXT' => 'Betala via',
    'LANG_PAYMENT_PROCESSING_TEXT' => 'Betalningen bearbetas...',
    'LANG_ORDER_PLEASE_WAIT_UNTIL_WILL_BE_PROCESSED_TEXT' => 'Var god vänta, din reservation bearbetas...',

    // display-booking-confirm.php
    'LANG_STEP5_PAY_ONLINE_TEXT' => 'Betalt online',
    'LANG_STEP5_PAY_AT_PICKUP_TEXT' => 'Betalt vid upphämtning',
    'LANG_ORDER_RECEIVED_YOUR_CODE_S_TEXT' => 'Ditt reservationsnummer är %s.',
    'LANG_ORDER_CONFIRMED_YOUR_CODE_S_TEXT' => 'Ditt reservationsnummer är %s.',
    'LANG_ORDER_UPDATED_YOUR_CODE_S_TEXT' => 'Ditt reservationsnummer är %s.',
    'LANG_INVOICE_SENT_TO_YOUR_EMAIL_ADDRESS_TEXT' => 'Vi bearbetar den och återkommer så snabbt som möjligt när bokningen är klar',

    // display-booking-failure.php
    'LANG_ORDER_FAILURE_TEXT' => 'Reservationen misslyckades',
    'LANG_SEARCH_ALL_ITEM_MODELS_TEXT' => 'Sök efter bilar',
    ...
    'LANG_DAY_PRICE_FROM_TEXT' => 'Dagligt från pris', // Not used
    'LANG_HOUR_PRICE_FROM_TEXT' => 'Tim pris från', // Not used
    'LANG_NO_ITEM_MODELS_IN_THIS_CATEGORY_TEXT' => 'Där finns inga bilar under denna kategori',
    'LANG_PRICE_FOR_DAY_FROM_TEXT' => 'Pris per dag från',
    'LANG_PRICE_FOR_HOUR_FROM_TEXT' => 'Pris per timme från',
    'LANG_PRICE_WITH_APPLIED_TEXT' => 'med tillämpade',
    'LANG_WITH_APPLIED_DISCOUNT_TEXT' => 'rabatt',

    // class.ItemsAvailability.php
    'LANG_MONTH_DAY_TEXT' => 'Dag',
    'LANG_MONTH_DAYS_TEXT' => 'Days',
    'LANG_ITEMS_AVAILABILITY_FOR_TEXT' => 'Tillgängliga bilar',
    ...
    'LANG_ITEMS_AVAILABILITY_THIS_MONTH_TEXT' => 'Tillgängliga bilar för denna månad', // Not used
    'LANG_ITEMS_AVAILABILITY_NEXT_MONTH_TEXT' => 'Tillgängliga bilar för nästa månad', // Not used
    'LANG_ITEM_MODEL_ID_TEXT' => 'ID:',
    'LANG_TOTAL_ITEMS_TEXT' => 'Totalt antal bilar:',

    // class.ExtrasAvailability.php
    'LANG_EXTRAS_AVAILABILITY_FOR_TEXT' => 'Tillgängliga tillbehör',
    ...
    'LANG_EXTRAS_AVAILABILITY_THIS_MONTH_TEXT' => 'Tillgängliga tillbehör för denna månad', // Not used
    'LANG_EXTRAS_AVAILABILITY_NEXT_MONTH_TEXT' => 'Tillgängliga tillbehör för nästa månad', // Not used
    'LANG_EXTRA_ID_TEXT' => 'ID',
    'LANG_TOTAL_EXTRAS_TEXT' => 'Totalt antal tillbehör:',

    // class.ItemModelsController.php
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME1_TEXT' => 'Bränsle',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL1_TEXT' => 'Bränsle',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME2_TEXT' => 'Växellåda',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL2_TEXT' => 'Växellåda',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME3_TEXT' => 'Bränsleförbrukning',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL3_TEXT' => 'Bränsleförbrukning',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME4_TEXT' => 'Antal passagerare (inkl. förare)',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL4_TEXT' => 'Antal passagerare',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME5_TEXT' => 'Cylindervolym',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL5_TEXT' => 'Cylindervolym',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME6_TEXT' => 'Max bagage',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL6_TEXT' => 'Max bagage',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME7_TEXT' => 'Dörrar',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL7_TEXT' => 'Dörrar',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME8_TEXT' => 'Körsträcka',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL8_TEXT' => 'Körsträcka',
    'LANG_PRICING_PRICE_FROM_TEXT' => 'Prisgrupp',
    'LANG_PRICING_INQUIRE_TEXT' => 'Call',
    'LANG_PRICING_GET_A_QUOTE_TEXT' => 'Get a quote',
    'LANG_FEATURES_TEXT' => 'Extra information',
    'LANG_PRICING_GET_IT_TEXT' => 'Info Reservera',

    // class.LocationsController.php
    'LANG_LOCATIONS_BUSINESS_HOURS_TEXT' => 'Business Hours',
    'LANG_LOCATION_FEES_TEXT' => 'Platsavgifter',
    ...
    'LANG_ITEM_MODEL_MINIMUM_ALLOWED_AGE_TEXT' => 'Min. förarålder',
    'LANG_ITEM_MODEL_MAXIMUM_ALLOWED_AGE_TEXT' => 'Maximum Driver Age',
    'LANG_ITEM_MODEL_MIN_ALLOWED_AGE_TEXT' => 'Min. förarålder',
    ...
    'LANG_ITEM_MODEL_ADDITIONAL_INFORMATION_TEXT' => 'Extra information',
    ...
    'LANG_ITEM_MODEL_VISIT_PAGE_TEXT' => 'Visa bilinformation',
    ...
    'LANG_ORDER_S_CANCELLED_SUCCESSFULLY_TEXT' => 'Reservationen %s lyckad annulering.',
    'LANG_ORDER_NOT_CANCELLED_CODE_S_DOES_NOT_EXIST_TEXT' => 'Reservationen har inte annulerats. Reservation code %s - does not exist.',

    // template.Step8EditBooking.php
    'LANG_SEARCH_CHANGE_ORDER_TEXT' => 'Ändra
reservation',
    'LANG_SEARCH_CHANGE_ORDER2_TEXT' => 'Ändra reservation',
    'LANG_ORDER_NO_CODE_ERROR_TEXT' => 'Ange reservations nummer!',

    // Errors
    'LANG_ERROR_REQUIRED_FIELD_TEXT' => 'Obligatoriskt',
    'LANG_ERROR_IS_EMPTY_TEXT' => 'är tomt',
    'LANG_ERROR_SLIDER_CANT_BE_DISPLAYED_TEXT' => 'Slider can\'t be displayed',
    'LANG_CUSTOMER_DETAILS_NOT_FOUND_ERROR_TEXT' => 'Kunduppgifter existerar inte. Gör en ny sökning eller skapa ett nytt konto.',
    'LANG_ERROR_CUSTOMER_DETAILS_NO_ERROR_TEXT' => 'Inga fel',
    'LANG_CUSTOMER_EXCEEDED_LOOKUP_ATTEMPTS_ERROR_TEXT' => 'Du har överskridit antal sökningar. Var vänlig och ange dina kunduppgifter nedan.',
    'LANG_ERROR_ORDER_DOES_NOT_EXIST_TEXT' => 'existerar inte',
    'LANG_ITEM_MODELS_PLEASE_SELECT_AT_LEAST_ONE_ITEM_MODEL_ERROR_TEXT' => 'Välj minst en bil.',
    'LANG_ITEMS_PLEASE_SELECT_AT_LEAST_ONE_ITEM_ERROR_TEXT' => 'Välj minst en bil.',
    'LANG_ERROR_SEARCH_ENGINE_DISABLED_TEXT' => 'Bokningssystemet är inte tillgängligt för tillfället. Vad god försök lite senare.',
    'LANG_SEARCH_OUT_BEFORE_IN_ERROR_TEXT' => 'Datumet för att lämna bilen måste vara senare än hämtningsdatumet. Var god och ändra datumen.',
    'LANG_SEARCH_MINIMUM_DURATION_CANT_BE_LESS_THAN_S_ERROR_TEXT' => 'Minst antal nätter kan inte vara mindre än %s.',
    'LANG_SEARCH_ERROR_PLEASE_MODIFY_YOUR_SEARCH_CRITERIA_TEXT' => 'Var god och ändra dina sökkriterier.',
    'LANG_ERROR_PICKUP_IS_NOT_POSSIBLE_ON_TEXT' => 'Hämtning är inte möjligt',
    'LANG_ERROR_PLEASE_MODIFY_YOUR_PICKUP_TIME_BY_WEBSITE_TIME_TEXT' => 'Var god och modifiera tid &amp; datum för upphämtning efter boknings platsens tid &amp; datum.',
    'LANG_ERROR_CURRENT_DATE_TIME_TEXT' => 'Nuvarande tid &amp; datum är',
    'LANG_ERROR_EARLIEST_POSSIBLE_PICKUP_DATE_TIME_TEXT' => 'Du kan tidigast hämta',
    'LANG_ERROR_OR_NEXT_BUSINESS_HOURS_OF_PICKUP_LOCATION_TEXT' => 'eller först när stället öppnar.',
    'LANG_ERROR_PICKUP_DATE_CANT_BE_LESS_THAN_RETURN_DATE_TEXT' => 'Tid &amp; datum för upphämtning kan inte vara mindre än tid &amp; datum för återlämning. Var god och ange korrekt tid &amp; datum.',
    'LANG_ERROR_PICKUP_LOCATION_IS_CLOSED_AT_THIS_DATE_TEXT' => 'Under valt datum så håller vi stängt för hämtning på %s.',
    'LANG_ERROR_PICKUP_LOCATION_IS_CLOSED_AT_THIS_TIME_TEXT' => 'Under vald tidpunkt så håller vi stängt för hämtning på %s.',
    'LANG_ERROR_RETURN_LOCATION_IS_CLOSED_AT_THIS_DATE_TEXT' => 'Under valt datum så håller vi stängt för återlämning. %s',
    'LANG_ERROR_RETURN_LOCATION_IS_CLOSED_AT_THIS_TIME_TEXT' => 'Under vald tidpunkt så håller vi stängt för återlämning. %s',
    'LANG_ERROR_AFTERHOURS_PICKUP_LOCATION_IS_CLOSED_AT_THIS_TIME_TEXT' => 'Efter stängning så gäller annan adress för hämtning av bil, dock är där också stängd under denna tidpunkt.',
    'LANG_ERROR_AFTERHOURS_RETURN_LOCATION_IS_CLOSED_AT_THIS_TIME_TEXT' => 'Efter stängning så gäller annan adress för återlämning av bil, dock är där också stängd under denna tidpunkt.',
    'LANG_ERROR_LOCATION_OPEN_HOURS_ARE_TEXT' => 'Öppettiderna är %s.',
    'LANG_ERROR_LOCATION_WEEKLY_OPEN_HOURS_ARE_TEXT' => 'Öppettiderna under veckan är:',
    'LANG_ERROR_AFTERHOURS_PICKUP_LOCATION_OPEN_HOURS_ARE_TEXT' => 'Hämtning utav bil efter stängning möjligt klockan %s.',
    'LANG_ERROR_AFTERHOURS_RETURN_LOCATION_OPEN_HOURS_ARE_TEXT' => 'Återlämning utav bil efter stängning är möjligt klockan %s.',
    'LANG_ERROR_AFTERHOURS_PICKUP_IS_NOT_ALLOWED_AT_LOCATION_TEXT' => 'Det är inte möjligt att hämta en bil när det är stängt',
    'LANG_ERROR_AFTERHOURS_RETURN_IS_NOT_ALLOWED_AT_LOCATION_TEXT' => 'Det är inte möjligt att återlämna en bil när det är stängt',
    'LANG_SEARCH_MAXIMUM_DURATION_CANT_BE_MORE_THAN_S_ERROR_TEXT' => 'Maximal reservations längd kan inte vara mer än  %s.',
    'LANG_ORDER_INVALID_CODE_ERROR_TEXT' => 'Felaktig reservations nummer eller så finns inte reservationen mer.',
    'LANG_ERROR_INVALID_SECURITY_CODE_TEXT' => 'Felaktig säkerhetskod.',
    ...
    'LANG_ORDER_NO_S_PICKED_UP_ERROR_TEXT' => 'Reservations nr. %s har redan markerats som hämtat, och är inte längre tillgänglig för redigering.',
    'LANG_ORDER_NO_S_CANCELLED_ERROR_TEXT' => 'Reservations nr. %s har annullerats.',
    'LANG_ORDER_NO_S_REFUNDED_ERROR_TEXT' => 'Reservations nr. %s har redan återbetalats och är inte tillgänglig längre.',
    'LANG_ERROR_PAYMENT_METHOD_IS_NOT_YET_IMPLEMENTED_TEXT' => 'Felmeddelande: Du försökte betala med en betalningsmetod som inte är tillgängligt för tillfället.',
    'LANG_ORDER_OTHER_ERROR_TEXT' => 'Felmeddelande: Om du fortsätter se detta meddelande, var vänlig kontakta admin.',
    ...
    'LANG_PAYMENT_METHOD_DEFAULT_PAYPAL_DESCRIPTION_TEXT' => 'Säker betalning',
    'LANG_PAYMENT_METHOD_DEFAULT_STRIPE_TEXT' => 'Credit Card (via Stripe.com)',
    'LANG_PAYMENT_METHOD_DEFAULT_BANK_TEXT' => 'Banköverförning',
    'LANG_PAYMENT_METHOD_DEFAULT_BANK_DETAILS_TEXT' => 'Bank detaljer',
    'LANG_PAYMENT_METHOD_DEFAULT_PAY_OVER_THE_PHONE_TEXT' => 'Betala med telefonen',
    'LANG_PAYMENT_METHOD_DEFAULT_PAY_ON_ARRIVAL_TEXT' => 'Betala på plats',
    'LANG_PAYMENT_METHOD_DEFAULT_PAY_ON_ARRIVAL_DETAILS_TEXT' => 'Kreditkort krävs',
    'LANG_EMAIL_DEFAULT_DEAR_TEXT' => 'Hej',
    'LANG_EMAIL_DEFAULT_REGARDS_TEXT' => 'Vänliga hälsningar',
    'LANG_EMAIL_DEFAULT_TITLE_ORDER_DETAILS_TEXT' => 'Reservations information - nr. [RESERVATION_CODE]',
    'LANG_EMAIL_DEFAULT_TITLE_ORDER_CONFIRMED_TEXT' => 'Reservations nr. [RESERVATION_CODE] - bekräftat',
    'LANG_EMAIL_DEFAULT_TITLE_ORDER_CANCELLED_TEXT' => 'Reservations nr. [RESERVATION_CODE] - annullerad',
    'LANG_EMAIL_DEFAULT_ADM_TITLE_ORDER_DETAILS_TEXT' => 'Notifiering: Ny reservation - [RESERVATION_CODE]',
    'LANG_EMAIL_DEFAULT_ADM_TITLE_ORDER_CONFIRMED_TEXT' => 'Notifiering: Reservation betald - [RESERVATION_CODE]',
    'LANG_EMAIL_DEFAULT_ADM_TITLE_ORDER_CANCELLED_TEXT' => 'Notifiering: Reservation annullerad - [RESERVATION_CODE]',
    'LANG_EMAIL_DEFAULT_BODY_ORDER_RECEIVED_TEXT' => 'Din reservation har mottagits.',
    'LANG_EMAIL_DEFAULT_BODY_ORDER_DETAILS_TEXT' => 'Detaljer för din reservation:',
    'LANG_EMAIL_DEFAULT_BODY_PAYMENT_RECEIVED_TEXT' => 'Vi har fått din betalning. Din reservation är nu bekräftad.',
    'LANG_EMAIL_DEFAULT_BODY_ORDER_CANCELLED_TEXT' => 'Din reservation, nr. [RESERVATION_CODE] har annulerats.',
    'LANG_EMAIL_DEFAULT_ADM_BODY_ORDER_RECEIVED_TEXT' => 'Ny reservation nr. [RESERVATION_CODE] mottagits från [CUSTOMER_NAME].',
    'LANG_EMAIL_DEFAULT_ADM_BODY_ORDER_DETAILS_TEXT' => 'Reservations detaljer:',
    'LANG_EMAIL_DEFAULT_ADM_BODY_ORDER_PAID_TEXT' => 'Reservations nr. [RESERVATION_CODE] var nyligen betald av [CUSTOMER_NAME].',
    'LANG_EMAIL_DEFAULT_ADM_BODY_ORDER_CANCELLED_TEXT' => 'Reservations nr. [RESERVATION_CODE] för [CUSTOMER_NAME] har nyligen annulerats.',
    'LANG_EMAIL_DEFAULT_ADM_BODY_CANCELLED_ORDER_DETAILS_TEXT' => 'Detaljerna från den annulerade reservationen:',
    ...
    'LANG_SEARCH_PICKUP_DATE_SELECT_ERROR_TEXT' => 'Var god och välj ett datum!',
    ...
    'LANG_SEARCH_RETURN_DATE_SELECT_ERROR_TEXT' => 'Var god och välj ett datum!',
    ...
    'LANG_SEARCH_TRY_DIFFERENT_DATE_OR_CRITERIA_ERROR_TEXT' => 'Inga tillgängliga bilar, var god och ändra datum eller gör en ny sökning.',
...
(New WP User)',
    ...
    'LANG_SETTINGS_DEFAULT_PAYMENT_CANCELLED_PAGE_TITLE_TEXT' => 'Betalning annullerad',
    'LANG_SETTINGS_DEFAULT_PAYMENT_CANCELLED_PAGE_CONTENT_TEXT' => 'Betalningen har annullerats. Din reservation har inte bekräftats.',
    'LANG_SETTINGS_DEFAULT_ORDER_CONFIRMED_PAGE_TITLE_TEXT' => 'Reservation bekräftad.',
    'LANG_SETTINGS_DEFAULT_ORDER_CONFIRMED_PAGE_CONTENT_TEXT' => 'Tack! Vi har fått din betalning och din reservation är nu bekräftad.',
    'LANG_SETTINGS_DEFAULT_TERMS_AND_CONDITIONS_PAGE_TITLE_TEXT' => 'Villkor för att hyra bil',
    ...
    'LANG_TRANSACTION_ID_TEXT' => 'Transaktion ID',
    'LANG_TRANSACTION_ID_EXTERNAL_ID_AND_LEGAL_COUNTRY_TEXT' => 'Transaction Id, External Id & Legal Country',
    'LANG_TRANSACTION_EXTERNAL_ID_TEXT' => 'External Transaktion ID',
    ...
    'LANG_TRANSACTION_PAYER_EMAIL_TEXT' => 'Betalarens email',
