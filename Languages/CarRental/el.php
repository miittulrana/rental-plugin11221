...
return array(
    // Ext Settings
    'EXT_NAME' => 'Ενοικιάσεις αυτοκινήτων',
    ...
    // Admin - Global
    'LANG_ORDERS_VIEW_TEXT' => 'Εμφάνισε τις Κρατήσεις',
    'LANG_ORDERS_VIEW_UNPAID_TEXT' => 'Εμφάνισε απλήρωτες Κρατήσεις',
    'LANG_ORDERS_NONE_YET_TEXT' => 'Καμία κράτηση ακόμα',
    'LANG_ORDER_DETAILS_TEXT' => 'Πληροφορίες Κράτησης',
    'LANG_CUSTOMER_DETAILS_FROM_DB_TEXT' => 'Πληροφορίες Πελάτη (Τελευταία Έκδοση στη βάση δεδομένων)',
    'LANG_ORDER_STATUS_TEXT' => 'Κατάσταση Κράτησης',
    'LANG_ORDER_STATUS_UPCOMING_TEXT' => 'Σε εξέλιξη',
    'LANG_ORDER_STATUS_DEPARTED_TEXT' => 'Αναχώρηση',
    'LANG_ORDER_STATUS_COMPLETED_EARLY_TEXT' => 'Πρόωρη Ολοκλήρωση',
    'LANG_ORDER_STATUS_COMPLETED_TEXT' => 'Ολοκληρώθηκε',
    'LANG_ORDER_STATUS_ACTIVE_TEXT' => 'Ενεργή',
    'LANG_ORDER_STATUS_CANCELLED_TEXT' => 'Ακυρωμένη',
    'LANG_ORDER_STATUS_PAID_TEXT' => 'Πληρωμένη',
    'LANG_ORDER_STATUS_UNPAID_TEXT' => 'Απλήρωτη',
    'LANG_ORDER_STATUS_REFUNDED_TEXT' => 'Επιστροφή Χρημάτων',
    'LANG_INVOICE_PRINT_TEXT' => 'Εκτύπωση Τιμολογίου',
    'LANG_CUSTOMER_BACK_TO_ORDERS_LIST_TEXT' => 'Επιστροφή στη\'s λίστα Κρατήσεις Πελατών',
    ...
    'LANG_ORDERS_BY_CUSTOMER_TEXT' => 'Κρατήσεις Πελατών',
    'LANG_ORDERS_BY_S_TEXT' => 'Κρατήσεις από %s',
    'LANG_ALL_ORDERS_TEXT' => 'Όλες οι κρατήσεις',
    'LANG_ALL_PICKUPS_TEXT' => 'Όλες οι παραλαβές',
    'LANG_ALL_RETURNS_TEXT' => 'Όλες οι παραδόσεις',
    ...
    'LANG_PREPAYMENT_ITEMS_PRICE_TEXT' => 'Τιμές αυτοκινήτων',
    ...
    'LANG_PRICING_REGULAR_PRICE_TEXT' => ' Κανονική τιμή',
    'LANG_PRICE_TYPE_TEXT' => 'Τύπος Τιμή',
    ...
    'LANG_CALENDAR_NO_CALENDARS_FOUND_TEXT' => 'Δεν βρέθηκαν αποτελέσματα για το επιλεγμένο εύρος ημερομηνιών',
    'LANG_PAGE_SELECT_TEXT' => ' - Επιλογή σελίδας - ',
    'LANG_SELECT_EMAIL_TYPE_TEXT' => '--- Επιλέξτε τύπο E-mail ---',
    ...
    'LANG_ITEM_MODEL_ADD_EDIT_TEXT' => 'Προσθήκη / Επεξεργασία Αυτοκινήτου Model',

    // Item Element
    'LANG_ITEM_TEXT' => 'Αυτοκίνητο',
    'LANG_ITEM_MANAGER_TEXT' => 'Car Manager',
    'LANG_ITEM_ADD_EDIT_TEXT' => 'Προσθήκη / Επεξεργασία Αυτοκινήτου',
...
and when plugin is network-enabled in multisite mode',
    ...
    'LANG_MANUFACTURER_TEXT' => 'Κατασκευαστής',
    'LANG_MANUFACTURER_ID_TEXT' => 'Κατασκευαστής Id',
    'LANG_MANUFACTURER_IDS_TEXT' => 'Κατασκευαστής Ids',
    'LANG_MANUFACTURER_SELECT_TEXT' => 'Κατασκευαστής:',
    'LANG_MANUFACTURER_SELECT2_TEXT' => '- Select Κατασκευαστής -', // MB
    'LANG_MANUFACTURER_ADD_EDIT_TEXT' => 'Προσθήκη / Επεξεργασία κατασκευαστή',

    // Class Element
    'LANG_CLASS_TEXT' => 'Κατηγορία',
    'LANG_CLASS_ID_TEXT' => 'Κατηγορία Id',
    'LANG_CLASS_IDS_TEXT' => 'Κατηγορία Ids',
    'LANG_CLASS_SELECT_TEXT' => 'Κατηγορία:',
    'LANG_CLASS_SELECT2_TEXT' => '- Select Κατηγορία -', // MB
    'LANG_CLASS_ADD_NEW_TEXT' => 'Add New Κατηγορία',
    'LANG_CLASS_LIST_TEXT' => 'Κατηγορία List',
    'LANG_CLASS_ADD_EDIT_TEXT' => 'Προσθήκη / Επεξεργασία Body Type',
    ...
    // Attribute Element
    'LANG_ATTRIBUTE_ADD_EDIT_TEXT' => 'Προσθήκη / Επεξεργασία Attribute',

    // Feature Element
    'LANG_FEATURE_TEXT' => 'Feature',
    'LANG_FEATURE_ADD_EDIT_TEXT' => 'Προσθήκη / Επεξεργασία Feature',
    ...
    'LANG_ITEM_MODEL_OPTION_ADD_EDIT_TEXT' => 'Προσθήκη / Επεξεργασία Car Model Option',
    'LANG_ITEM_OPTION_ADD_EDIT_TEXT' => 'Προσθήκη / Επεξεργασία Car Option',
    'LANG_BLOCK_ITEM_MODEL_TEXT' => 'Block Car Model',
    'LANG_BLOCK_ITEM_TEXT' => 'Block Car',

    // Item Model Element
    'LANG_ITEM_MODEL_PRICES_TEXT' => 'Τιμές αυτοκινητων',
    'LANG_PRICE_PLAN_ADD_EDIT_TEXT' => 'Προσθήκη / Επεξεργασία Price Plan',
    'LANG_PRICE_PLAN_DISCOUNT_ADD_EDIT_TEXT' => 'Προσθήκη / Επεξεργασία Price Plan Discount',

    // Extras Element
    'LANG_EXTRAS_MANAGER_TEXT' => 'Extras Manager',
    'LANG_EXTRA_ADD_EDIT_TEXT' => 'Προσθήκη / Επεξεργασία Extra',
    'LANG_EXTRA_OPTION_ADD_EDIT_TEXT' => 'Προσθήκη / Επεξεργασία Extra Option',
    'LANG_EXTRA_DISCOUNT_ADD_EDIT_TEXT' => 'Προσθήκη / Επεξεργασία Extra Discount',
    'LANG_BLOCK_EXTRA_TEXT' => 'Block Extra',

    // Location Element
    'LANG_LOCATION_GLOBAL_TEXT' => 'Global Location',
    'LANG_LOCATION_MANAGER_TEXT' => 'Location Manager',
    'LANG_LOCATION_ADD_EDIT_TEXT' => 'Προσθήκη / Επεξεργασία Location',
    'LANG_LOCATION_STATUS_OPEN_TEXT' => 'Ανοιχτά',
    'LANG_LOCATION_STATUS_CLOSED_TEXT' => 'Κλειστά',
    'LANG_LOCATION_LUNCH_TEXT' => 'Lunch',
    'LANG_LOCATION_LUNCH_TIME_TEXT' => 'Lunch Time',

    // Distance Element
    'LANG_DISTANCE_ADD_EDIT_TEXT' => 'Προσθήκη / Επεξεργασία Distance',
    ...
    'LANG_CUSTOMER_ADD_EDIT_TEXT' => 'Προσθήκη/Επεξεργασία Customer',
    ...
    'LANG_ORDER_ADD_EDIT_TEXT' => 'Προσθήκη/Επεξεργασία Reservation',
    ...
    'LANG_TAX_ADD_EDIT_TEXT' => 'Προσθήκη / Επεξεργασία Tax',

    // Payment Method Element
    'LANG_PAYMENT_METHOD_ADD_EDIT_TEXT' => 'Προσθήκη / Επεξεργασία Payment Method',
    ...
    // Prepayment Element
    'LANG_PREPAYMENT_ADD_EDIT_TEXT' => 'Προσθήκη / Επεξεργασία Prepayment',

    // Ext - Popular
    'LANG_ITEM_MODEL_TEXT' => 'Μοντέλο Αυτοκινήτου',
    'LANG_EXTRA_TEXT' => 'Εξτρα',
    'LANG_RENTAL_OPTION_TEXT' => 'Επιλογή Ενοικίασης',
    'LANG_ITEM_MODELS_TEXT' => 'Αυτοκίνητα model',
    'LANG_ITEMS_TEXT' => 'Αυτοκίνητα',
    'LANG_EXTRAS_TEXT' => 'Εξτρας',
    'LANG_RENTAL_OPTIONS_TEXT' => 'Επιλογές Ενοικίασης',
    'LANG_ITEM_MODEL_SHOW_TEXT' => 'Εμφάνισε Αυτοκίνητο model',
    'LANG_COUPON_TEXT' => 'Κουπόνι',

    // Search Element
    'LANG_SEARCH_TEXT' => 'Αναζήτηση',
    'LANG_SEARCH_DEFAULT_SEARCH_PAGE_URL_SLUG_TEXT' => 'search', // Latin letters only
    'LANG_TAX_WITH_TEXT' => 'με Φόρο',
    'LANG_TAX_WITHOUT_TEXT' => 'w/o Φόρος',
    'LANG_TAX_SHORT_TEXT' => 'Φόρος',
    'LANG_DEPOSIT_TEXT' => 'Κατάθεση',
    'LANG_DISCOUNT_TEXT' => 'Έκπτωση',
    'LANG_PREPAYMENT_TEXT' => 'Ποσό προπληρωμής',
    'LANG_ITEM_MODELS_NONE_AVAILABLE_TEXT' => 'Κανένα Αμάξι διαθέσιμο',
    'LANG_ITEM_MODELS_NONE_AVAILABLE_IN_THIS_CLASS_TEXT' => 'Κανένα αμάξι διαθέσιμο σε αυτή την κατηγορία',
    'LANG_ITEMS_NONE_AVAILABLE_TEXT' => 'Κανένα Αμάξι διαθέσιμο',
    'LANG_ITEMS_NONE_AVAILABLE_IN_THIS_CLASS_TEXT' => 'Κανένα αμάξι διαθέσιμο σε αυτή την κατηγορία',
    'LANG_EXTRAS_NONE_AVAILABLE_TEXT' => 'Κανένα extras διαθέσιμο',
    ...
    'LANG_ORDER_MARK_PAID_TEXT' => 'Σήμανση ως πληρωμένο',
    'LANG_ORDER_MARK_COMPLETED_EARLY_TEXT' => 'Mark Completed Early',
    'LANG_ORDER_REFUND_TEXT' => 'Επιστροφή πληρωμής',
    'LANG_LOCATION_SELECT2_TEXT' => '-- Επιλέξτε τοποθεσία --',
    'LANG_LOCATIONS_ALL_TEXT' => 'οποιοδήποτε κατάστημα ',
    'LANG_PRICING_DAILY_TEXT' => 'Καθημερινά',
    'LANG_PRICING_HOURLY_TEXT' => 'Ωριαία',
    'LANG_PRICING_PER_ORDER2_TEXT' => 'Per Reservation',
    'LANG_PRICING_COMBINED_DAILY_AND_HOURLY_TEXT' => 'σε συνδυασμό  - Ημερομίσθιου &amp; ωρομίσθιου',
    ...
    'LANG_ORDER_TEXT' => 'Κράτηση',
    'LANG_PICKUP_TEXT' => 'Τόπος Παραλαβής',
    'LANG_RETURN_TEXT' => 'Τόπος Επιστροφής',
    'LANG_INFORMATION_TEXT' => 'Πληροφορίες Αυτοκινήτων',
    'LANG_CITY_AND_LOCATION_TEXT' => 'Πόλη &amp; Τοποθεσία:',
    'LANG_SEARCH_PICKUP_CITY_AND_LOCATION_SELECT_TEXT' => 'Τόπος Παραλαβής Πόλη &amp; Τοποθεσία:',
    'LANG_SEARCH_PICKUP_CITY_AND_LOCATION_SELECT2_TEXT' => '- Select Τόπος Παραλαβής Πόλη &amp; Τοποθεσία -', // MB
    'LANG_SEARCH_RETURN_CITY_AND_LOCATION_SELECT_TEXT' => 'Τόπος Επιστροφής Πόλη &amp; Τοποθεσία:',
    'LANG_SEARCH_RETURN_CITY_AND_LOCATION_SELECT2_TEXT' => '- Select Τόπος Επιστροφής Πόλη &amp; Τοποθεσία -', // MB
    'LANG_ORDER_PERIOD_SELECT_TEXT' => 'Περίοδος κράτησης:',
    'LANG_ORDER_PERIOD_SELECT2_TEXT' => ' - Select Period -', // MB
    'LANG_COUPON_CODE_TEXT' => 'Κωδικός Κουπονιού',
    'LANG_ORDER_CODE_INPUT_TEXT' => 'Νούμερο Κράτησης:',
    'LANG_ORDER_CODE_INPUT2_TEXT' => '- Νούμερο Κράτησης -', // MB
    'LANG_COUPON_CODE_INPUT_TEXT' => 'Έχω ένα κουπόνι(κουπόνι):',
    'LANG_COUPON_CODE_INPUT2_TEXT' => '- Έχω ένα κουπόνι(κουπόνι) -', // MB
    'LANG_LOCATION_PICKUP_TEXT' => 'Τόπος Παραλαβής',
    'LANG_LOCATION_RETURN_TEXT' => 'Τόπος Επιστροφής',
    'LANG_ALL_BODY_TYPES_DROPDOWN_TEXT' => '---- All Types ----',
    'LANG_ALL_TRANSMISSION_TYPES_DROPDOWN_TEXT' => '---- All Transmissions ----',
    'LANG_SELECT_PICKUP_LOCATION_TEXT' => '-- Επιλέξτε Τόπο Παραλαβής --',
    'LANG_SELECT_RETURN_LOCATION_TEXT' => '-- Επιλέξτε Τόπο Επιστροφής --',
    'LANG_PICKUP_DATE_TEXT' => 'Ημερομηνία Παραλαβής',
    'LANG_RETURN_DATE_TEXT' => 'Ημερομηνία Παράδοσης',
    ...
    'LANG_SHOW_ITEM_DESCRIPTION_TEXT' => 'Εμφάνιση περιγραφή αυτοκινήτου ',
    'LANG_ORDER_UPDATE_MY_ORDER_TEXT' => 'Ενημέρωση Κρατησή μου',
    'LANG_CANCEL_ORDER_TEXT' => 'Ακύρωση κράτησης',
    'LANG_ORDER_CHANGE_DATE_TIME_AND_LOCATION_TEXT' => 'Αλλαγή Ημερομηνίας, ώρας &amp; τοποθεσίας',
    'LANG_ORDER_CHANGE_ORDERED_ITEM_MODELS_TEXT' => 'Αλλαγή αυτοκινήτων',
    'LANG_ORDER_CHANGE_ORDERED_ITEMS_TEXT' => 'Αλλαγή αυτοκινήτων',
    'LANG_CHANGE_EXTRAS_TEXT' => 'Αλλαγή Extras',
    'LANG_CHANGE_RENTAL_OPTIONS_TEXT' => 'Αλλαγή Επιλογών Ενοικίασης ',
    'LANG_IN_THIS_LOCATION_TEXT' => 'Σε αυτόν τον κλάδο',
    'LANG_AFTERHOURS_PICKUP_IS_NOT_ALLOWED_TEXT' => 'Δεν επιτρέπετε',
    'LANG_AFTERHOURS_RETURN_IS_NOT_ALLOWED_TEXT' => 'Δεν επιτρέπετε',

    // Search step no. 3 - search results
    'LANG_DISTANCE_AWAY_TEXT' => '%s away',
    'LANG_ORDER_DATA_TEXT' => 'Στοιχεία Κράτησης',
    'LANG_ORDER_CODE_TEXT' => 'Κωδικός Κράτησης',
    'LANG_ORDER_CODE2_TEXT' => 'Κωδικός Κράτησης', // Uppercase lowercase
    'LANG_ORDER_EDIT_TEXT' => 'Επεξεργασία',
    'LANG_ORDER_VIEW_DETAILS_TEXT' => 'View Reservation Details',
    'LANG_ORDER_PICKUP_TEXT' => 'Παραλαβή',
    'LANG_ORDER_BUSINESS_HOURS_TEXT' => 'Εργάσιμες ώρες',
    'LANG_ORDER_FEE_TEXT' => 'Τέλη',
    'LANG_ORDER_RETURN_TEXT' => 'Επιστροφή',
    'LANG_ORDER_NIGHTLY_RATE_TEXT' => 'μετά από ώρες',
    'LANG_ORDER_AFTERHOURS_TEXT' => 'μετά από ώρες',
    'LANG_ORDER_EARLY_TEXT' => 'Early',
    'LANG_ORDER_LATE_TEXT' => 'Late',
    'LANG_ORDER_AFTERHOURS_PICKUP_TEXT' => 'Παραλαβή μετά απο καθορισμένες ώρες',
    'LANG_ORDER_AFTERHOURS_PICKUP_IMPOSSIBLE_TEXT' => 'Μη εφικτό',
    'LANG_ORDER_AFTERHOURS_RETURN_TEXT' => 'Παράδοση μετά απο καθορισμένες ώρες',
    'LANG_ORDER_AFTERHOURS_RETURN_IMPOSSIBLE_TEXT' => 'Μη εφικτό',
    'LANG_SEARCH_RESULTS_TEXT' => 'Αποτελέσματα Αναζήτησης',

    // Search step no. 4 - booking options
    'LANG_SELECT_RENTAL_OPTIONS_TEXT' => 'Επιλέξτε Επιλογές Ενοικίασης',
    'LANG_SELECTED_ITEMS_TEXT' => 'Επιλεγμένα αυτοκίνητα',
    'LANG_FOR_DEPENDANT_ITEM_TEXT' => ' (for %s)',
    'LANG_NO_EXTRAS_AVAILABLE_CLICK_CONTINUE_TEXT' => 'Δεν διατίθενται έξτρα αυτοκινήτων. Κάντε κλικ στο κουμπί συνέχεια',

    // Search step no. 5 - booking details
    'LANG_PICKUP_DATE_AND_TIME_TEXT' => 'Παραλαβή ημερομηνία &amp; χρόνος',
    'LANG_RETURN_DATE_AND_TIME_TEXT' => 'Παράδοση ημερομηνία &amp; χρόνος',
    'LANG_UNIT_PRICE_TEXT' => 'Τιμή μονάδας',
    'LANG_LOCATION_PICKUP_FEE_TEXT' => 'Τέλη παραλαβής',
    'LANG_LOCATION_PICKUP_FEE2_TEXT' => 'Τέλη παραλαβής', // Uppercase lowercase
    'LANG_LOCATION_RETURN_FEE_TEXT' => 'Τέλη παράδοσης',
    'LANG_LOCATION_RETURN_FEE2_TEXT' => 'Τέλη παράδοσης', // Uppercase lowercase
    'LANG_LOCATION_NIGHTLY_RATE_APPLIED_TEXT' => '(Εφαρμογή νυχτερινού φόρου)',
    'LANG_ITEMS_QUANTITY_SUFFIX_TEXT' => 'αυτοκίνητο/α',
    'LANG_EXTRAS_QUANTITY_SUFFIX_TEXT' => 'έξτρα/ς',
    'LANG_PAY_NOW_OR_AT_PICKUP_TEXT' => 'Πληρωμή τώρα/ κατά την Παραλαβή',
    'LANG_PAYMENT_PAY_NOW_TEXT' => 'Πληρωμή τώρα',
    'LANG_PAYMENT_PAY_AT_PICKUP_TEXT' => 'Πληρωμή κατα την παραλαβή',
    'LANG_PAYMENT_PAY_LATER_OR_ON_RETURN_TEXT' => 'Πληρωμή αργότερα / στην Επιστροφή',
    'LANG_PAYMENT_PAY_LATER_TEXT' => 'Πληρωμή αργότερα',
    'LANG_PAYMENT_PAY_ON_RETURN_TEXT' => 'Πληρωμή στην Επιστροφή',
    'LANG_ORDER_RENTAL_DETAILS_TEXT' => 'Λεπτομέρειες Ενοικίασης',
    'LANG_PAYMENT_GROSS_TOTAL_TEXT' => ' Μερικό σύνολο',
    'LANG_PAYMENT_GRAND_TOTAL_TEXT' => 'Σύνολο',
    'LANG_CUSTOMER_DETAILS_TEXT' => 'Λεπτομέρειες πελάτη ',
    'LANG_CUSTOMER_SEARCH_FOR_EXISTING_TEXT' => 'Αναζήτηση για Υπάρχων Στοιχεία Πελάτη ',
    'LANG_CUSTOMER_EXISTING_TEXT' => 'Υπάρχων πελάτης',
    ...
    'LANG_CUSTOMER_FETCH_DETAILS_TEXT' => 'Λήψη Λεπτομερειών',
    'LANG_CUSTOMER_OR_ENTER_DETAILS_TEXT' => 'Ή να δημιουργήστε ένα νέο λογαριασμό ',
    'LANG_CUSTOMER_TEXT' => 'Πελάτης',
    'LANG_CUSTOMER_SELECT_TEXT' => 'Select Customer',
    'LANG_CITY_TEXT' => 'Πόλη',
    'LANG_STATE_TEXT' => 'Πολιτεία',
    'LANG_COUNTRY_TEXT' => 'Χώρα',
    'LANG_ADDITIONAL_COMMENTS_TEXT' => 'Επιπλέον Σχόλια',
    'LANG_CUSTOMER_ID_TEXT' => 'ID Πελάτη',
    ...
    'LANG_PAYMENT_PAY_BY_SHORT_TEXT' => 'Πληρώστε με',
    'LANG_SEARCH_I_AGREE_WITH_TERMS_AND_CONDITIONS_TEXT' => 'Αποδέχομαι τους όρους χρήσης',
    'LANG_TERMS_AND_CONDITIONS_TEXT' => 'όροι χρήσης',
    'LANG_FIELD_REQUIRED_TEXT' => 'Αυτό το πεδίο είναι υποχρεωτικό',

    // Search step no. 6 - process booking
    'LANG_PAYMENT_DETAILS_TEXT' => 'Λεπτομέρειες πληρωμής',
    'LANG_PAYMENT_OPTION_TEXT' => 'Πληρωμή με',
    'LANG_PAYMENT_PROCESSING_TEXT' => 'επεξεργασία πληρωμής...',
    'LANG_ORDER_PLEASE_WAIT_UNTIL_WILL_BE_PROCESSED_TEXT' => 'Παρακαλώ περιμένετε, επεξεργαζόμαστε την παραγγελία σας...',

    // display-booking-confirm.php
    'LANG_STEP5_PAY_ONLINE_TEXT' => 'Online Πληρωμή',
    'LANG_STEP5_PAY_AT_PICKUP_TEXT' => 'Πληρωμή κατα την παραλαβή',
    'LANG_ORDER_RECEIVED_YOUR_CODE_S_TEXT' => 'Η κρατησή σας καταχωρύθηκε. Κωδικός Κράτησης %s.',
    'LANG_ORDER_CONFIRMED_YOUR_CODE_S_TEXT' => 'Η κρατησή σας καταχωρύθηκε. Κωδικός Κράτησης %s.',
    'LANG_ORDER_UPDATED_YOUR_CODE_S_TEXT' => 'Η κρατησή σας καταχωρύθηκε. Κωδικός Κράτησης %s.',
    'LANG_INVOICE_SENT_TO_YOUR_EMAIL_ADDRESS_TEXT' => 'Τιμολόγιο αποστέλλεται στην ηλεκτρονική σας διεύθυνση ',

    // display-booking-failure.php
    'LANG_ORDER_FAILURE_TEXT' => 'Η κράτηση απέτυχε',
    'LANG_SEARCH_ALL_ITEM_MODELS_TEXT' => 'Αναζήτηση όλων των αυτοκινήτων',
    ...
    'LANG_DAY_PRICE_TEXT' => 'Ημερομίσθιο',
    'LANG_HOUR_PRICE_TEXT' => 'Ωρομίσθιο',
    'LANG_NO_ITEM_MODELS_IN_THIS_CATEGORY_TEXT' => 'Δεν υπάρχουν αυτοκίνητα σε αυτή την κατηγορία',
    'LANG_PRICE_FOR_DAY_FROM_TEXT' => 'Το ημερομίσθιο ξεκινάει από',
    'LANG_PRICE_FOR_HOUR_FROM_TEXT' => 'Το ωρομίσθιο ξεκινάει από',
    'LANG_PRICE_WITH_APPLIED_TEXT' => 'με εφαρμογή',
    'LANG_WITH_APPLIED_DISCOUNT_TEXT' => 'Έκπτωση',

    // class.ItemsAvailability.php
    'LANG_MONTH_DAY_TEXT' => 'Ημέρα',
    'LANG_MONTH_DAYS_TEXT' => 'Days',
    'LANG_ITEMS_AVAILABILITY_FOR_TEXT' => 'Διαθέσιμα αυτοκίνητα',
    'LANG_ITEMS_AVAILABILITY_IN_NEXT_30_DAYS_TEXT' => 'Διαθέσιμα αυτοκίνητα για τις επόμενες 30 μέρες',
    'LANG_ITEMS_PARTIAL_AVAILABILITY_FOR_TEXT' => 'Partial Cars Availability For',
    'LANG_ITEMS_AVAILABILITY_THIS_MONTH_TEXT' => 'Διαθέσιμα αυτοκίνητα αυτό το μήνα', // Not used
    'LANG_ITEMS_AVAILABILITY_NEXT_MONTH_TEXT' => 'Διαθέσιμα αυτοκίνητα τον επόμενο μήνα', // Not used
    'LANG_ITEM_MODEL_ID_TEXT' => 'ID:',
    'LANG_TOTAL_ITEMS_TEXT' => 'Συνολικά αυτοκίνητα:',

    // class.ExtrasAvailability.php
    'LANG_EXTRAS_AVAILABILITY_FOR_TEXT' => 'Διαθέσιμα έξτρας για',
    'LANG_EXTRAS_AVAILABILITY_IN_NEXT_30_DAYS_TEXT' => 'Διαθέσιμα έξτρας για τις επόμενες 30 μέρες',
    'LANG_EXTRAS_PARTIAL_AVAILABILITY_FOR_TEXT' => 'Partial Extras Availability For',
    'LANG_EXTRAS_AVAILABILITY_THIS_MONTH_TEXT' => 'Διαθέσιμα έξτρας για αυτό τον μήνα', // Not used
    'LANG_EXTRAS_AVAILABILITY_NEXT_MONTH_TEXT' => 'Διαθέσιμα έξτρας για τον επόμενο μήνα', // Not used
    'LANG_EXTRA_ID_TEXT' => 'ID',
    'LANG_TOTAL_EXTRAS_TEXT' => 'Συνολικά έξτρας:',

    // class.ItemModelsController.php
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME1_TEXT' => 'καύσιμα',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL1_TEXT' => 'καύσιμα',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME2_TEXT' => 'κιβώτιο ταχυτήτων',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL2_TEXT' => 'κιβώτιο ταχυτήτων',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME3_TEXT' => 'κατανάλωση καυσίμου',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL3_TEXT' => 'κατανάλωση καυσίμου',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME4_TEXT' => 'Συνολικοί επιβάτες',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL4_TEXT' => 'Συνολικοί επιβάτες',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME5_TEXT' => 'κυβισμός',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL5_TEXT' => 'κυβισμός',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME6_TEXT' => 'Συνολικές βαλίτσες',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL6_TEXT' => 'Συνολικές βαλίτσες',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME7_TEXT' => 'Πόρτες',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL7_TEXT' => 'Πόρτες',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME8_TEXT' => 'Απόσταση σε Μίλια',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL8_TEXT' => 'Απόσταση σε Μίλια',
    'LANG_PRICING_PRICE_FROM_TEXT' => 'Τιμή από',
    'LANG_PRICING_INQUIRE_TEXT' => 'Call',
    'LANG_PRICING_GET_A_QUOTE_TEXT' => 'Ζητήστε μας προσφορά',
    'LANG_FEATURES_TEXT' => ' Χαρακτηριστικά',
    'LANG_PRICING_GET_IT_TEXT' => 'Κράτηση',

    // class.LocationsController.php
    'LANG_LOCATIONS_BUSINESS_HOURS_TEXT' => 'Business Hours',
    'LANG_LOCATION_FEES_TEXT' => 'Τέλη Τοποθεσίας',
    ...
    'LANG_ITEM_MODEL_MINIMUM_ALLOWED_AGE_TEXT' => 'Ελάχιστη ηλικία πελάτη',
    'LANG_ITEM_MODEL_MAXIMUM_ALLOWED_AGE_TEXT' => 'Maximum Driver Age',
    'LANG_ITEM_MODEL_MIN_ALLOWED_AGE_TEXT' => 'Ελάχιστη ηλικία πελάτη',
    ...
    'LANG_ITEM_MODEL_ADDITIONAL_INFORMATION_TEXT' => 'Επιπλέον πληροφορίες',
    ...
    'LANG_ITEM_MODEL_VISIT_PAGE_TEXT' => 'Εμφάνιση περιγραφής αυτοκινήτου',
    ...
    'LANG_ORDER_S_CANCELLED_SUCCESSFULLY_TEXT' => 'ακυρώθηκε με επιτυχία %s.',
    'LANG_ORDER_NOT_CANCELLED_CODE_S_DOES_NOT_EXIST_TEXT' => 'Η Κράτηση δεν ακυρώθηκε. Reservation code %s - does not exist.',

    // template.Step8EditBooking.php
    'LANG_SEARCH_CHANGE_ORDER_TEXT' => 'Αλλαγή
κράτηση',
    'LANG_SEARCH_CHANGE_ORDER2_TEXT' => 'Αλλαγή κράτησης',
    'LANG_ORDER_NO_CODE_ERROR_TEXT' => 'Παρακαλώ εισάγετε τον αριθμό κράτησης!',
    ...
    // Install Element
    'LANG_COMPANY_DEFAULT_NAME_TEXT' => 'Εταιρία ενοικιάσεων αυτοκινήτων',
    ...
    'LANG_PAYMENT_METHOD_DEFAULT_PAYPAL_DESCRIPTION_TEXT' => 'Ασφαλή Άμεση Πληρωμή',
    'LANG_PAYMENT_METHOD_DEFAULT_STRIPE_TEXT' => 'Πιστωτική Κάρτα (μέσω Stripe.com)',
    'LANG_PAYMENT_METHOD_DEFAULT_BANK_TEXT' => 'Μεταφορά Τραπέζης',
    'LANG_PAYMENT_METHOD_DEFAULT_BANK_DETAILS_TEXT' => 'Λεπτομέρειες Τραπέζης',
    'LANG_PAYMENT_METHOD_DEFAULT_PAY_OVER_THE_PHONE_TEXT' => 'ΠΛηρώστε μέσω τηλεφώνου',
    'LANG_PAYMENT_METHOD_DEFAULT_PAY_ON_ARRIVAL_TEXT' => 'Πληρώστε κατα την παραλαβή',
    'LANG_PAYMENT_METHOD_DEFAULT_PAY_ON_ARRIVAL_DETAILS_TEXT' => 'Χρειάζεται πιστωτική κάρτα',
    'LANG_EMAIL_DEFAULT_DEAR_TEXT' => 'Αγαπητέ',
    'LANG_EMAIL_DEFAULT_REGARDS_TEXT' => 'Εκτίμηση',
    'LANG_EMAIL_DEFAULT_TITLE_ORDER_DETAILS_TEXT' => 'Πληροφορίες Κράτησης - no. [RESERVATION_CODE]',
    'LANG_EMAIL_DEFAULT_TITLE_ORDER_CONFIRMED_TEXT' => 'Κράτηση Νουμ. [RESERVATION_CODE] - Επιβαιβεώθηκε',
    'LANG_EMAIL_DEFAULT_TITLE_ORDER_CANCELLED_TEXT' => 'Κράτηση Νουμ. [RESERVATION_CODE] - Ακυρώθηκε',
    'LANG_EMAIL_DEFAULT_ADM_TITLE_ORDER_DETAILS_TEXT' => 'Ειδοποίηση: Καινούργια Κράτηση - [RESERVATION_CODE]',
    'LANG_EMAIL_DEFAULT_ADM_TITLE_ORDER_CONFIRMED_TEXT' => 'Ειδοποίηση: Κράτηση Πληρώθηκε - [RESERVATION_CODE]',
    'LANG_EMAIL_DEFAULT_ADM_TITLE_ORDER_CANCELLED_TEXT' => 'Ειδοποίηση: Κράτηση Ακυρώθηκε - [RESERVATION_CODE]',
    'LANG_EMAIL_DEFAULT_BODY_ORDER_RECEIVED_TEXT' => 'Οι πληροφορίες κρατησής σας ελήφθησαν',
    'LANG_EMAIL_DEFAULT_BODY_ORDER_DETAILS_TEXT' => 'Πληροφορίες Κράτησης:',
    'LANG_EMAIL_DEFAULT_BODY_PAYMENT_RECEIVED_TEXT' => 'Η πληρωμή σας λήφθηκε. Η κράτηση σας επιβαιβεώθηκε',
    'LANG_EMAIL_DEFAULT_BODY_ORDER_CANCELLED_TEXT' => 'Η κρατησή σας  no. [RESERVATION_CODE] ακυρώθηκε.',
    'LANG_EMAIL_DEFAULT_ADM_BODY_ORDER_RECEIVED_TEXT' => 'Η κρατησή σας   no. [RESERVATION_CODE] Λήφθηκε απο [CUSTOMER_NAME].',
    'LANG_EMAIL_DEFAULT_ADM_BODY_ORDER_DETAILS_TEXT' => 'Πληροφορίες Κράτησης:',
    'LANG_EMAIL_DEFAULT_ADM_BODY_ORDER_PAID_TEXT' => 'Η κράτηση σας  no. [RESERVATION_CODE] πρόσφατα πληρώθηκε από [CUSTOMER_NAME].',
    'LANG_EMAIL_DEFAULT_ADM_BODY_ORDER_CANCELLED_TEXT' => 'Η κράτηση σας no. [RESERVATION_CODE] για [CUSTOMER_NAME] πρόσφατα ακυρώθηκε.',
    'LANG_EMAIL_DEFAULT_ADM_BODY_CANCELLED_ORDER_DETAILS_TEXT' => 'Πληροφορίες Κράτησης, η οποία ακυρώθηκε:',
    ...
    // Manager Element
    'LANG_MANAGER_TEXT' => 'Διαχειριστής',
    ...
    // Notification Element
    'LANG_NOTIFICATION_ADD_EDIT_TEXT' => 'Προσθήκη / Επεξεργασία Email',
    ...
    'LANG_PRICE_GROUP_ADD_EDIT_TEXT' => 'Προσθήκη / Επεξεργασία Price Group',
...
(New WP User)',
    ...
    'LANG_SETTINGS_DEFAULT_PAYMENT_CANCELLED_PAGE_TITLE_TEXT' => 'Ακύρωση Πληρωμής',
    'LANG_SETTINGS_DEFAULT_PAYMENT_CANCELLED_PAGE_CONTENT_TEXT' => 'Η πληρωμή σας ακυρώθηκε. Η κράτηση σας δεν έχει επιβεβαιωθεί.',
    'LANG_SETTINGS_DEFAULT_ORDER_CONFIRMED_PAGE_TITLE_TEXT' => 'Επιβεβαίωση Κράτησης',
    'LANG_SETTINGS_DEFAULT_ORDER_CONFIRMED_PAGE_CONTENT_TEXT' => 'Ευχαριστούμε. Δεχτήκαμε την πληρωμή σας. Η κράτηση σας  Επιβεβαιώθηκε.',
    'LANG_SETTINGS_DEFAULT_TERMS_AND_CONDITIONS_PAGE_TITLE_TEXT' => 'Όροι Χρήσης για τις ενοικιάσεις αυτοκινήτων',
    ...
    'LANG_TRANSACTION_ID_TEXT' => 'Ταυτότητα συναλλαγής',
    'LANG_TRANSACTION_ID_EXTERNAL_ID_AND_LEGAL_COUNTRY_TEXT' => 'Transaction Id, External Id & Legal Country',
    'LANG_TRANSACTION_EXTERNAL_ID_TEXT' => 'External Ταυτότητα συναλλαγής',
    ...
    'LANG_TRANSACTION_PAYER_EMAIL_TEXT' => 'Πληρωτής E-Mail',
    ...
    // ZIP Code Element
    'LANG_ZIP_CODE_TEXT' => 'Ταχυδρομικός κώδικας',
