...
return array(
    ...
    // Admin - Global
    'LANG_ORDERS_VIEW_TEXT' => 'Rezervasyonlara Bak',
    'LANG_ORDERS_VIEW_UNPAID_TEXT' => 'Ödenmemiş Rezervayonlar',
    'LANG_ORDERS_NONE_YET_TEXT' => 'Henüz Rezervasyon Yok',
    'LANG_ORDER_DETAILS_TEXT' => 'Rezervasyon Detayları',
    'LANG_CUSTOMER_DETAILS_FROM_DB_TEXT' => 'Müşteri Detayları (Latest version from database)',
    'LANG_ORDER_STATUS_TEXT' => 'Rezervasyon Durumu',
    'LANG_ORDER_STATUS_UPCOMING_TEXT' => 'Upcoming',
    'LANG_ORDER_STATUS_DEPARTED_TEXT' => 'Geçmiş',
    'LANG_ORDER_STATUS_COMPLETED_EARLY_TEXT' => 'Completed Early',
    'LANG_ORDER_STATUS_COMPLETED_TEXT' => 'Completed',
    'LANG_ORDER_STATUS_ACTIVE_TEXT' => 'Aktif',
    'LANG_ORDER_STATUS_CANCELLED_TEXT' => 'İptal',
    'LANG_ORDER_STATUS_PAID_TEXT' => 'Ödenmiş',
    'LANG_ORDER_STATUS_UNPAID_TEXT' => 'Ödenmemiş',
    'LANG_ORDER_STATUS_REFUNDED_TEXT' => 'Onaylanmayan',
    'LANG_INVOICE_PRINT_TEXT' => 'Fatura Yazdır',
    'LANG_CUSTOMER_BACK_TO_ORDERS_LIST_TEXT' => 'Müşteri Listesine Geri Dön',
    ...
    'LANG_PRICING_REGULAR_PRICE_TEXT' => 'Normal Fiyat',
    'LANG_PRICE_TYPE_TEXT' => 'Fiyatlandırma Şekli',
    ...
    'LANG_CALENDAR_NO_CALENDARS_FOUND_TEXT' => 'Seçmiş olduğunuz zaman aralığında, araç bulunmamaktadır',
    'LANG_PAGE_SELECT_TEXT' => ' - Choose page - ',
    'LANG_SELECT_EMAIL_TYPE_TEXT' => '--- Email Tipi ---',
...
and when plugin is network-enabled in multisite mode',
    ...
    'LANG_ITEM_NOT_AVAILABLE_FOR_ORDERING_TEXT' => 'Bu Araba Müsair Değil for reservation.',

    // Manufacturer Element
    'LANG_MANUFACTURER_TEXT' => 'Üretici',
    'LANG_MANUFACTURER_ID_TEXT' => 'Üretici Id',
    'LANG_MANUFACTURER_IDS_TEXT' => 'Üretici Ids',
    'LANG_MANUFACTURER_SELECT_TEXT' => 'Üretici:',
    'LANG_MANUFACTURER_SELECT2_TEXT' => '- Select Üretici -', // MB
    'LANG_MANUFACTURER_ADD_EDIT_TEXT' => 'Add / Edit Üretici',

    // Class Element
    'LANG_CLASS_TEXT' => 'Sınıf',
    'LANG_CLASS_ID_TEXT' => 'Sınıf Id',
    'LANG_CLASS_IDS_TEXT' => 'Sınıf Ids',
    'LANG_CLASS_SELECT_TEXT' => 'Sınıf:',
    'LANG_CLASS_SELECT2_TEXT' => '- Select Sınıf -', // MB
    'LANG_CLASS_ADD_NEW_TEXT' => 'Add New Sınıf',
    ...
    'LANG_LOCATION_STATUS_OPEN_TEXT' => 'Açık',
    'LANG_LOCATION_STATUS_CLOSED_TEXT' => 'Kapalı',
    ...
    // Ext - Popular
    'LANG_ITEM_MODEL_TEXT' => 'Araba Modeli',
    'LANG_EXTRA_TEXT' => 'Extra',
    'LANG_RENTAL_OPTION_TEXT' => 'Araba Seçimi',
    'LANG_ITEM_MODELS_TEXT' => 'Arabalar Modeli',
    'LANG_ITEMS_TEXT' => 'Arabalar',
    'LANG_EXTRAS_TEXT' => 'Extras',
    'LANG_RENTAL_OPTIONS_TEXT' => 'Araba Seçimi',
    'LANG_ITEM_MODEL_SHOW_TEXT' => 'Araba Bak Model',
    'LANG_COUPON_TEXT' => 'Coupon',

    // Search Element
    'LANG_SEARCH_TEXT' => 'Ara',
    'LANG_SEARCH_DEFAULT_SEARCH_PAGE_URL_SLUG_TEXT' => 'search', // Latin letters only
    'LANG_TAX_WITH_TEXT' => 'Kdv Dahil',
    'LANG_TAX_WITHOUT_TEXT' => 'w/o Kdv',
    'LANG_TAX_SHORT_TEXT' => 'Kdv',
    'LANG_DEPOSIT_TEXT' => 'Depozit',
    'LANG_DISCOUNT_TEXT' => 'indirim',
    'LANG_PREPAYMENT_TEXT' => 'Ön ödeme miktarı',
    'LANG_ITEM_MODELS_NONE_AVAILABLE_TEXT' => 'Müsait Araç Bulunamadı',
    'LANG_ITEM_MODELS_NONE_AVAILABLE_IN_THIS_CLASS_TEXT' => 'Bu segmentte araç bulunamadı',
    'LANG_ITEMS_NONE_AVAILABLE_TEXT' => 'Müsait Araç Bulunamadı',
    'LANG_ITEMS_NONE_AVAILABLE_IN_THIS_CLASS_TEXT' => 'Bu segmentte araç bulunamadı',
    'LANG_EXTRAS_NONE_AVAILABLE_TEXT' => 'Ekstra Bulunamadı',
    ...
    'LANG_ORDER_MARK_PAID_TEXT' => 'Ödeme İşaretle',
    'LANG_ORDER_MARK_COMPLETED_EARLY_TEXT' => 'Mark Completed Early',
    'LANG_ORDER_REFUND_TEXT' => 'Geri Ödeme',
    'LANG_LOCATION_SELECT2_TEXT' => '-- Yer Seçimi --',
    'LANG_LOCATIONS_ALL_TEXT' => 'Herhangi bir seçim',
    'LANG_PRICING_DAILY_TEXT' => 'Günlük',
    'LANG_PRICING_HOURLY_TEXT' => 'Saatlik',
    'LANG_PRICING_PER_ORDER2_TEXT' => 'Tek Rezervasyon',
    'LANG_PRICING_COMBINED_DAILY_AND_HOURLY_TEXT' => 'Karışık - Saatlik - Günlük - Haftalık',
    'LANG_PRICING_PER_ORDER_TEXT' => 'Rezervasyon',
    ...
    'LANG_PRICING_PER_DAY_TEXT' => 'Gün',
    'LANG_PRICING_PER_DAY_SHORT_TEXT' => 'd.',
    'LANG_PRICING_PER_NIGHT_TEXT' => 'night',
    'LANG_PRICING_PER_NIGHT_SHORT_TEXT' => 'n.',
    'LANG_PRICING_PER_HOUR_TEXT' => 'Saat',
    'LANG_PRICING_PER_HOUR_SHORT_TEXT' => 'sa',
    'LANG_PRICING_PER_MINUTE_TEXT' => 'minute',
    'LANG_PRICING_PER_MINUTE_SHORT_TEXT' => 'min',

    // Search step no. 1 - item search
    'LANG_ORDER_TEXT' => 'Rezervasyon',
    'LANG_PICKUP_TEXT' => 'Araba al',
    'LANG_RETURN_TEXT' => 'Araba Bırak',
    'LANG_INFORMATION_TEXT' => 'Bilgilendirme',
    'LANG_CITY_AND_LOCATION_TEXT' => 'Şehir ve Konum:',
    'LANG_SEARCH_PICKUP_CITY_AND_LOCATION_SELECT_TEXT' => 'Arabanın Alınacağı şehir ve Konum:',
    'LANG_SEARCH_PICKUP_CITY_AND_LOCATION_SELECT2_TEXT' => '- Select Arabanın Alınacağı şehir ve Konum -', // MB
    'LANG_SEARCH_RETURN_CITY_AND_LOCATION_SELECT_TEXT' => 'Arabanın Bırakılacağı şhir ve Konum:',
    'LANG_SEARCH_RETURN_CITY_AND_LOCATION_SELECT2_TEXT' => '- Select Arabanın Bırakılacağı şhir ve Konum -', // MB
    'LANG_ORDER_PERIOD_SELECT_TEXT' => 'Rezervasyon Süresi:',
    'LANG_ORDER_PERIOD_SELECT2_TEXT' => ' - Select Period -', // MB
    'LANG_COUPON_CODE_TEXT' => 'Coupon code',
    'LANG_ORDER_CODE_INPUT_TEXT' => 'Rezervasyon Numaram:',
    'LANG_ORDER_CODE_INPUT2_TEXT' => '- Rezervasyon Numaram -', // MB
    'LANG_COUPON_CODE_INPUT_TEXT' => 'I have coupon code:',
    'LANG_COUPON_CODE_INPUT2_TEXT' => '- I have coupon code -', // MB
    'LANG_LOCATION_PICKUP_TEXT' => 'Arabanın Alınacağı Konum',
    'LANG_LOCATION_RETURN_TEXT' => 'Araç Alış Noktası',
    'LANG_ALL_BODY_TYPES_DROPDOWN_TEXT' => '---- Tüm Araç Tipleri ----',
    'LANG_ALL_TRANSMISSION_TYPES_DROPDOWN_TEXT' => '---- Tüm Vites Türleri ----',
    'LANG_SELECT_PICKUP_LOCATION_TEXT' => '-- Araba Alış Konum Seçimi --',
    'LANG_SELECT_RETURN_LOCATION_TEXT' => '-- Araba Bırakış Konum Seçimi --',
    'LANG_PICKUP_DATE_TEXT' => 'Araba Alış Tarihi',
    'LANG_RETURN_DATE_TEXT' => 'Drop-Off Date',
    'LANG_ORDER_NO_PERIOD_SELECTED_ERROR_TEXT' => 'Lütfen Rezervasyon Süresi Seçin!',
    ...
    'LANG_LOCATION_PICKUP_SELECT_ERROR_TEXT' => 'Lütfen Araba Alış Konumu Seçin!',
    'LANG_LOCATION_RETURN_SELECT_ERROR_TEXT' => 'Lütfen Arabayı Bırakacağınız Konumu Seçin!',
    'LANG_SHOW_ITEM_DESCRIPTION_TEXT' => 'Araba Özelliklerini Göster',
    'LANG_ORDER_UPDATE_MY_ORDER_TEXT' => 'Rezervasyonumu Güncelle',
    'LANG_CANCEL_ORDER_TEXT' => 'Rezervasyon iptal Et',
    'LANG_ORDER_CHANGE_DATE_TIME_AND_LOCATION_TEXT' => 'Rezervasyon Konumu Tarihi ve Zamanı Değiştir',
    'LANG_ORDER_CHANGE_ORDERED_ITEM_MODELS_TEXT' => 'Araba Değiştir',
    'LANG_ORDER_CHANGE_ORDERED_ITEMS_TEXT' => 'Araba Değiştir',
    'LANG_CHANGE_EXTRAS_TEXT' => 'Ektraları Değiştir',
    'LANG_CHANGE_RENTAL_OPTIONS_TEXT' => 'Kiralama Seçeneklerini Değiştir',
    'LANG_IN_THIS_LOCATION_TEXT' => 'Bu Kategoride',
    'LANG_AFTERHOURS_PICKUP_IS_NOT_ALLOWED_TEXT' => 'Sonra Alıma İzin verilmedi',
    'LANG_AFTERHOURS_RETURN_IS_NOT_ALLOWED_TEXT' => 'Sonra Teslimata izin verilmedi',

    // Search step no. 3 - search results
    'LANG_DISTANCE_AWAY_TEXT' => '%s away',
    'LANG_ORDER_DATA_TEXT' => 'Rezervasyon Detayları',
    'LANG_ORDER_CODE_TEXT' => 'Rezervasyon Kodu',
    'LANG_ORDER_CODE2_TEXT' => 'Rezervasyon kodu', // Uppercase lowercase
    'LANG_ORDER_EDIT_TEXT' => 'Düzenle',
    'LANG_ORDER_VIEW_DETAILS_TEXT' => 'View Reservation Details',
    'LANG_ORDER_PICKUP_TEXT' => 'Alış',
    'LANG_ORDER_BUSINESS_HOURS_TEXT' => 'Çalışma Saatleri',
    'LANG_ORDER_FEE_TEXT' => 'Ücret',
    'LANG_ORDER_RETURN_TEXT' => 'Dönüş',
    'LANG_ORDER_NIGHTLY_RATE_TEXT' => 'Gece Geçmiş Saatler',
    'LANG_ORDER_AFTERHOURS_TEXT' => 'Gemiş Saatler',
    'LANG_ORDER_EARLY_TEXT' => 'Early',
    'LANG_ORDER_LATE_TEXT' => 'Late',
    'LANG_ORDER_AFTERHOURS_PICKUP_TEXT' => 'Araba Teslim Sonrası Geçen süre',
    'LANG_ORDER_AFTERHOURS_PICKUP_IMPOSSIBLE_TEXT' => 'Araba teslimatı mümkün değil',
    'LANG_ORDER_AFTERHOURS_RETURN_TEXT' => 'Araba geri alım süresi geçen süre',
    'LANG_ORDER_AFTERHOURS_RETURN_IMPOSSIBLE_TEXT' => 'Geçen süre içerisinde dönüş mümkün değil',
    'LANG_SEARCH_RESULTS_TEXT' => 'Arama Sonuçları',

    // Search step no. 4 - booking options
    'LANG_SELECT_RENTAL_OPTIONS_TEXT' => 'Kiralama opsiyonlarını seçin',
    'LANG_SELECTED_ITEMS_TEXT' => 'Araba Seçimi',
    'LANG_FOR_DEPENDANT_ITEM_TEXT' => ' (for %s)',
    'LANG_NO_EXTRAS_AVAILABLE_CLICK_CONTINUE_TEXT' => 'Araba ekstra seçeneği mevcut değil. Devam butonuna Tıklayın',

    // Search step no. 5 - booking details
    'LANG_PICKUP_DATE_AND_TIME_TEXT' => 'Araba Alış Tarihi ve Zamanı',
    'LANG_RETURN_DATE_AND_TIME_TEXT' => 'Araba Bırakma Tarihi ve Zamanı',
    'LANG_UNIT_PRICE_TEXT' => 'Birim Fiyatı',
    'LANG_LOCATION_PICKUP_FEE_TEXT' => 'Araba Alış Harcı',
    'LANG_LOCATION_PICKUP_FEE2_TEXT' => 'Araba alış harcı', // Uppercase lowercase
    'LANG_LOCATION_RETURN_FEE_TEXT' => 'Araba Bırakış Harcı',
    'LANG_LOCATION_RETURN_FEE2_TEXT' => 'Araba bırakış harcı', // Uppercase lowercase
    'LANG_LOCATION_NIGHTLY_RATE_APPLIED_TEXT' => '(Gecelik Fark Yansıtılır)',
    'LANG_ITEMS_QUANTITY_SUFFIX_TEXT' => 'Araç(lar)',
    'LANG_EXTRAS_QUANTITY_SUFFIX_TEXT' => 'ekstra(lar)',
    'LANG_PAY_NOW_OR_AT_PICKUP_TEXT' => 'Şimdi Öde / Al',
    'LANG_PAYMENT_PAY_NOW_TEXT' => 'Şimdi Öde',
    'LANG_PAYMENT_PAY_AT_PICKUP_TEXT' => 'Öde ve Al',
    'LANG_PAYMENT_PAY_LATER_OR_ON_RETURN_TEXT' => 'Sonra Öde / Dönüşte',
    'LANG_PAYMENT_PAY_LATER_TEXT' => 'Sonra Öde',
    'LANG_PAYMENT_PAY_ON_RETURN_TEXT' => 'Dönüşte Öde',
    'LANG_ORDER_RENTAL_DETAILS_TEXT' => 'Araba Kiralama Detayları',
    'LANG_PAYMENT_GROSS_TOTAL_TEXT' => 'Alt Toplam',
    'LANG_PAYMENT_GRAND_TOTAL_TEXT' => 'Genel Toplam',
    'LANG_CUSTOMER_DETAILS_TEXT' => 'Müşteri Detayları',
    'LANG_CUSTOMER_SEARCH_FOR_EXISTING_TEXT' => 'Mevcut Müşteri Detayları Arama',
    'LANG_CUSTOMER_EXISTING_TEXT' => 'Mevcut Müşteri',
    ...
    'LANG_CUSTOMER_FETCH_DETAILS_TEXT' => 'Detayları Al',
    'LANG_CUSTOMER_OR_ENTER_DETAILS_TEXT' => 'Yeni Hesap Oluştur',
    'LANG_CUSTOMER_TEXT' => 'Müşteri',
    'LANG_CUSTOMER_SELECT_TEXT' => 'Select Customer',
    'LANG_CITY_TEXT' => 'Şehir',
    'LANG_STATE_TEXT' => 'Devlet',
    'LANG_COUNTRY_TEXT' => 'Ülke',
    'LANG_ADDITIONAL_COMMENTS_TEXT' => 'Ek Yorumlar',
    'LANG_CUSTOMER_ID_TEXT' => 'Müşteri ID',
    ...
    'LANG_PAYMENT_PAY_BY_SHORT_TEXT' => 'ile Öde',
    'LANG_SEARCH_I_AGREE_WITH_TERMS_AND_CONDITIONS_TEXT' => 'Hizmet Koşullarını ve Mevcut Şartları Kabul Ediyorum',
    'LANG_TERMS_AND_CONDITIONS_TEXT' => 'Terms &amp; Conditions',
    'LANG_FIELD_REQUIRED_TEXT' => 'Bu Alan Gereklidir',

    // Search step no. 6 - process booking
    'LANG_PAYMENT_DETAILS_TEXT' => 'Ödeme Detayları',
    'LANG_PAYMENT_OPTION_TEXT' => 'ile Ödeme',
    'LANG_PAYMENT_PROCESSING_TEXT' => 'Ödeme işlemi yapılıyor...',
    'LANG_ORDER_PLEASE_WAIT_UNTIL_WILL_BE_PROCESSED_TEXT' => 'Lütfen Bekleyiniz, İşleminiz Gerçekleştiriliyor...',

    // display-booking-confirm.php
    'LANG_STEP5_PAY_ONLINE_TEXT' => 'Online Ödeme',
    'LANG_STEP5_PAY_AT_PICKUP_TEXT' => 'Alırken Ödeme',
    'LANG_ORDER_RECEIVED_YOUR_CODE_S_TEXT' => 'Rezervasyonunuz Onaylanmıştır. Rezervasyon Kodunuz %s.',
    'LANG_ORDER_CONFIRMED_YOUR_CODE_S_TEXT' => 'Rezervasyonunuz Onaylanmıştır. Rezervasyon Kodunuz %s.',
    'LANG_ORDER_UPDATED_YOUR_CODE_S_TEXT' => 'Rezervasyonunuz Onaylanmıştır. Rezervasyon Kodunuz %s.',
    'LANG_INVOICE_SENT_TO_YOUR_EMAIL_ADDRESS_TEXT' => 'Faturanız Email Adresinize Gönderilmiştir',

    // display-booking-failure.php
    'LANG_ORDER_FAILURE_TEXT' => 'Rezervasyon Gerçekleşmedi',
    'LANG_SEARCH_ALL_ITEM_MODELS_TEXT' => 'Tüm Arabaları Ara',
    ...
    'LANG_DAY_PRICE_TEXT' => 'Günlük Fiyat',
    'LANG_HOUR_PRICE_TEXT' => 'Saatlik Fiyat',
    'LANG_NO_ITEM_MODELS_IN_THIS_CATEGORY_TEXT' => 'Bu Kategoride Araba Bulunmamaktadır',
    'LANG_PRICE_FOR_DAY_FROM_TEXT' => 'Gün Başlangıç Fiyatı',
    'LANG_PRICE_FOR_HOUR_FROM_TEXT' => 'Saat Başlangıç Fiyatı',
    'LANG_PRICE_WITH_APPLIED_TEXT' => 'Birlikte Uyganır',
    'LANG_WITH_APPLIED_DISCOUNT_TEXT' => 'İndirim',

    // class.ItemsAvailability.php
    'LANG_MONTH_DAY_TEXT' => 'Gün',
    'LANG_MONTH_DAYS_TEXT' => 'Days',
    'LANG_ITEMS_AVAILABILITY_FOR_TEXT' => 'Arabaların Kısmi Müsait olan Pozisyonları',
    'LANG_ITEMS_AVAILABILITY_IN_NEXT_30_DAYS_TEXT' => 'Cars Availability in Next 30 Days',
    'LANG_ITEMS_PARTIAL_AVAILABILITY_FOR_TEXT' => 'Arabaların Müsait olan Pozisyonu',
    'LANG_ITEMS_AVAILABILITY_THIS_MONTH_TEXT' => 'Bu Ay için Müsait olan Arabalar', // Not used
    'LANG_ITEMS_AVAILABILITY_NEXT_MONTH_TEXT' => 'Sonraki Ay için Müsait Olan Arabalar', // Not used
    'LANG_ITEM_MODEL_ID_TEXT' => 'ID:',
    'LANG_TOTAL_ITEMS_TEXT' => 'Toplam Arabalar:',

    // class.ExtrasAvailability.php
    'LANG_EXTRAS_AVAILABILITY_FOR_TEXT' => 'Ekstra Müsait Olanlar',
    'LANG_EXTRAS_AVAILABILITY_IN_NEXT_30_DAYS_TEXT' => 'Extras Availability in Next 30 Days',
    'LANG_EXTRAS_PARTIAL_AVAILABILITY_FOR_TEXT' => 'Kısmi Ekstra Müsait',
    'LANG_EXTRAS_AVAILABILITY_THIS_MONTH_TEXT' => 'Bu Ay için Ekstra Müsait', // Not used
    'LANG_EXTRAS_AVAILABILITY_NEXT_MONTH_TEXT' => 'Sonraki Ay için Ekstra Müsait', // Not used
    'LANG_EXTRA_ID_TEXT' => 'ID:',
    'LANG_TOTAL_EXTRAS_TEXT' => 'Toplam Ekstra:',

    // class.ItemModelsController.php
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME1_TEXT' => 'Yakıt',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL1_TEXT' => 'Yakıt',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME2_TEXT' => 'Vites',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL2_TEXT' => 'Vites',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME3_TEXT' => 'Yakıt Kullanımı',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL3_TEXT' => 'Yakıt Kullanımı',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME4_TEXT' => 'Max Yolcu',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL4_TEXT' => 'Max Yolcu',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME5_TEXT' => 'Motor Kapasitesi',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL5_TEXT' => 'Motor Kapasitesi',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME6_TEXT' => 'Max Bagaj',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL6_TEXT' => 'Max Bagaj',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME7_TEXT' => 'Kapı Adedi',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL7_TEXT' => 'Kapı Adedi',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME8_TEXT' => 'Kilometre',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL8_TEXT' => 'Kilometre',
    'LANG_PRICING_PRICE_FROM_TEXT' => 'Dan Başlayan Fiyatlar',
    'LANG_PRICING_INQUIRE_TEXT' => 'Call',
    'LANG_PRICING_GET_A_QUOTE_TEXT' => 'Get a quote',
    'LANG_FEATURES_TEXT' => 'Özellikler',
    'LANG_PRICING_GET_IT_TEXT' => 'Ayır',

    // class.LocationsController.php
    'LANG_LOCATIONS_BUSINESS_HOURS_TEXT' => 'Business Hours',
    'LANG_LOCATION_FEES_TEXT' => 'Konum Harcı',
    ...
    'LANG_ITEM_MODEL_MINIMUM_ALLOWED_AGE_TEXT' => 'Sürücü Yaşı En Az',
    'LANG_ITEM_MODEL_MAXIMUM_ALLOWED_AGE_TEXT' => 'Maximum Driver Age',
    'LANG_ITEM_MODEL_MIN_ALLOWED_AGE_TEXT' => 'Sürücü Yaşı En Az',
    ...
    'LANG_ITEM_MODEL_ADDITIONAL_INFORMATION_TEXT' => 'Ek Bilgi',
    ...
    'LANG_ITEM_MODEL_VISIT_PAGE_TEXT' => 'Araba Açıklamalarını Göster',
    ...
    'LANG_ORDER_S_CANCELLED_SUCCESSFULLY_TEXT' => 'Rezervasyon %s İptal Gerçekleşti.',
    'LANG_ORDER_NOT_CANCELLED_CODE_S_DOES_NOT_EXIST_TEXT' => 'Rezervasyon İptal Edilmedi. Reservation code %s - does not exist.',

    // template.Step8EditBooking.php
    'LANG_SEARCH_CHANGE_ORDER_TEXT' => 'Değiştir
Rezervasyon',
    'LANG_SEARCH_CHANGE_ORDER2_TEXT' => 'Rezervasyon değiştir',
    'LANG_ORDER_NO_CODE_ERROR_TEXT' => 'Lütfen Rezervasyon Numarası Girin!',

    // Errors
    'LANG_ERROR_REQUIRED_FIELD_TEXT' => 'Gerekli Alanlar',
    'LANG_ERROR_IS_EMPTY_TEXT' => 'Henüz Boş',
    'LANG_ERROR_SLIDER_CANT_BE_DISPLAYED_TEXT' => 'Slider can\'t be displayed',
    'LANG_CUSTOMER_DETAILS_NOT_FOUND_ERROR_TEXT' => 'Müşteri ile ilgili herhangi bir bilgi bulunamadı. Lütfen Yeni Hesap Oluşturun.',
    'LANG_ERROR_CUSTOMER_DETAILS_NO_ERROR_TEXT' => 'Hata Yok',
    'LANG_CUSTOMER_EXCEEDED_LOOKUP_ATTEMPTS_ERROR_TEXT' => 'Müşteri Bilgilerini Sorgulama Adedini Aştınız. Mevcut form bilgilerini Lütfen Manuel olarak Giriniz.',
    'LANG_ERROR_ORDER_DOES_NOT_EXIST_TEXT' => 'Mevcut Değil',
    'LANG_ITEM_MODELS_PLEASE_SELECT_AT_LEAST_ONE_ITEM_MODEL_ERROR_TEXT' => 'En Az bir Araba Seçmelisiniz',
    'LANG_ITEMS_PLEASE_SELECT_AT_LEAST_ONE_ITEM_ERROR_TEXT' => 'En Az bir Araba Seçmelisiniz',
    'LANG_ERROR_SEARCH_ENGINE_DISABLED_TEXT' => 'Şu an Online Rezervasyon Alamıyoruz. Araba Teslim Anında Ödeme Yapabilirsiniz veya Sonra Tekrar Deneyebilirsiniz.',
    'LANG_SEARCH_OUT_BEFORE_IN_ERROR_TEXT' => 'Araba Geri Bırakma Tarihiniz, Arabayı Alma Tarihinden Sonra Olmalıdır. Lütfen Araba Alım ve Bırakma Tarihinizi Kontrol ediniz.',
    'LANG_SEARCH_MINIMUM_DURATION_CANT_BE_LESS_THAN_S_ERROR_TEXT' => 'Gece En az Sayıdan daha Az olmamalıdır %s.',
    'LANG_SEARCH_ERROR_PLEASE_MODIFY_YOUR_SEARCH_CRITERIA_TEXT' => 'Lütfen Arama Ayarlarınızda Değişiklik Yapınız',
    'LANG_ERROR_PICKUP_IS_NOT_POSSIBLE_ON_TEXT' => 'Alım Mümkün Değil',
    'LANG_ERROR_PLEASE_MODIFY_YOUR_PICKUP_TIME_BY_WEBSITE_TIME_TEXT' => 'Lütefan Alım tarihi, Konum ve Seçeneklerinde Değişiklik Yapınız',
    'LANG_ERROR_CURRENT_DATE_TIME_TEXT' => 'Kiralama Konumu ve Tarihi bu zamanda',
    'LANG_ERROR_EARLIEST_POSSIBLE_PICKUP_DATE_TIME_TEXT' => 'Mümkün olan en Erken Kiralama Tarihi ve Zamanı',
    'LANG_ERROR_OR_NEXT_BUSINESS_HOURS_OF_PICKUP_LOCATION_TEXT' => 'Kiralama için Konum Seçerseniz ilk ve Son Bakın',
    'LANG_ERROR_PICKUP_DATE_CANT_BE_LESS_THAN_RETURN_DATE_TEXT' => 'Kiralama Sürecinde Alım Tarihi geri Bırakma Tarinden Önce olmalıdır. Lütfen Doğru Zaman ve Tarih Seçimi Yapınızç',
    'LANG_ERROR_PICKUP_LOCATION_IS_CLOSED_AT_THIS_DATE_TEXT' => 'Alım Şube %s adresi %s Süre Bitimi (%s).',
    'LANG_ERROR_PICKUP_LOCATION_IS_CLOSED_AT_THIS_TIME_TEXT' => 'Alım Şube %s adresi %s Süre Bitimi (%s).',
    'LANG_ERROR_RETURN_LOCATION_IS_CLOSED_AT_THIS_DATE_TEXT' => 'Bırakılacak Şube %s adresi %s Süre Bitimi (%s).',
    'LANG_ERROR_RETURN_LOCATION_IS_CLOSED_AT_THIS_TIME_TEXT' => 'Dropoff branch %s at address %s Süre Bitimi (%s).',
    'LANG_ERROR_AFTERHOURS_PICKUP_LOCATION_IS_CLOSED_AT_THIS_TIME_TEXT' => 'Şube den zamanı Geçmiş alım %s Adresi %s Zaten Şube Tarafından Kapatılmış.',
    'LANG_ERROR_AFTERHOURS_RETURN_LOCATION_IS_CLOSED_AT_THIS_TIME_TEXT' => 'Şube den zamanı Geçmiş alım %s Adresi %s Zaten Şube Tarafından Kapatılmış.',
    'LANG_ERROR_LOCATION_OPEN_HOURS_ARE_TEXT' => 'Şubenin Açık Olduğu Saatler %s, %s are %s.',
    'LANG_ERROR_LOCATION_WEEKLY_OPEN_HOURS_ARE_TEXT' => 'Hafta Boyunca Şubenin Açık Olduğu Saatler:',
    'LANG_ERROR_AFTERHOURS_PICKUP_LOCATION_OPEN_HOURS_ARE_TEXT' => 'Zamanı Geçmiş Alımlarda Şubeden Yapılabilecek Saatler %s.',
    'LANG_ERROR_AFTERHOURS_RETURN_LOCATION_OPEN_HOURS_ARE_TEXT' => 'Zamanı Geçmiş Bırakış Şubeden Yapılabilecek Saatler %s.',
    'LANG_ERROR_AFTERHOURS_PICKUP_IS_NOT_ALLOWED_AT_LOCATION_TEXT' => 'Zamanı Geçmiş Alımlar bu Konumdan Gerçekleştirilemez.',
    'LANG_ERROR_AFTERHOURS_RETURN_IS_NOT_ALLOWED_AT_LOCATION_TEXT' => 'Zamanı Geçmiş Bırakış bu Konumdan Gerçekleştirilemez.',
    'LANG_SEARCH_MAXIMUM_DURATION_CANT_BE_MORE_THAN_S_ERROR_TEXT' => 'Maksimum Kiralama şu kadar günden fazla olamaz %s.',
    'LANG_ORDER_INVALID_CODE_ERROR_TEXT' => 'Yanlış Rezervasyon Numarası. Böyle bir numara Mevcut Değil',
    'LANG_ERROR_INVALID_SECURITY_CODE_TEXT' => 'Güvenlik Kodu Yanlış.',
    ...
    'LANG_ORDER_NO_S_PICKED_UP_ERROR_TEXT' => 'Reservation No. %s Zaten İşaretlenmiş daha ileriki bir durum ayarlaması yapılamaz.',
    'LANG_ORDER_NO_S_CANCELLED_ERROR_TEXT' => 'Reservation No. %s İptal Edildi.',
    'LANG_ORDER_NO_S_REFUNDED_ERROR_TEXT' => 'Reservation No. %s Zaten İade Edilmiş, Mevcut Değil.',
    'LANG_ERROR_PAYMENT_METHOD_IS_NOT_YET_IMPLEMENTED_TEXT' => 'Hata: Başka bir Ödeme Metodu Seçin, Henüz Ödemeye Açık Olmayan Bir Sistem olabilir',
    ...
    'LANG_PAYMENT_METHOD_DEFAULT_PAYPAL_TEXT' => 'Online - PayPal - Ödeme Noktası',
    'LANG_PAYMENT_METHOD_DEFAULT_PAYPAL_DESCRIPTION_TEXT' => 'Anında Güvenli Ödeme',
    'LANG_PAYMENT_METHOD_DEFAULT_STRIPE_TEXT' => 'Credit Card (via Stripe.com)',
    'LANG_PAYMENT_METHOD_DEFAULT_BANK_TEXT' => 'Banka Transferi',
    'LANG_PAYMENT_METHOD_DEFAULT_BANK_DETAILS_TEXT' => 'Banka Bilgileri',
    'LANG_PAYMENT_METHOD_DEFAULT_PAY_OVER_THE_PHONE_TEXT' => 'Telefon ile Ödeme',
    'LANG_PAYMENT_METHOD_DEFAULT_PAY_ON_ARRIVAL_TEXT' => 'Teslim anında ödeme',
    'LANG_PAYMENT_METHOD_DEFAULT_PAY_ON_ARRIVAL_DETAILS_TEXT' => 'Kredi Kart bilgileri gerekli',
    'LANG_EMAIL_DEFAULT_DEAR_TEXT' => 'Sayın',
    'LANG_EMAIL_DEFAULT_REGARDS_TEXT' => 'Saygılarımızla',
    'LANG_EMAIL_DEFAULT_TITLE_ORDER_DETAILS_TEXT' => 'Rezervasyon Detayları - no. [RESERVATION_CODE]',
    'LANG_EMAIL_DEFAULT_TITLE_ORDER_CONFIRMED_TEXT' => 'Rezervasyon no. [RESERVATION_CODE] - Onaylandı',
    'LANG_EMAIL_DEFAULT_TITLE_ORDER_CANCELLED_TEXT' => 'Rezervasyon no. [RESERVATION_CODE] - Onaylanmadı',
    'LANG_EMAIL_DEFAULT_ADM_TITLE_ORDER_DETAILS_TEXT' => 'Notification: Yeni Rezervasyon - [RESERVATION_CODE]',
    'LANG_EMAIL_DEFAULT_ADM_TITLE_ORDER_CONFIRMED_TEXT' => 'Notification: Rezervasyon Ödemesi - [RESERVATION_CODE]',
    'LANG_EMAIL_DEFAULT_ADM_TITLE_ORDER_CANCELLED_TEXT' => 'Notification: Rezervasyon İptali - [RESERVATION_CODE]',
    'LANG_EMAIL_DEFAULT_BODY_ORDER_RECEIVED_TEXT' => 'Rezervasyon Ayrıntıları Alındı.',
    'LANG_EMAIL_DEFAULT_BODY_ORDER_DETAILS_TEXT' => 'Rezervasyon Detaylarınız:',
    'LANG_EMAIL_DEFAULT_BODY_PAYMENT_RECEIVED_TEXT' => 'Ödemeniz Alınmıştır. Rezervasyonunuz Onaylanmaktadır.',
    'LANG_EMAIL_DEFAULT_BODY_ORDER_CANCELLED_TEXT' => 'Rezervasyon no. [RESERVATION_CODE] İptal Edildi.',
    'LANG_EMAIL_DEFAULT_ADM_BODY_ORDER_RECEIVED_TEXT' => 'Yeni Rezervasyon no. [RESERVATION_CODE] Gönderen [CUSTOMER_NAME].',
    'LANG_EMAIL_DEFAULT_ADM_BODY_ORDER_DETAILS_TEXT' => 'Rezervasyon Detayları:',
    'LANG_EMAIL_DEFAULT_ADM_BODY_ORDER_PAID_TEXT' => 'Rezervasyon no. [RESERVATION_CODE] tarafından ödendi [CUSTOMER_NAME].',
    'LANG_EMAIL_DEFAULT_ADM_BODY_ORDER_CANCELLED_TEXT' => 'Rezervasyon no. [RESERVATION_CODE] için [CUSTOMER_NAME] Sonradan İptal Edildi.',
    'LANG_EMAIL_DEFAULT_ADM_BODY_CANCELLED_ORDER_DETAILS_TEXT' => 'İptal edilen rezervasyon detayları:',
    ...
    'LANG_SEARCH_PICKUP_DATE_SELECT_ERROR_TEXT' => 'Lütfen Araba Alış Tarihi Seçin!',
    ...
    'LANG_SEARCH_RETURN_DATE_SELECT_ERROR_TEXT' => 'Lütfen Araba Bırakış Tarihi Seçin!',
    ...
    'LANG_SEARCH_TRY_DIFFERENT_DATE_OR_CRITERIA_ERROR_TEXT' => 'Bu Pozisyonda Araba Bulunamadı. Lütfen Arama Kriterlerini değiştirerek Yeniden Deneyiniz.',
...
(New WP User)',
    ...
    'LANG_SETTINGS_DEFAULT_PAYMENT_CANCELLED_PAGE_TITLE_TEXT' => 'Ödeme İptal',
    'LANG_SETTINGS_DEFAULT_PAYMENT_CANCELLED_PAGE_CONTENT_TEXT' => 'Ödeme İptal Edildi. Rezervasyonunuz Onaylanmadı',
    'LANG_SETTINGS_DEFAULT_ORDER_CONFIRMED_PAGE_TITLE_TEXT' => 'Rezervasyon Onaylandı',
    'LANG_SETTINGS_DEFAULT_ORDER_CONFIRMED_PAGE_CONTENT_TEXT' => 'Rezervasyonunuz tamamlandı Ödeme için Teşekkür Ederiz',
    'LANG_SETTINGS_DEFAULT_TERMS_AND_CONDITIONS_PAGE_TITLE_TEXT' => 'Araç Kiralama Şartları ve Sözleşmesi',
    'LANG_SETTINGS_DEFAULT_TERMS_AND_CONDITIONS_PAGE_CONTENT_TEXT' => 'Sağlıklı bir biçimde araç kiralayabilmeniz için tavsiye ve önergeleri takip ediniz',
    ...
    'LANG_TRANSACTION_PAYER_EMAIL_TEXT' => 'Ödeme Sahibinin Emaili',
