...
return array(
    // Ext Settings
    'EXT_NAME' => 'Vehicle Rental',
    'EXT_FLEET' => 'Vehicle Rental Fleet',
    'EXT_FLEET_SHORT' => 'Vehicle Fleet',
    'EXT_SYSTEM' => 'Vehicle Rental System',

    // Admin - Ajax
    'LANG_FEATURE_DELETION_DIALOG_TEXT' => 'Do you really want to delete this feature?',
    'LANG_CUSTOMER_DELETION_DIALOG_TEXT' => 'Do you really want to delete this customer? Remember that all reservations made by this customer, invoices and all reserved vehicles will also be deleted.',
    'LANG_CUSTOMER_REQUIRED_ERROR_TEXT' => 'Error: Customer is required!',
    'LANG_MANUFACTURER_DELETION_DIALOG_TEXT' => 'Do you really want to delete this manufacturer? Remember that vehicles, made by this manufacturer and related reservations also will be deleted.',
    'LANG_ITEM_MODEL_DELETION_DIALOG_TEXT' => 'Do you want to delete this vehicle model? Remember that all corresponding reservations will also be deleted.',
    'LANG_ITEM_DELETION_DIALOG_TEXT' => 'Do you want to delete this vehicle? Remember that all corresponding reservations will also be deleted.',
    'LANG_ATTRIBUTE_DELETION_DIALOG_TEXT' => 'Do you really want to delete this attribute? All vehicles, using this attribute and related reservations will be unassigned from it, but not deleted.',
    'LANG_CLASS_DELETION_DIALOG_TEXT' => 'Do you really want to delete this class? Remember that vehicles, using this class and related reservations also will be deleted.',
    ...
    'LANG_LOCATION_DELETION_DIALOG_TEXT' => 'Do you want to delete this location? All related distances and upcoming reservations from/to this location will be deleted. Vehicles won\'t be deleted, just locations will be unassigned from them .',
    ...
    'LANG_MAX_ITEM_UNITS_PER_ORDER_TEXT' => 'Maximum vehicle units per reservation',
    'LANG_TOTAL_ITEM_UNITS_IN_STOCK_TEXT' => 'Total vehicle units in garage',
    ...
    'LANG_PREPAYMENT_ITEMS_PRICE_TEXT' => 'Vehicles Price',
    'LANG_PREPAYMENT_ITEMS_DEPOSIT_TEXT' => 'Vehicles Deposit',
    ...
    // Item Model Element
    'LANG_ITEM_MODEL_MANAGER_TEXT' => 'Vehicle Model Manager',
    'LANG_ITEM_MODEL_ADD_EDIT_TEXT' => 'Add / Edit Vehicle Model',

    // Item Element
    'LANG_ITEM_TEXT' => 'Vehicle',
    'LANG_ITEM_MANAGER_TEXT' => 'Vehicle Manager',
    'LANG_ITEM_ADD_EDIT_TEXT' => 'Add / Edit Vehicle',
    'LANG_ITEM_BACK_TO_LIST_TEXT' => 'Back to Vehicle List',
    'LANG_ITEM_UNIQUE_IDENTIFIER_TEXT' => 'Unique Identifier',
    'LANG_ITEM_UNIQUE_IDENTIFIER_SHORT_TEXT' => 'Vehicle UID',
...
and when plugin is network-enabled in multisite mode',
    ...
    'LANG_ITEM_NOTES_FOR_MODEL_S_UID_S_S_TEXT' => 'Notes for vehicle (model: %s, License plate #: %s): %s',
    'LANG_ITEM_ORDERABLE_TEXT' => 'Reservable', // This is ok to use exact item
    'LANG_ITEM_NOT_ORDERABLE_TEXT' => 'This vehicle is not reservable.',
    'LANG_ITEM_AVAILABLE_FOR_ORDERING_TEXT' => 'Available for reservation', // This is ok to use exact item
    'LANG_ITEM_NOT_AVAILABLE_FOR_ORDERING_TEXT' => 'This vehicle is not available for reservation.',
    'LANG_ITEM_PRICE_PLANS_TITLE' => 'Vehicle Price Plans',
    ...
    'LANG_FEATURE_ADD_TO_ALL_ITEM_MODELS_TEXT' => 'Add to all vehicle models',
    ...
    'LANG_ITEM_MODEL_OPTION_ADD_EDIT_TEXT' => 'Add / Edit Vehicle Model Option',
    'LANG_ITEM_OPTION_ADD_EDIT_TEXT' => 'Add / Edit Vehicle Option',
    'LANG_BLOCK_ITEM_MODEL_TEXT' => 'Block Vehicle Model',
    'LANG_BLOCK_ITEM_TEXT' => 'Block Vehicle',

    // Item Model Element
    'LANG_ITEM_MODEL_PRICES_TEXT' => 'Vehicle Model Prices',
    ...
    'LANG_ITEM_MODELS_AVAILABILITY_SEARCH_RESULTS_TEXT' => 'Vehicle Models Availability Search Results',
    'LANG_ITEMS_AVAILABILITY_SEARCH_RESULTS_TEXT' => 'Vehicles Availability Search Results',
    ...
    // Ext - Popular
    'LANG_ITEM_MODEL_TEXT' => 'Vehicle Model',
    'LANG_EXTRA_TEXT' => 'Extra',
    'LANG_RENTAL_OPTION_TEXT' => 'Rental Option',
    'LANG_ITEM_MODELS_TEXT' => 'Vehicle Models',
    'LANG_ITEMS_TEXT' => 'Vehicles',
    'LANG_EXTRAS_TEXT' => 'Extras',
    'LANG_RENTAL_OPTIONS_TEXT' => 'Rental Options',
    'LANG_ITEM_MODEL_SHOW_TEXT' => 'View vehicle model',
    ...
    'LANG_ITEM_MODELS_NONE_AVAILABLE_TEXT' => 'No vehicles available',
    'LANG_ITEM_MODELS_NONE_AVAILABLE_IN_THIS_CLASS_TEXT' => 'No vehicles available in this class',
    'LANG_ITEMS_NONE_AVAILABLE_TEXT' => 'No vehicles available',
    'LANG_ITEMS_NONE_AVAILABLE_IN_THIS_CLASS_TEXT' => 'No vehicles available in this class',
    ...
    'LANG_SHOW_ITEM_DESCRIPTION_TEXT' => 'Show vehicle description',
    ...
    'LANG_ORDER_CHANGE_ORDERED_ITEM_MODELS_TEXT' => 'Change Vehicles',
    'LANG_ORDER_CHANGE_ORDERED_ITEMS_TEXT' => 'Change Vehicles',
    ...
    'LANG_SELECTED_ITEMS_TEXT' => 'Selected Vehicle',
    'LANG_FOR_DEPENDANT_ITEM_TEXT' => ' (for %s)',
    'LANG_NO_EXTRAS_AVAILABLE_CLICK_CONTINUE_TEXT' => 'No vehicle extras available. Click on continue button',
    ...
    'LANG_PAYMENT_PAY_LATER_TEXT' => 'Pay on Pick-up',
    ...
    'LANG_ADDITIONAL_COMMENTS_TEXT' => 'DELIVERIES only accepted if booked before 48 Hours, Write Address if opting for Delivery or Pickup, IMP! Email us or Call us for Confirmation',
    ...
    'LANG_ORDER_RECEIVED_YOUR_CODE_S_TEXT' => 'Your reservation has been received. Reservation code %s.',
    'LANG_ORDER_CONFIRMED_YOUR_CODE_S_TEXT' => 'Your reservation is confirmed. Reservation code %s.',
    'LANG_ORDER_UPDATED_YOUR_CODE_S_TEXT' => 'Your reservation has been updated. Reservation code %s.',
    'LANG_INVOICE_SENT_TO_YOUR_EMAIL_ADDRESS_TEXT' => 'An Invoice has been sent to your email address',

    // display-booking-failure.php
    'LANG_ORDER_FAILURE_TEXT' => 'Unfortunately this reservation cannot be completed for the reason/s below',
    'LANG_SEARCH_ALL_ITEM_MODELS_TEXT' => 'Search All Vehicles',
    ...
    'LANG_NO_ITEM_MODELS_IN_THIS_CATEGORY_TEXT' => 'There are no vehicles available in this category',
    ...
    'LANG_ITEMS_AVAILABILITY_FOR_TEXT' => 'Vehicles Availability For',
    'LANG_ITEMS_AVAILABILITY_IN_NEXT_30_DAYS_TEXT' => 'Vehicles Availability in Next 30 Days',
    'LANG_ITEMS_PARTIAL_AVAILABILITY_FOR_TEXT' => 'Partial Vehicles Availability For',
    'LANG_ITEMS_AVAILABILITY_THIS_MONTH_TEXT' => 'Vehicles Availability This Month', // Not used
    'LANG_ITEMS_AVAILABILITY_NEXT_MONTH_TEXT' => 'Vehicles Availability Next Month', // Not used
    'LANG_ITEM_MODEL_ID_TEXT' => 'ID:',
    'LANG_TOTAL_ITEMS_TEXT' => 'Total vehicles:',
    ...
    'LANG_ITEM_MODEL_MINIMUM_ALLOWED_AGE_TEXT' => 'Minimum Driver age',
    'LANG_ITEM_MODEL_MAXIMUM_ALLOWED_AGE_TEXT' => 'Maximum Driver Age',
    'LANG_ITEM_MODEL_MIN_ALLOWED_AGE_TEXT' => 'Minimum driver age',
    ...
    'LANG_ITEM_MODEL_FEATURES_TEXT' => 'Vehicle Model Features',
    ...
    'LANG_ITEM_MODEL_LIST_TEXT' => 'Vehicle Model List',
    'LANG_ITEM_MODEL_SLIDER_TEXT' => 'Vehicle Model Slider',
    'LANG_ITEM_MODEL_PRICE_TABLE_TEXT' => 'Vehicle Model Price Table',
    'LANG_ITEM_MODEL_AVAILABILITY_CALENDAR_TEXT' => 'Vehicle Model Availability Calendar',
    'LANG_ITEM_MODEL_SAVE_TEXT' => 'Save vehicle model',
    'LANG_ITEM_MODEL_ANY_TEXT' => 'Any Vehicle Model',
    'LANG_ITEM_MODEL_UNLIMITED_NUMBER_OF_ITEMS_TEXT' => 'There are unlimited number of vehicles of this model.',
    'LANG_ITEM_MODEL_NO_ITEMS_AVAILABLE_TEXT' => 'No vehicles available from this model.',
    'LANG_ITEM_MODEL_VISIT_PAGE_TEXT' => 'Show vehicle model description',
...
reservation',
    ...
    'LANG_ITEM_MODELS_PLEASE_SELECT_AT_LEAST_ONE_ITEM_MODEL_ERROR_TEXT' => 'Please select at least one vehicle',
    'LANG_ITEMS_PLEASE_SELECT_AT_LEAST_ONE_ITEM_ERROR_TEXT' => 'Please select at least one vehicle',
    ...
    'LANG_ERROR_PICKUP_LOCATION_IS_CLOSED_AT_THIS_DATE_TEXT' => '%s at %s is closed for pick-up on %s.',
    'LANG_ERROR_PICKUP_LOCATION_IS_CLOSED_AT_THIS_TIME_TEXT' => '%s at %s is closed for pick-up at %s.',
    'LANG_ERROR_RETURN_LOCATION_IS_CLOSED_AT_THIS_DATE_TEXT' => '%s at %s is closed for vehicle return on %s.',
    'LANG_ERROR_RETURN_LOCATION_IS_CLOSED_AT_THIS_TIME_TEXT' => '%s at %s is closed for vehicle return at %s.',
    ...
    'LANG_ERROR_LOCATION_OPEN_HOURS_ARE_TEXT' => 'This location is closed on %s, %s',
    'LANG_ERROR_LOCATION_WEEKLY_OPEN_HOURS_ARE_TEXT' => 'Our opening hours are:',
    ...
    'LANG_ORDER_INVALID_CODE_ERROR_TEXT' => 'Reservation code is either not valid or this reservation does not exist anymore.',
    'LANG_ERROR_INVALID_SECURITY_CODE_TEXT' => 'Security code is not valid.',
    'LANG_ITEM_MODEL_AGE_S_ERROR_TEXT' => 'Based on the date of birth you inputed, you are under the legal age to rent the %s.',
    'LANG_ITEM_MODEL_AGE_ERROR_TEXT' => 'Based on the date of birth you inputed, you are under the legal age to rent one of the selected vehicle models.',
    ...
    'LANG_BLOCK_DELETE_OPTIONS_ERROR_TEXT' => 'Failed: No vehicles or extras were deleted from block!',
    'LANG_BLOCK_OPTIONS_DELETED_TEXT' => 'Completed: All vehicles and extras were deleted from block!',
    ...
    // Discount Element
    'LANG_DISCOUNT_ITEM_ORDER_IN_ADVANCE_TEXT' => 'Add/Edit Vehicle Discount for Order in Advance',
    'LANG_DISCOUNT_ITEM_ORDER_DURATION_TEXT' => 'Add/Edit Vehicle Discount for Order Duration',
    ...
    'LANG_EXTRA_ITEM_MODEL_ASSIGN_ERROR_TEXT' => 'Error: You are not allowed to assign extras to that vehicle model!',
    'LANG_EXTRA_ITEM_MODEL_SELECT_ERROR_TEXT' => 'Error: Please select a vehicle model!',
    ...
    // Install Element
    'LANG_COMPANY_DEFAULT_NAME_TEXT' => 'Vehicle Rental Company',
    ...
    'LANG_PAYMENT_METHOD_DEFAULT_STRIPE_TEXT' => 'Credit Vehicled (via Stripe.com)',
    ...
    'LANG_PAYMENT_METHOD_DEFAULT_PAY_ON_ARRIVAL_DETAILS_TEXT' => 'Credit Vehicled Required',
    ...
    'LANG_ITEM_MODEL_DOES_NOT_EXIST_ERROR_TEXT' => 'Error: Selected vehicle model does not exist!',
    'LANG_ITEM_MODEL_WITH_ID_D_DOES_NOT_EXIST_ERROR_TEXT' => 'Error: Vehicle model with ID \'%d\' does not exist!',
    'LANG_ITEM_MODEL_SKU_EXISTS_ERROR_TEXT' => 'Error: Vehicle with this stock keeping unit (SKU) already exist!',
    'LANG_ITEM_MODEL_MORE_UNITS_PER_ORDER_THAN_IN_STOCK_ERROR_TEXT' => 'Error: You can\'t allow to reserve more vehicle units per one reservation than you have in garage!',
    'LANG_ITEM_MODEL_UPDATE_ERROR_TEXT' => 'Error: MySQL update error for existing vehicle!',
    'LANG_ITEM_MODEL_UPDATED_TEXT' => 'Completed: Vehicle details has been updated successfully!',
    'LANG_ITEM_MODEL_INSERTION_ERROR_TEXT' => 'Error: MySQL insert error for new vehicle!',
    'LANG_ITEM_MODEL_INSERTED_TEXT' => 'Completed: New vehicle has been added successfully!',
    'LANG_ITEM_MODEL_REGISTERED_TEXT' => 'Vehicle model name registered for translation.',
    'LANG_ITEM_MODEL_ATTRIBUTE_RESET_ERROR_TEXT' => 'Error: MySQL update error when trying to reset vehicle model attribute!',
    'LANG_ITEM_MODEL_ATTRIBUTE_HAD_RESET_TEXT' => 'Completed: Vehicle model attribute had reset successfully!',
    'LANG_ITEM_MODEL_DELETION_ERROR_TEXT' => 'Error: MySQL delete error for existing vehicle. No rows were deleted from database!',
    'LANG_ITEM_MODEL_DELETED_TEXT' => 'Completed: Vehicle has been deleted successfully!',

    // OK / Error Messages - (ItemModel) Order Option Element
    'LANG_ITEM_MODEL_ORDER_ID_QUANTITY_OPTION_SKU_ERROR_TEXT' => 'Error: New vehicle can\'t be blocked because of bad reservation id (%s), SKU (%s) or quantity (%s)!',
    'LANG_ITEM_MODEL_ORDER_OPTION_INSERTION_ERROR_TEXT' => 'Error: MySQL insert error for new vehicle (SKU - %s) reservation/block!',
    'LANG_ITEM_MODEL_ORDER_OPTION_INSERTED_TEXT' => 'Completed: New vehicle (SKU - %s) has been blocked/reserved!',
    'LANG_ITEM_MODEL_ORDER_OPTION_DELETION_ERROR_TEXT' => 'Error: MySQL delete error for existing reserved/blocked vehicle. No rows row were deleted from database!',
    'LANG_ITEM_MODEL_ORDER_OPTION_DELETED_TEXT' => 'Completed: Vehicle has been removed from reservation/block!',

    // OK / Error Messages - (ItemModel) Option Element
    'LANG_ITEM_MODEL_OPTION_PLEASE_SELECT_ERROR_TEXT' => 'Error: Please select a vehicle!',
    'LANG_ITEM_MODEL_OPTION_NAME_EXISTS_ERROR_TEXT' => 'Error: Option with chosen name already exists for this vehicle!',
    'LANG_ITEM_MODEL_OPTION_UPDATE_ERROR_TEXT' => 'Error: MySQL update error for existing vehicle option!',
    'LANG_ITEM_MODEL_OPTION_UPDATED_TEXT' => 'Completed: Vehicle option has been updated successfully!',
    'LANG_ITEM_MODEL_OPTION_INSERTION_ERROR_TEXT' => 'Error: MySQL insert error for new vehicle option!',
    'LANG_ITEM_MODEL_OPTION_INSERTED_TEXT' => 'Completed: New vehicle option has been added successfully!',
    'LANG_ITEM_MODEL_OPTION_REGISTERED_TEXT' => 'Vehicle option name registered for translation.',
    'LANG_ITEM_MODEL_OPTION_DELETION_ERROR_TEXT' => 'Error: MySQL delete error for existing vehicle option. No rows were deleted from database!',
    'LANG_ITEM_MODEL_OPTION_DELETED_TEXT' => 'Completed: Vehicle option has been deleted successfully!',

    // Item Model Post
    'LANG_ITEM_MODEL_POST_LABEL_NAME_TEXT' => 'Vehicle Page', // name
    'LANG_ITEM_MODEL_POST_LABEL_SINGULAR_NAME_TEXT' => 'Vehicle Pages', // singular_name
    'LANG_ITEM_MODEL_POST_LABEL_MENU_NAME_TEXT' => 'Vehicle Pages', // menu_name
    'LANG_ITEM_MODEL_POST_LABEL_PARENT_ITEM_COLON_TEXT' => 'Parent Vehicle', // parent_item_colon
    'LANG_ITEM_MODEL_POST_LABEL_ALL_ITEMS_TEXT' => 'All Vehicle Pages', // all_items
    'LANG_ITEM_MODEL_POST_LABEL_VIEW_ITEM_TEXT' => 'View Vehicle Page', // view_item
    'LANG_ITEM_MODEL_POST_LABEL_ADD_NEW_ITEM_TEXT' => 'Add New Vehicle Page', // add_new_item
    'LANG_ITEM_MODEL_POST_LABEL_ADD_NEW_TEXT' => 'Add New Page', // add_new
    'LANG_ITEM_MODEL_POST_LABEL_EDIT_ITEM_TEXT' => 'Edit Vehicle Page', // edit_item
    'LANG_ITEM_MODEL_POST_LABEL_UPDATE_ITEM_TEXT' => 'Update Vehicle Page', // update_item
    'LANG_ITEM_MODEL_POST_LABEL_SEARCH_ITEMS_TEXT' => 'Search Vehicle Page', // search_items
    ...
    'LANG_ITEM_MODEL_POST_DESCRIPTION_TEXT' => 'List of vehicle pages',

    // Location Post
    'LANG_LOCATION_POST_LABEL_NAME_TEXT' => 'Vehicle Location', // name
    'LANG_LOCATION_POST_LABEL_SINGULAR_NAME_TEXT' => 'Vehicle Locations', // singular_name
    'LANG_LOCATION_POST_LABEL_MENU_NAME_TEXT' => 'Vehicle Locations', // menu_name
    'LANG_LOCATION_POST_LABEL_PARENT_LOCATION_COLON_TEXT' => 'Parent Vehicle Location', // parent_item_colon
    'LANG_LOCATION_POST_LABEL_ALL_LOCATIONS_TEXT' => 'All Vehicle Location Pages', // all_items
    'LANG_LOCATION_POST_LABEL_VIEW_LOCATION_TEXT' => 'View Vehicle Location Page', // view_item
    'LANG_LOCATION_POST_LABEL_ADD_NEW_LOCATION_TEXT' => 'Add New Vehicle Location Page', // add_new_item
    'LANG_LOCATION_POST_LABEL_ADD_NEW_TEXT' => 'Add New Page', // add_new
    'LANG_LOCATION_POST_LABEL_EDIT_LOCATION_TEXT' => 'Edit Vehicle Location Page', // edit_item
    'LANG_LOCATION_POST_LABEL_UPDATE_LOCATION_TEXT' => 'Update Vehicle Location Page', // update_item
    'LANG_LOCATION_POST_LABEL_SEARCH_LOCATIONS_TEXT' => 'Search Vehicle Location Page', // search_items
    ...
    'LANG_LOCATION_POST_DESCRIPTION_TEXT' => 'List of vehicle location pages',
    ...
    'LANG_ORDER_OPTIONS_DELETION_ERROR_TEXT' => 'Failed: No vehicles or extras were deleted from reservation!',
    'LANG_ORDER_OPTIONS_DELETED_TEXT' => 'Completed: All vehicles and extras were deleted from reservation!',
    ...
    'LANG_PAGE_POST_LABEL_SINGULAR_NAME_TEXT' => 'Vehicle Rental Pages', // singular_name
    'LANG_PAGE_POST_LABEL_MENU_NAME_TEXT' => 'Vehicle Rental Pages', // menu_name
    ...
    'LANG_PAGE_POST_DESCRIPTION_TEXT' => 'List of vehicle information pages',
    ...
    'LANG_SEARCH_TRY_DIFFERENT_DATE_OR_CRITERIA_ERROR_TEXT' => 'No vehicle models available. Please change reservation period or modify your search criteria.',
...
(New WP User)',
    ...
    'LANG_SETTINGS_DEFAULT_PAGE_URL_SLUG_TEXT' => 'vehicle-rental', // Latin letters only
    'LANG_SETTINGS_DEFAULT_ITEM_MODEL_URL_SLUG_TEXT' => 'vehicle-model', // Latin letters only
    'LANG_SETTINGS_DEFAULT_LOCATION_URL_SLUG_TEXT' => 'vehicle-location', // Latin letters only
    'LANG_SETTINGS_DEFAULT_PAYMENT_CANCELLED_PAGE_TITLE_TEXT' => 'Payment cancelled',
    'LANG_SETTINGS_DEFAULT_PAYMENT_CANCELLED_PAGE_CONTENT_TEXT' => 'Payment has been cancelled and your reservation is not confirmed.',
    'LANG_SETTINGS_DEFAULT_ORDER_CONFIRMED_PAGE_TITLE_TEXT' => 'Reservation confirmed',
    'LANG_SETTINGS_DEFAULT_ORDER_CONFIRMED_PAGE_CONTENT_TEXT' => 'Thank you. We received your payment and your reservation is now confirmed.',
    'LANG_SETTINGS_DEFAULT_TERMS_AND_CONDITIONS_PAGE_TITLE_TEXT' => 'Terms of Use for Renting a Vehicle',
    'LANG_SETTINGS_DEFAULT_TERMS_AND_CONDITIONS_PAGE_CONTENT_TEXT' => 'You must follow the guidelines &amp; terms for the regular vehicle rental.',
    ...
    'LANG_TRANSACTION_PAYER_VEHICLED_TYPE_TEXT' => 'Payer Vehicled Type',
    'LANG_TRANSACTION_PAYER_VEHICLED_TYPE_SHORT_TEXT' => 'Vehicled Type',
    'LANG_TRANSACTION_PAYER_VEHICLED_NUMBER_TEXT' => 'Payer Vehicled Number',
    'LANG_TRANSACTION_PAYER_VEHICLED_NUMBER_SHORT_TEXT' => 'Vehicled Number',
    ...
    //New strings
    'LANG_FLEET_MODEL_PRICES_OVERVIEW' => 'Vehicle Prices for Today',
    'LANG_FLEET_MODEL_PRICES_DISCOUNTS_IN_ADVANCE' => 'Vehicle Discount Plans for Reservation in Advance',
    'LANG_SINGLE_VEHICLE_TITLE' => 'vehicle',
    'LANG_MULTIPLE_VEHICLE_TITLE' => 'vehicles',
    'LANG_SINGLE_VEHICLE_TITLE_UPPERCASE' => 'Vehicle',
    'LANG_MULTIPLE_VEHICLE_TITLE_UPPERCASE' => 'Vehicles',
    'LANG_SINGLE_VEHICLE_TITLE_FULL_UPPERCASE' => 'VEHICLE',
    'LANG_INSTRUCTIONS_PARAGRAPH1' => 'Please note, that if you see that after update or after uploading the first vehicle image the &quot;/wp-content/uploads/VehicleRentalGallery/&quot; directory is not created (or &quot;/wp-content/uploads/sites/2/VehicleRentalGallery/&quot; etc. for multisite setup), you will have to create that directory manually via FTP client like FileZilla and set it&#39;s permission to 0777.',
);