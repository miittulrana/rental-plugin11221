...
return array(
    ...
    // Admin - Global
    'LANG_ORDERS_VIEW_TEXT' => 'عرض حجوزات',
    'LANG_ORDERS_VIEW_UNPAID_TEXT' => 'View Unpaid Reservations',
    'LANG_ORDERS_NONE_YET_TEXT' => 'لا الحجوزات حتى الآن',
    'LANG_ORDER_DETAILS_TEXT' => 'تفاصيل الحجز',
    'LANG_CUSTOMER_DETAILS_FROM_DB_TEXT' => 'تفاصيل العملاء (أحدث الإصدارات من قاعدة بيانات)',
    'LANG_ORDER_STATUS_TEXT' => 'حالة الحجز',
    'LANG_ORDER_STATUS_UPCOMING_TEXT' => 'Upcoming',
    'LANG_ORDER_STATUS_DEPARTED_TEXT' => 'الراحلون',
    'LANG_ORDER_STATUS_COMPLETED_EARLY_TEXT' => 'Completed Early',
    'LANG_ORDER_STATUS_COMPLETED_TEXT' => 'Completed',
    'LANG_ORDER_STATUS_ACTIVE_TEXT' => 'جارية',
    'LANG_ORDER_STATUS_CANCELLED_TEXT' => 'إلغاء',
    'LANG_ORDER_STATUS_PAID_TEXT' => 'Paid',
    'LANG_ORDER_STATUS_UNPAID_TEXT' => 'Unpaid',
    'LANG_ORDER_STATUS_REFUNDED_TEXT' => 'Refunded',
    'LANG_INVOICE_PRINT_TEXT' => 'طباعة فاتورة',
    'LANG_CUSTOMER_BACK_TO_ORDERS_LIST_TEXT' => 'الرجوع إلى قائمة حجوزات الزبون',
    ...
    'LANG_SELECT_EMAIL_TYPE_TEXT' => '--- اختر نوع البريد الإلكتروني ---',
...
and when plugin is network-enabled in multisite mode',
    ...
    'LANG_MANUFACTURER_TEXT' => 'بائع السيارات',
    ...
    // Ext - Popular
    'LANG_ITEM_MODEL_TEXT' => 'نوع السيارة',
    'LANG_EXTRA_TEXT' => 'Extra',
    'LANG_RENTAL_OPTION_TEXT' => 'Extra',
    'LANG_ITEM_MODELS_TEXT' => 'سيارات Models',
    'LANG_ITEMS_TEXT' => 'سيارات',
    'LANG_EXTRAS_TEXT' => 'تأجير خيارات',
    'LANG_RENTAL_OPTIONS_TEXT' => 'تأجير خيارات',
    'LANG_ITEM_MODEL_SHOW_TEXT' => 'عرض سيارة',
    'LANG_COUPON_TEXT' => 'Coupon',

    // Search Element
    'LANG_SEARCH_TEXT' => 'بحث',
    'LANG_SEARCH_DEFAULT_SEARCH_PAGE_URL_SLUG_TEXT' => 'search', // Latin letters only
    'LANG_TAX_WITH_TEXT' => 'with VAT',
    'LANG_TAX_WITHOUT_TEXT' => 'ث / س VAT',
    'LANG_TAX_SHORT_TEXT' => 'VAT',
    'LANG_DEPOSIT_TEXT' => 'ودائع',
    'LANG_DISCOUNT_TEXT' => 'الخصم',
    'LANG_PREPAYMENT_TEXT' => 'المبلغ المسبق',
    'LANG_ITEM_MODELS_NONE_AVAILABLE_TEXT' => 'لا السيارات المتاحة',
    'LANG_ITEM_MODELS_NONE_AVAILABLE_IN_THIS_CLASS_TEXT' => 'لا السيارات المتاحة في هذه الفئة',
    'LANG_ITEMS_NONE_AVAILABLE_TEXT' => 'لا السيارات المتاحة',
    'LANG_ITEMS_NONE_AVAILABLE_IN_THIS_CLASS_TEXT' => 'لا السيارات المتاحة في هذه الفئة',
    ...
    'LANG_LOCATION_SELECT2_TEXT' => '- اختر المكان -',
    'LANG_LOCATIONS_ALL_TEXT' => 'All Locations',
    'LANG_PRICING_DAILY_TEXT' => 'اليومية',
    'LANG_PRICING_HOURLY_TEXT' => 'ساعة',
    'LANG_PRICING_PER_ORDER2_TEXT' => 'Per Order',
    'LANG_PRICING_COMBINED_DAILY_AND_HOURLY_TEXT' => 'الجامع - يومية & أمبير؛ كل ساعة',
    'LANG_PRICING_PER_ORDER_TEXT' => 'booking',
    ...
    'LANG_PRICING_PER_DAY_TEXT' => 'يوم',
    'LANG_PRICING_PER_DAY_SHORT_TEXT' => ' د.',
    'LANG_PRICING_PER_NIGHT_TEXT' => 'night',
    'LANG_PRICING_PER_NIGHT_SHORT_TEXT' => 'n.',
    'LANG_PRICING_PER_HOUR_TEXT' => 'ساعة',
    'LANG_PRICING_PER_HOUR_SHORT_TEXT' => '/ ساعة',
    'LANG_PRICING_PER_MINUTE_TEXT' => 'minute',
    'LANG_PRICING_PER_MINUTE_SHORT_TEXT' => 'min',

    // Search step no. 1 - item search
    'LANG_ORDER_TEXT' => 'الحجز',
    'LANG_PICKUP_TEXT' => 'Pick Up',
    'LANG_RETURN_TEXT' => 'Return',
    'LANG_INFORMATION_TEXT' => 'Information',
    'LANG_CITY_AND_LOCATION_TEXT' => 'مدينة & أمبير؛ المكان:',
    'LANG_SEARCH_PICKUP_CITY_AND_LOCATION_SELECT_TEXT' => 'وانيت مدينة اند الموقع:',
    'LANG_SEARCH_PICKUP_CITY_AND_LOCATION_SELECT2_TEXT' => '- وانيت مدينة اند الموقع -', // MB
    'LANG_SEARCH_RETURN_CITY_AND_LOCATION_SELECT_TEXT' => 'قطرة معطلة مدينة اند الموقع:',
    'LANG_SEARCH_RETURN_CITY_AND_LOCATION_SELECT2_TEXT' => '- قطرة معطلة مدينة اند الموقع -', // MB
    'LANG_ORDER_PERIOD_SELECT_TEXT' => 'فترة الحجز:',
    'LANG_ORDER_PERIOD_SELECT2_TEXT' => ' - Select Period -', // MB
    'LANG_COUPON_CODE_TEXT' => 'Coupon code',
    'LANG_ORDER_CODE_INPUT_TEXT' => 'لدي رقم الحجز:',
    'LANG_ORDER_CODE_INPUT2_TEXT' => '- لدي رقم الحجز -', // MB
    'LANG_COUPON_CODE_INPUT_TEXT' => 'I have coupon code:',
    'LANG_COUPON_CODE_INPUT2_TEXT' => '- I have coupon code -', // MB
    'LANG_LOCATION_PICKUP_TEXT' => 'البيك اب الموقع',
    'LANG_LOCATION_RETURN_TEXT' => 'الانزال الموقع',
    'LANG_ALL_BODY_TYPES_DROPDOWN_TEXT' => '---- جميع أنواع ----',
    'LANG_ALL_TRANSMISSION_TYPES_DROPDOWN_TEXT' => '---- كل الإرسال ----',
    'LANG_SELECT_PICKUP_LOCATION_TEXT' => '- اختر اقطة الموقع -',
    'LANG_SELECT_RETURN_LOCATION_TEXT' => '- اختر المكان الإفلات من -',
    'LANG_PICKUP_DATE_TEXT' => 'البيك اب التسجيل',
    'LANG_RETURN_DATE_TEXT' => 'الانزال التسجيل',
    'LANG_ORDER_NO_PERIOD_SELECTED_ERROR_TEXT' => 'Please selected reservation period!',
    ...
    'LANG_LOCATION_PICKUP_SELECT_ERROR_TEXT' => 'الرجاء تحديد البيك اب الموقع.',
    'LANG_LOCATION_RETURN_SELECT_ERROR_TEXT' => 'الرجاء تحديد غلبه النعاس الموقع.',
    'LANG_SHOW_ITEM_DESCRIPTION_TEXT' => 'مشاهدة وصف سيارة',
    'LANG_ORDER_UPDATE_MY_ORDER_TEXT' => 'تحديث حجزي',
    'LANG_CANCEL_ORDER_TEXT' => 'الغاء الحجز',
    'LANG_ORDER_CHANGE_DATE_TIME_AND_LOCATION_TEXT' => 'تغيير التاريخ والوقت اند الموقع',
    'LANG_ORDER_CHANGE_ORDERED_ITEM_MODELS_TEXT' => 'تغيير سيارات',
    'LANG_ORDER_CHANGE_ORDERED_ITEMS_TEXT' => 'تغيير سيارات',
    'LANG_CHANGE_EXTRAS_TEXT' => 'تغيير إضافات',
    'LANG_CHANGE_RENTAL_OPTIONS_TEXT' => 'تغيير إضافات',
    'LANG_IN_THIS_LOCATION_TEXT' => 'في هذا الفرع',
    'LANG_AFTERHOURS_PICKUP_IS_NOT_ALLOWED_TEXT' => 'غير مسموح',
    'LANG_AFTERHOURS_RETURN_IS_NOT_ALLOWED_TEXT' => 'غير مسموح',

    // Search step no. 3 - search results
    'LANG_DISTANCE_AWAY_TEXT' => '%s away',
    'LANG_ORDER_DATA_TEXT' => 'تفاصيل الحجز',
    'LANG_ORDER_CODE_TEXT' => 'الحجز لا.',
    'LANG_ORDER_CODE2_TEXT' => 'الحجز لا.',
    'LANG_ORDER_EDIT_TEXT' => 'تحرير',
    'LANG_ORDER_VIEW_DETAILS_TEXT' => 'View Reservation Details',
    'LANG_ORDER_PICKUP_TEXT' => 'بيك أب',
    'LANG_ORDER_BUSINESS_HOURS_TEXT' => 'ساعات العمل',
    'LANG_ORDER_FEE_TEXT' => 'الرسوم',
    'LANG_ORDER_RETURN_TEXT' => 'عودة',
    'LANG_ORDER_NIGHTLY_RATE_TEXT' => 'بعد ساعات',
    'LANG_ORDER_AFTERHOURS_TEXT' => 'بعد ساعات',
    'LANG_ORDER_EARLY_TEXT' => 'Early',
    'LANG_ORDER_LATE_TEXT' => 'Late',
    'LANG_ORDER_AFTERHOURS_PICKUP_TEXT' => 'بعد ساعات بيك آب',
    'LANG_ORDER_AFTERHOURS_PICKUP_IMPOSSIBLE_TEXT' => 'مستحيل',
    'LANG_ORDER_AFTERHOURS_RETURN_TEXT' => 'بعد ساعة من عودته',
    'LANG_ORDER_AFTERHOURS_RETURN_IMPOSSIBLE_TEXT' => 'مستحيل',
    'LANG_SEARCH_RESULTS_TEXT' => 'نتائج البحث',

    // Search step no. 4 - booking options
    'LANG_SELECT_RENTAL_OPTIONS_TEXT' => 'اختيار الاكسسوارات',
    'LANG_SELECTED_ITEMS_TEXT' => 'سيارات مختارة',
    'LANG_FOR_DEPENDANT_ITEM_TEXT' => ' (for %s)',
    'LANG_NO_EXTRAS_AVAILABLE_CLICK_CONTINUE_TEXT' => 'لا سيارة إضافات تتوفر انقر على زر متابعة.',

    // Search step no. 5 - booking details
    'LANG_PICKUP_DATE_AND_TIME_TEXT' => 'البيك اب التسجيل اند الوقت',
    'LANG_RETURN_DATE_AND_TIME_TEXT' => 'غلبه النعاس، التاريخ وأمبير؛ الوقت',
    'LANG_UNIT_PRICE_TEXT' => 'سعر الوحدة',
    'LANG_LOCATION_PICKUP_FEE_TEXT' => 'البيك اب تهمة',
    'LANG_LOCATION_PICKUP_FEE2_TEXT' => 'البيك اب تهمة', // Uppercase lowercase
    'LANG_LOCATION_RETURN_FEE_TEXT' => 'تهمة غلبه النعاس',
    'LANG_LOCATION_RETURN_FEE2_TEXT' => 'تهمة غلبه النعاس', // Uppercase lowercase
    'LANG_LOCATION_NIGHTLY_RATE_APPLIED_TEXT' => '(معدل ليلا تطبيق)',
    'LANG_ITEMS_QUANTITY_SUFFIX_TEXT' => 'السيارة (ق)',
    'LANG_EXTRAS_QUANTITY_SUFFIX_TEXT' => 'extra(s)',
    'LANG_PAY_NOW_OR_AT_PICKUP_TEXT' => 'الدفع الآن / في اقطة',
    'LANG_PAYMENT_PAY_NOW_TEXT' => 'الدفع الآن',
    'LANG_PAYMENT_PAY_AT_PICKUP_TEXT' => 'الدفع في اقطة',
    ...
    'LANG_ORDER_RENTAL_DETAILS_TEXT' => 'تأجير تفاصيل',
    'LANG_PAYMENT_GROSS_TOTAL_TEXT' => 'الباطن إجمالي',
    'LANG_PAYMENT_GRAND_TOTAL_TEXT' => 'المجموع',
    'LANG_CUSTOMER_DETAILS_TEXT' => 'تفاصيل العملاء',
    'LANG_CUSTOMER_SEARCH_FOR_EXISTING_TEXT' => 'تفاصيل العملاء الحاليين',
    'LANG_CUSTOMER_EXISTING_TEXT' => 'العملاء الحاليين',
    ...
    'LANG_CUSTOMER_FETCH_DETAILS_TEXT' => 'الجلب تفاصيل',
    'LANG_CUSTOMER_OR_ENTER_DETAILS_TEXT' => 'OR',
    'LANG_CUSTOMER_TEXT' => 'عميل',
    'LANG_CUSTOMER_SELECT_TEXT' => 'Select Customer',
    'LANG_CITY_TEXT' => 'مدينة',
    'LANG_STATE_TEXT' => 'الدولة',
    'LANG_COUNTRY_TEXT' => 'البلد',
    'LANG_ADDITIONAL_COMMENTS_TEXT' => 'تعليقات إضافية',
    'LANG_CUSTOMER_ID_TEXT' => 'ID العميل',
    ...
    'LANG_PAYMENT_PAY_BY_SHORT_TEXT' => 'الدفع عن طريق',
    'LANG_SEARCH_I_AGREE_WITH_TERMS_AND_CONDITIONS_TEXT' => 'وأنا أتفق مع شروط & أمبير؛ الظروف',
    'LANG_TERMS_AND_CONDITIONS_TEXT' => 'الشروط والاحكام',
    'LANG_FIELD_REQUIRED_TEXT' => 'هذا الحقل مطلوب',

    // Search step no. 6 - process booking
    'LANG_PAYMENT_DETAILS_TEXT' => 'تفاصيل الدفع',
    'LANG_PAYMENT_OPTION_TEXT' => 'الدفع بواسطة',
    ...
    'LANG_STEP5_PAY_ONLINE_TEXT' => 'الإنترنت دفعت',
    'LANG_STEP5_PAY_AT_PICKUP_TEXT' => 'الدفع في اقطة',
    'LANG_ORDER_RECEIVED_YOUR_CODE_S_TEXT' => 'أكد الحجز الحجز لا. s%.',
    'LANG_ORDER_CONFIRMED_YOUR_CODE_S_TEXT' => 'أكد الحجز الحجز لا. s%.',
    'LANG_ORDER_UPDATED_YOUR_CODE_S_TEXT' => 'أكد الحجز الحجز لا. s%.',
    'LANG_INVOICE_SENT_TO_YOUR_EMAIL_ADDRESS_TEXT' => 'أرسلت الفاتورة في عنوان البريد الإلكتروني الخاص بك',

    // display-booking-failure.php
    'LANG_ORDER_FAILURE_TEXT' => 'الفشل الحجز',
    'LANG_SEARCH_ALL_ITEM_MODELS_TEXT' => 'بحث جميع سيارات',
    ...
    'LANG_DAY_PRICE_TEXT' => 'يوم السعر من',
    'LANG_HOUR_PRICE_TEXT' => 'سعر ساعة من',
    'LANG_NO_ITEM_MODELS_IN_THIS_CATEGORY_TEXT' => 'لا توجد سيارات في هذه الفئة',
    'LANG_PRICE_FOR_DAY_FROM_TEXT' => 'سعر يوميا ابتداء من',
    'LANG_PRICE_FOR_HOUR_FROM_TEXT' => 'الأسعار لمدة ساعة بدءا من',
    'LANG_PRICE_WITH_APPLIED_TEXT' => 'مع التطبيقية',
    'LANG_WITH_APPLIED_DISCOUNT_TEXT' => 'الخصم',

    // class.ItemsAvailability.php
    'LANG_MONTH_DAY_TEXT' => 'يوم',
    ...
    'LANG_ITEMS_AVAILABILITY_THIS_MONTH_TEXT' => 'سيارات توافر هذا الشهر',
    'LANG_ITEMS_AVAILABILITY_NEXT_MONTH_TEXT' => 'سيارات التوفر الشهر القادم',
    'LANG_ITEM_MODEL_ID_TEXT' => 'ID:',
    'LANG_TOTAL_ITEMS_TEXT' => 'مجموع السيارات:',
    ...
    'LANG_EXTRAS_AVAILABILITY_THIS_MONTH_TEXT' => 'Extras Availability This Month',
    'LANG_EXTRAS_AVAILABILITY_NEXT_MONTH_TEXT' => 'Extras Availability Next Month',
    'LANG_EXTRA_ID_TEXT' => 'ID',
    'LANG_TOTAL_EXTRAS_TEXT' => 'Total extras',

    // class.ItemModelsController.php
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME1_TEXT' => 'لوقود Type',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL1_TEXT' => 'لوقود',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME2_TEXT' => 'Type علبة',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL2_TEXT' => 'علبة',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME3_TEXT' => 'استهلاك الوقود',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL3_TEXT' => 'استهلاك الوقود',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME4_TEXT' => 'الركاب سعة',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL4_TEXT' => 'الركاب سعة',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME5_TEXT' => 'قدرة المحرك',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL5_TEXT' => 'قدرة المحرك',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME6_TEXT' => 'ماكس الأمتعة',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL6_TEXT' => 'ماكس الأمتعة',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME7_TEXT' => 'أبواب',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL7_TEXT' => 'أبواب',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME8_TEXT' => 'الأميال',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL8_TEXT' => 'الأميال',
    'LANG_PRICING_PRICE_FROM_TEXT' => 'الأسعار من',
    'LANG_PRICING_INQUIRE_TEXT' => 'Call',
    'LANG_PRICING_GET_A_QUOTE_TEXT' => 'Get a quote',
    'LANG_FEATURES_TEXT' => 'ملامح',
    'LANG_PRICING_GET_IT_TEXT' => 'كتاب',

    // class.LocationsController.php
    'LANG_LOCATIONS_BUSINESS_HOURS_TEXT' => 'Business Hours',
    'LANG_LOCATION_FEES_TEXT' => 'رسوم الموقع',
    ...
    'LANG_ITEM_MODEL_MINIMUM_ALLOWED_AGE_TEXT' => 'عمر السائق الحد الأدنى',
    'LANG_ITEM_MODEL_MAXIMUM_ALLOWED_AGE_TEXT' => 'Maximum Driver Age',
    'LANG_ITEM_MODEL_MIN_ALLOWED_AGE_TEXT' => 'عمر السائق الحد الأدنى',
    ...
    'LANG_ITEM_MODEL_ADDITIONAL_INFORMATION_TEXT' => 'معلومات إضافية',
    ...
    'LANG_ITEM_MODEL_VISIT_PAGE_TEXT' => 'مشاهدة وصف سيارة',
    ...
    'LANG_ORDER_S_CANCELLED_SUCCESSFULLY_TEXT' => 'إلغاء بنجاح s%',
    'LANG_ORDER_NOT_CANCELLED_CODE_S_DOES_NOT_EXIST_TEXT' => '%s لم يكن إلغاء الحجز',

    // template.CodeInputForm.php
    'LANG_SEARCH_CHANGE_ORDER_TEXT' => 'Change
reservation',
    'LANG_SEARCH_CHANGE_ORDER2_TEXT' => 'تغيير الحجز',
    'LANG_ORDER_NO_CODE_ERROR_TEXT' => 'الرجاء إدخال رقم الحجز!',

    // Errors
    'LANG_ERROR_REQUIRED_FIELD_TEXT' => 'حقل مطلوب',
    'LANG_ERROR_IS_EMPTY_TEXT' => 'فارغ',
    'LANG_ERROR_SLIDER_CANT_BE_DISPLAYED_TEXT' => 'Slider can\'t be displayed',
    'LANG_CUSTOMER_DETAILS_NOT_FOUND_ERROR_TEXT' => 'تفاصيل لا توجد يرجى الاشتراك.',
    'LANG_ERROR_CUSTOMER_DETAILS_NO_ERROR_TEXT' => 'لا أخطاء',
    ...
    'LANG_ERROR_ORDER_DOES_NOT_EXIST_TEXT' => 'لا وجود لها',
    'LANG_ITEM_MODELS_PLEASE_SELECT_AT_LEAST_ONE_ITEM_MODEL_ERROR_TEXT' => 'الرجاء تحديد سيارة واحدة على الأقل',
    'LANG_ITEMS_PLEASE_SELECT_AT_LEAST_ONE_ITEM_ERROR_TEXT' => 'الرجاء تحديد سيارة واحدة على الأقل',
    'LANG_ERROR_SEARCH_ENGINE_DISABLED_TEXT' => 'الحجز عبر الإنترنت آسف غير متوفرة حاليا يرجى المحاولة لاحقا.',
    'LANG_SEARCH_OUT_BEFORE_IN_ERROR_TEXT' => 'عذرا قمت بإدخال معايير البحث غير صحيحة الرجاء المحاولة مع معايير البحث صالحة.',
    'LANG_SEARCH_MINIMUM_DURATION_CANT_BE_LESS_THAN_S_ERROR_TEXT' => '.%s لا ينبغي أن يكون الحد الأدنى لعدد أقل من ليلة',
    'LANG_SEARCH_ERROR_PLEASE_MODIFY_YOUR_SEARCH_CRITERIA_TEXT' => 'الرجاء تعديل معايير البحث الخاصة بك.',
    'LANG_ERROR_PICKUP_IS_NOT_POSSIBLE_ON_TEXT' => 'الحجز غير ممكن لفحص في تاريخ:',
    'LANG_ERROR_PLEASE_MODIFY_YOUR_PICKUP_TIME_BY_WEBSITE_TIME_TEXT' => 'الرجاء تعديل معايير البحث الخاصة بك وفقا لموقع الحجز التاريخ الحالي وأمبير؛ في المرة',
    'LANG_ERROR_CURRENT_DATE_TIME_TEXT' => 'موقع الحجز التاريخ والوقت الحالي:',
    ...
    'LANG_ERROR_PICKUP_DATE_CANT_BE_LESS_THAN_RETURN_DATE_TEXT' => 'Pick-Up تاريخ و أمبير؛ الوقت لا يمكن أن يكون أقل من من السقوط خارج التاريخ والوقت. يرجى اختيار الصحيح البيك اب وغلبه النعاس، التاريخ والوقت ',
    ...
    'LANG_ERROR_AFTERHOURS_PICKUP_LOCATION_IS_CLOSED_AT_THIS_TIME_TEXT' => 'بعد فرع ساعات بيك اب هو٪ الصورة في عنوان٪ الصورة ولكن تم إغلاق هذا الفرع أيضا في هذا الوقت.',
    'LANG_ERROR_AFTERHOURS_RETURN_LOCATION_IS_CLOSED_AT_THIS_TIME_TEXT' => 'بعد ساعات يتجمعوا الفرع٪ الصورة في عنوان٪ الصورة ولكن يتم إغلاق هذا الفرع أيضا في هذا الوقت.',
    ...
    'LANG_ERROR_AFTERHOURS_PICKUP_LOCATION_OPEN_HOURS_ARE_TEXT' => 'بعد فرع ساعات بيك اب ساعات مفتوحة ل٪ الصورة.',
    'LANG_ERROR_AFTERHOURS_RETURN_LOCATION_OPEN_HOURS_ARE_TEXT' => 'بعد ساعات يتجمعوا فرع مفتوحة ساعات هي٪ الصورة.',
    'LANG_ERROR_AFTERHOURS_PICKUP_IS_NOT_ALLOWED_AT_LOCATION_TEXT' => 'بعد غير مسموح ساعات صغيرة في هذا الموقع.',
    'LANG_ERROR_AFTERHOURS_RETURN_IS_NOT_ALLOWED_AT_LOCATION_TEXT' => 'بعد غير مسموح ساعات يتجمعوا في هذا الموقع.',
    'LANG_SEARCH_MAXIMUM_DURATION_CANT_BE_MORE_THAN_S_ERROR_TEXT' => '.%s طول حجز أقصى لا يمكن أن يكون أطول من (بالأيام)',
    ...
    'LANG_ORDER_NO_S_PICKED_UP_ERROR_TEXT' => 'Order No. %s already marked as departed, and is not available for further editing.',
    'LANG_ORDER_NO_S_CANCELLED_ERROR_TEXT' => 'Order No. %s has been cancelled.',
    'LANG_ORDER_NO_S_REFUNDED_ERROR_TEXT' => 'Order No. %s was already refunded and is not available anymore.',
    ...
    'LANG_ORDER_OTHER_ERROR_TEXT' => 'خطأ حجز باقي اذا واصلتم رؤية هذه الرسالة، يرجى الاتصال بمسؤول الموقع.',
    ...
    'LANG_EMAIL_NOTIFICATION_SUBJECT_AND_BODY_EXISTS_FOR_THIS_TYPE_ERROR_TEXT' => 'Error: Other e-mail already exist with this subject and body for this notification type!',
    'LANG_EMAIL_NOTIFICATION_DOES_NOT_EXIST_ERROR_TEXT' => 'Sorry, no e-mail notification found for this id.',
    'LANG_EMAIL_NOTIFICATION_UPDATE_ERROR_TEXT' => 'Error: MySQL update error for existing e-mail!',
    'LANG_EMAIL_NOTIFICATION_UPDATED_TEXT' => 'Completed: E-mail has been updated successfully!',
    ...
    'LANG_EMAIL_NOTIFICATION_REGISTERED_TEXT' => 'E-mail subject and body registered for translation.',
    ...
    'LANG_EMAIL_NOTIFICATION_SENT_TO_S_TEXT' => 'Completed: E-mail was sent successfully to %s!',
    ...
    'LANG_EXTRA_DISCOUNT_DAYS_INTERSECTION_ERROR_TEXT' => 'Error: Extra discount days range intersects other discount for specific extra or all extras!',
    ...
    'LANG_PAYMENT_METHOD_DEFAULT_PAYPAL_TEXT' => 'اون لاين - باي بال',
    ...
    'LANG_PAYMENT_METHOD_DEFAULT_BANK_TEXT' => 'نقل البنك',
    'LANG_PAYMENT_METHOD_DEFAULT_BANK_DETAILS_TEXT' => 'معلوماتك بنك',
    'LANG_PAYMENT_METHOD_DEFAULT_PAY_OVER_THE_PHONE_TEXT' => 'الدفع عبر الهاتف',
    'LANG_PAYMENT_METHOD_DEFAULT_PAY_ON_ARRIVAL_TEXT' => 'الدفع في البيك اب',
    'LANG_PAYMENT_METHOD_DEFAULT_PAY_ON_ARRIVAL_DETAILS_TEXT' => 'بطاقة الائتمان مطلوبة',
    'LANG_EMAIL_DEFAULT_DEAR_TEXT' => 'عزيزي',
    'LANG_EMAIL_DEFAULT_REGARDS_TEXT' => 'تحياتي',
    ...
    'LANG_SEARCH_PICKUP_DATE_SELECT_ERROR_TEXT' => 'الرجاء إدخال تاريخ الوصول',
    ...
    'LANG_SEARCH_RETURN_DATE_SELECT_ERROR_TEXT' => 'الرجاء إدخال تاريخ المغادرة',
    ...
    'LANG_SEARCH_TRY_DIFFERENT_DATE_OR_CRITERIA_ERROR_TEXT' => 'لا السيارات المتاحة الرجاء محاولة فتحة تاريخ المختلفة أو تعديل معايير البحث الخاصة بك.',
...
(New WP User)',
    ...
    'LANG_SETTINGS_DEFAULT_TERMS_AND_CONDITIONS_PAGE_TITLE_TEXT' => 'شروط الاستخدام لتأجير السيارات',
    'LANG_SETTINGS_DEFAULT_TERMS_AND_CONDITIONS_PAGE_CONTENT_TEXT' => 'يجب اتباع المبادئ التوجيهية اند. حيث لتأجير السيارات العادية',
    ...
    'LANG_TRANSACTION_PAYER_EMAIL_TEXT' => 'الدافع البريد الإلكتروني',
    ...
    // ZIP Code Element
    'LANG_ZIP_CODE_TEXT' => 'الرمز البريدي',
