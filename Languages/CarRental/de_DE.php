...
return array(
    ...
    // Admin - Global
    'LANG_ORDERS_VIEW_TEXT' => 'Buchungen anzeigen',
    'LANG_ORDERS_VIEW_UNPAID_TEXT' => 'offene Reservierung anzeigen',
    'LANG_ORDERS_NONE_YET_TEXT' => 'Bisher keine Reservierung',
    'LANG_ORDER_DETAILS_TEXT' => 'Reservierung Details',
    'LANG_CUSTOMER_DETAILS_FROM_DB_TEXT' => 'Kundeninformationen (Letzte Version aus der Datenbank)',
    'LANG_ORDER_STATUS_TEXT' => 'Reservierung Status',
    'LANG_ORDER_STATUS_UPCOMING_TEXT' => 'Upcoming',
    'LANG_ORDER_STATUS_DEPARTED_TEXT' => 'Abgeholt',
    'LANG_ORDER_STATUS_COMPLETED_EARLY_TEXT' => 'Completed Early',
    'LANG_ORDER_STATUS_COMPLETED_TEXT' => 'Completed',
    'LANG_ORDER_STATUS_ACTIVE_TEXT' => 'Aktiv',
    'LANG_ORDER_STATUS_CANCELLED_TEXT' => 'Abgebrochen',
    'LANG_ORDER_STATUS_PAID_TEXT' => 'Bezahlt',
    'LANG_ORDER_STATUS_UNPAID_TEXT' => 'nicht bezahlt',
    'LANG_ORDER_STATUS_REFUNDED_TEXT' => 'Rückerstattet',
    'LANG_INVOICE_PRINT_TEXT' => 'Rechnung drucken',
    'LANG_CUSTOMER_BACK_TO_ORDERS_LIST_TEXT' => 'Zurück zur Buchungsliste des Kunden',
    ...
    'LANG_PRICING_REGULAR_PRICE_TEXT' => 'Regulärer Preis',
    'LANG_PRICE_TYPE_TEXT' => 'Preis Typ',
    ...
    'LANG_CALENDAR_NO_CALENDARS_FOUND_TEXT' => 'Für den gewählten Zeitraum wurde kein Kalender gefunden',
...
and when plugin is network-enabled in multisite mode',
    ...
    'LANG_ITEM_NOT_AVAILABLE_FOR_ORDERING_TEXT' => 'Dieses Fahrzeug ist nicht verfügbar for reservation.',

    // Manufacturer Element
    'LANG_MANUFACTURER_TEXT' => 'Hersteller',
    'LANG_MANUFACTURER_ID_TEXT' => 'Hersteller Id',
    'LANG_MANUFACTURER_IDS_TEXT' => 'Hersteller Ids',
    'LANG_MANUFACTURER_SELECT_TEXT' => 'Hersteller:',
    'LANG_MANUFACTURER_SELECT2_TEXT' => '- Select Hersteller -', // MB
    'LANG_MANUFACTURER_ADD_EDIT_TEXT' => 'Add / Edit Hersteller',

    // Class Element
    'LANG_CLASS_TEXT' => 'Klasse',
    'LANG_CLASS_ID_TEXT' => 'Klasse Id',
    'LANG_CLASS_IDS_TEXT' => 'Klasse Ids',
    'LANG_CLASS_SELECT_TEXT' => 'Klasse:',
    'LANG_CLASS_SELECT2_TEXT' => '- Select Klasse -', // MB
    'LANG_CLASS_ADD_NEW_TEXT' => 'Add New Klasse',
    'LANG_CLASS_LIST_TEXT' => 'Klasse List',
    ...
    'LANG_LOCATION_STATUS_OPEN_TEXT' => 'Offen',
    'LANG_LOCATION_STATUS_CLOSED_TEXT' => 'Geschlossen',
    ...
    // Ext - Popular
    'LANG_ITEM_MODEL_TEXT' => 'Fahrzeug modell',
    'LANG_EXTRA_TEXT' => 'Extra',
    'LANG_RENTAL_OPTION_TEXT' => 'Mietoption',
    'LANG_ITEM_MODELS_TEXT' => 'Fahrzeuge modell',
    'LANG_ITEMS_TEXT' => 'Fahrzeuge',
    'LANG_EXTRAS_TEXT' => 'Extras',
    'LANG_RENTAL_OPTIONS_TEXT' => 'Mietoptionen',
    'LANG_ITEM_MODEL_SHOW_TEXT' => 'Fahrzeug anschauen modell',
    'LANG_COUPON_TEXT' => 'Coupon',

    // Search Element
    'LANG_SEARCH_TEXT' => 'Suche',
    'LANG_SEARCH_DEFAULT_SEARCH_PAGE_URL_SLUG_TEXT' => 'search', // Latin letters only
    'LANG_TAX_WITH_TEXT' => 'inklusive MWST',
    'LANG_TAX_WITHOUT_TEXT' => 'ohne MWST',
    'LANG_TAX_SHORT_TEXT' => 'MWST',
    'LANG_DEPOSIT_TEXT' => 'Kaution',
    'LANG_DISCOUNT_TEXT' => 'Rabatt',
    'LANG_PREPAYMENT_TEXT' => 'Vorauszahlung',
    'LANG_ITEM_MODELS_NONE_AVAILABLE_TEXT' => 'Keine Fahrzeuge verfügbar',
    'LANG_ITEM_MODELS_NONE_AVAILABLE_IN_THIS_CLASS_TEXT' => 'In dieser Klasse sind keine Fahrzeuge verfügbar',
    'LANG_ITEMS_NONE_AVAILABLE_TEXT' => 'Keine Fahrzeuge verfügbar',
    'LANG_ITEMS_NONE_AVAILABLE_IN_THIS_CLASS_TEXT' => 'In dieser Klasse sind keine Fahrzeuge verfügbar',
    'LANG_EXTRAS_NONE_AVAILABLE_TEXT' => 'Keine Extras verfügbar',
    ...
    'LANG_ORDER_MARK_PAID_TEXT' => 'Als bezahlt markieren',
    'LANG_ORDER_MARK_COMPLETED_EARLY_TEXT' => 'Mark Completed Early',
    'LANG_ORDER_REFUND_TEXT' => 'Bezahlung zurückerstatten',
    'LANG_LOCATION_SELECT2_TEXT' => '-- Ort wählen --',
    'LANG_LOCATIONS_ALL_TEXT' => 'Alle Filialen',
    'LANG_PRICING_DAILY_TEXT' => 'Täglich',
    'LANG_PRICING_HOURLY_TEXT' => 'Stündlich',
    'LANG_PRICING_PER_ORDER2_TEXT' => 'Pro Reservation',
    'LANG_PRICING_COMBINED_DAILY_AND_HOURLY_TEXT' => 'Kombiniert - Täglich &amp; Stündlich',
    'LANG_PRICING_PER_ORDER_TEXT' => 'Reservierung',
    ...
    'LANG_PICKUP_TEXT' => 'Abholung',
    'LANG_RETURN_TEXT' => 'Rückgabe',
    'LANG_INFORMATION_TEXT' => 'Information',
    'LANG_CITY_AND_LOCATION_TEXT' => 'Stadt &amp; Ort:',
    'LANG_SEARCH_PICKUP_CITY_AND_LOCATION_SELECT_TEXT' => 'Abholung Stadt &amp; Ort:',
    'LANG_SEARCH_PICKUP_CITY_AND_LOCATION_SELECT2_TEXT' => '- Select Abholung Stadt &amp; Ort -', // MB
    'LANG_SEARCH_RETURN_CITY_AND_LOCATION_SELECT_TEXT' => 'Rückgabe Stadt &amp; Ort:',
    'LANG_SEARCH_RETURN_CITY_AND_LOCATION_SELECT2_TEXT' => '- Select Rückgabe Stadt &amp; Ort -', // MB
    'LANG_ORDER_PERIOD_SELECT_TEXT' => 'Reserviert für:',
    'LANG_ORDER_PERIOD_SELECT2_TEXT' => ' - Select Period -', // MB
    'LANG_COUPON_CODE_TEXT' => 'Coupon code',
    'LANG_ORDER_CODE_INPUT_TEXT' => 'Ich habe eine Buchungsnummer:',
    'LANG_ORDER_CODE_INPUT2_TEXT' => '- Ich habe eine Buchungsnummer -', // MB
    'LANG_COUPON_CODE_INPUT_TEXT' => 'I have coupon code:',
    'LANG_COUPON_CODE_INPUT2_TEXT' => '- I have coupon code -', // MB
    'LANG_LOCATION_PICKUP_TEXT' => 'Abholort',
    'LANG_LOCATION_RETURN_TEXT' => 'Rückgabeort',
    'LANG_ALL_BODY_TYPES_DROPDOWN_TEXT' => '---- Alle Typen ----',
    'LANG_ALL_TRANSMISSION_TYPES_DROPDOWN_TEXT' => '---- All Transmissions ----',
    'LANG_SELECT_PICKUP_LOCATION_TEXT' => '-- Abholort wählen --',
    'LANG_SELECT_RETURN_LOCATION_TEXT' => '-- Rückgabeort wählen --',
    'LANG_PICKUP_DATE_TEXT' => 'Abholdatum',
    'LANG_RETURN_DATE_TEXT' => 'Rückgabedatum',
    'LANG_ORDER_NO_PERIOD_SELECTED_ERROR_TEXT' => 'Bitte wählen Sie einen Buchungszeitraum!',
    ...
    'LANG_LOCATION_PICKUP_SELECT_ERROR_TEXT' => 'Bitte wählen Sie einen Abholort!',
    'LANG_LOCATION_RETURN_SELECT_ERROR_TEXT' => 'Bitte wählen Sie einen Rückgabeort!',
    'LANG_SHOW_ITEM_DESCRIPTION_TEXT' => 'Fahrzeugbeschreibung anzeigen',
    'LANG_ORDER_UPDATE_MY_ORDER_TEXT' => 'Buchung aktualisieren',
    'LANG_CANCEL_ORDER_TEXT' => 'Buchung abbrechen',
    'LANG_ORDER_CHANGE_DATE_TIME_AND_LOCATION_TEXT' => 'Datum, Zeit &amp; Ort ändern',
    'LANG_ORDER_CHANGE_ORDERED_ITEM_MODELS_TEXT' => 'Fahrzeuge wechseln',
    'LANG_ORDER_CHANGE_ORDERED_ITEMS_TEXT' => 'Fahrzeuge wechseln',
    'LANG_CHANGE_EXTRAS_TEXT' => 'Extras ändern',
    'LANG_CHANGE_RENTAL_OPTIONS_TEXT' => 'Mietoptionen ändern',
    'LANG_IN_THIS_LOCATION_TEXT' => 'In dieser Filiale',
    'LANG_AFTERHOURS_PICKUP_IS_NOT_ALLOWED_TEXT' => 'Nicht möglich',
    'LANG_AFTERHOURS_RETURN_IS_NOT_ALLOWED_TEXT' => 'Nicht möglich',

    // Search step no. 3 - search results
    'LANG_DISTANCE_AWAY_TEXT' => '%s away',
    'LANG_ORDER_DATA_TEXT' => 'Buchungsdetails',
    'LANG_ORDER_CODE_TEXT' => 'Buchungsnummer',
    'LANG_ORDER_CODE2_TEXT' => 'Buchungsnummer', // Uppercase lowercase
    'LANG_ORDER_EDIT_TEXT' => 'ändern',
    'LANG_ORDER_VIEW_DETAILS_TEXT' => 'View Reservation Details',
    'LANG_ORDER_PICKUP_TEXT' => 'Abholung',
    'LANG_ORDER_BUSINESS_HOURS_TEXT' => 'Öffnungszeiten',
    'LANG_ORDER_FEE_TEXT' => 'Gebühr',
    'LANG_ORDER_RETURN_TEXT' => 'Rückkehr',
    'LANG_ORDER_NIGHTLY_RATE_TEXT' => 'ausserhalb der Öffnungszeiten',
    'LANG_ORDER_AFTERHOURS_TEXT' => 'ausserhalb der Öffnungszeiten',
    'LANG_ORDER_EARLY_TEXT' => 'Early',
    'LANG_ORDER_LATE_TEXT' => 'Late',
    'LANG_ORDER_AFTERHOURS_PICKUP_TEXT' => 'Abholung ausserhalb der Öffnungszeiten',
    'LANG_ORDER_AFTERHOURS_PICKUP_IMPOSSIBLE_TEXT' => 'Nicht möglich',
    'LANG_ORDER_AFTERHOURS_RETURN_TEXT' => 'Rückgabe ausserhalb der Öffnungszeiten',
    'LANG_ORDER_AFTERHOURS_RETURN_IMPOSSIBLE_TEXT' => 'Nicht möglich',
    'LANG_SEARCH_RESULTS_TEXT' => 'Suchresultate',

    // Search step no. 4 - booking options
    'LANG_SELECT_RENTAL_OPTIONS_TEXT' => 'Zusatzoptionen wählen',
    'LANG_SELECTED_ITEMS_TEXT' => 'Gewählte Fahrzeuge',
    'LANG_FOR_DEPENDANT_ITEM_TEXT' => ' (for %s)',
    'LANG_NO_EXTRAS_AVAILABLE_CLICK_CONTINUE_TEXT' => 'Es sind keine Extras verfügbar. Klicken Sie auf weiter',

    // Search step no. 5 - booking details
    'LANG_PICKUP_DATE_AND_TIME_TEXT' => 'Abholdatum &amp; Zeit',
    'LANG_RETURN_DATE_AND_TIME_TEXT' => 'Rückgabedatum &amp; Zeit',
    'LANG_UNIT_PRICE_TEXT' => 'Preis pro Stück',
    'LANG_LOCATION_PICKUP_FEE_TEXT' => 'Abholgebühr',
    'LANG_LOCATION_PICKUP_FEE2_TEXT' => 'Abholgebühr', // Uppercase lowercase
    'LANG_LOCATION_RETURN_FEE_TEXT' => 'Rückgabegebühr',
    'LANG_LOCATION_RETURN_FEE2_TEXT' => 'Rückgabegebühr', // Uppercase lowercase
    'LANG_LOCATION_NIGHTLY_RATE_APPLIED_TEXT' => '(Gebühr für ausserhalb der Öffnungszeiten)',
    'LANG_ITEMS_QUANTITY_SUFFIX_TEXT' => 'Fahrzeug(e)',
    'LANG_EXTRAS_QUANTITY_SUFFIX_TEXT' => 'Extra(s)',
    'LANG_PAY_NOW_OR_AT_PICKUP_TEXT' => 'Sofort bezahlen / bei Abholung',
    'LANG_PAYMENT_PAY_NOW_TEXT' => 'Sofort bezahlen',
    'LANG_PAYMENT_PAY_AT_PICKUP_TEXT' => 'Bei Abholung bezahlen',
    'LANG_PAYMENT_PAY_LATER_OR_ON_RETURN_TEXT' => 'Später bezahlen / bei Rückgabe',
    'LANG_PAYMENT_PAY_LATER_TEXT' => 'Später bezahlen',
    'LANG_PAYMENT_PAY_ON_RETURN_TEXT' => 'Bei Rückgabe bezahlen',
    'LANG_ORDER_RENTAL_DETAILS_TEXT' => 'Mietübersicht',
    'LANG_PAYMENT_GROSS_TOTAL_TEXT' => 'Sub Total',
    'LANG_PAYMENT_GRAND_TOTAL_TEXT' => 'Total',
    'LANG_CUSTOMER_DETAILS_TEXT' => 'Kundeninformationen',
    'LANG_CUSTOMER_SEARCH_FOR_EXISTING_TEXT' => 'Nach bestehendem Kunden suchen',
    'LANG_CUSTOMER_EXISTING_TEXT' => 'Bestehender Kunde',
    ...
    'LANG_CUSTOMER_FETCH_DETAILS_TEXT' => 'Informationen abrufen',
    'LANG_CUSTOMER_OR_ENTER_DETAILS_TEXT' => 'Oder neuen Account erstellen',
    'LANG_CUSTOMER_TEXT' => 'Kunde',
    'LANG_CUSTOMER_SELECT_TEXT' => 'Select Customer',
    'LANG_CITY_TEXT' => 'Stadt',
    'LANG_STATE_TEXT' => 'Kanton',
    'LANG_COUNTRY_TEXT' => 'Land',
    'LANG_ADDITIONAL_COMMENTS_TEXT' => 'Bemerkung',
    'LANG_CUSTOMER_ID_TEXT' => 'Kundennummer',
    ...
    'LANG_PAYMENT_PAY_BY_SHORT_TEXT' => 'Bezahlen mit',
    'LANG_SEARCH_I_AGREE_WITH_TERMS_AND_CONDITIONS_TEXT' => 'Ich bin mit den AGBs einverstanden',
    'LANG_TERMS_AND_CONDITIONS_TEXT' => 'AGB',
    'LANG_FIELD_REQUIRED_TEXT' => 'Dies ist ein Pflichtfeld',

    // Search step no. 6 - process booking
    'LANG_PAYMENT_DETAILS_TEXT' => 'Zahlungsinformationen',
    'LANG_PAYMENT_OPTION_TEXT' => 'Bezahlen mit',
    'LANG_PAYMENT_PROCESSING_TEXT' => 'Bezahlvorgang wird durchgeführt...',
    'LANG_ORDER_PLEASE_WAIT_UNTIL_WILL_BE_PROCESSED_TEXT' => 'Bitte warten, Ihre Bestellung wird bearbeitet...',

    // display-booking-confirm.php
    'LANG_STEP5_PAY_ONLINE_TEXT' => 'Online bezahlt',
    'LANG_STEP5_PAY_AT_PICKUP_TEXT' => 'Bezahlung bei Abholung',
    'LANG_ORDER_RECEIVED_YOUR_CODE_S_TEXT' => 'Ihre Reservierung ist bestätigt. Ihre Buchungsnummer lautet: %s.',
    'LANG_ORDER_CONFIRMED_YOUR_CODE_S_TEXT' => 'Ihre Reservierung ist bestätigt. Ihre Buchungsnummer lautet: %s.',
    'LANG_ORDER_UPDATED_YOUR_CODE_S_TEXT' => 'Ihre Reservierung ist bestätigt. Ihre Buchungsnummer lautet: %s.',
    'LANG_INVOICE_SENT_TO_YOUR_EMAIL_ADDRESS_TEXT' => 'Die Rechnung wurde an Ihre Emailadresse geschickt',

    // display-booking-failure.php
    'LANG_ORDER_FAILURE_TEXT' => 'Reservierung Fehlgeschlagen',
    'LANG_SEARCH_ALL_ITEM_MODELS_TEXT' => 'Alle Fahrzeuge suchen',
    ...
    'LANG_DAY_PRICE_TEXT' => 'Tagespreis',
    'LANG_HOUR_PRICE_TEXT' => 'Stundenpreis',
    'LANG_NO_ITEM_MODELS_IN_THIS_CATEGORY_TEXT' => 'In dieser Kategorie gibt es keine Fahrzeuge',
    'LANG_PRICE_FOR_DAY_FROM_TEXT' => 'Preise für einen Tag ab',
    'LANG_PRICE_FOR_HOUR_FROM_TEXT' => 'Preise für eine Stunde ab',
    'LANG_PRICE_WITH_APPLIED_TEXT' => 'verbunden mit',
    'LANG_WITH_APPLIED_DISCOUNT_TEXT' => 'Rabatt',

    // class.ItemsAvailability.php
    'LANG_MONTH_DAY_TEXT' => 'Tag',
    'LANG_MONTH_DAYS_TEXT' => 'Days',
    'LANG_ITEMS_AVAILABILITY_FOR_TEXT' => 'Fahrzeuge verfügbar für',
    'LANG_ITEMS_AVAILABILITY_IN_NEXT_30_DAYS_TEXT' => 'Cars Availability in Next 30 Days',
    'LANG_ITEMS_PARTIAL_AVAILABILITY_FOR_TEXT' => 'Teilweise Fahrzeuge verfügbar für',
    'LANG_ITEMS_AVAILABILITY_THIS_MONTH_TEXT' => 'Diesen Monat verfügbare Fahrzeuge', // Not used
    'LANG_ITEMS_AVAILABILITY_NEXT_MONTH_TEXT' => 'Nächsten Monat verfügbare Fahrzeuge', // Not used
    'LANG_ITEM_MODEL_ID_TEXT' => 'ID:',
    'LANG_TOTAL_ITEMS_TEXT' => 'Total Fahrzeuge:',

    // class.ExtrasAvailability.php
    'LANG_EXTRAS_AVAILABILITY_FOR_TEXT' => 'Extras verfügbar für',
    'LANG_EXTRAS_AVAILABILITY_IN_NEXT_30_DAYS_TEXT' => 'Extras Availability in Next 30 Days',
    'LANG_EXTRAS_PARTIAL_AVAILABILITY_FOR_TEXT' => 'Teilweise Extras verfügbar für',
    ...
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME1_TEXT' => 'Kraftstoff',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL1_TEXT' => 'Kraftstoff',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME2_TEXT' => 'Getriebe',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL2_TEXT' => 'Getriebe',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME3_TEXT' => 'Kraftstoffverbrauch',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL3_TEXT' => 'Kraftstoffverbrauch',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME4_TEXT' => 'Max Passagiere',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL4_TEXT' => 'Max Passagiere',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME5_TEXT' => 'Motorleistung',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL5_TEXT' => 'Motorleistung',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME6_TEXT' => 'Max Gepäck',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL6_TEXT' => 'Max Gepäck',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME7_TEXT' => 'Türen',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL7_TEXT' => 'Türen',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME8_TEXT' => 'Kilometer inkl.',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL8_TEXT' => 'Kilometer inkl.',
    'LANG_PRICING_PRICE_FROM_TEXT' => 'Preis ab',
    'LANG_PRICING_INQUIRE_TEXT' => 'Call',
    'LANG_PRICING_GET_A_QUOTE_TEXT' => 'Get a quote',
    'LANG_FEATURES_TEXT' => 'Eigenschaften',
    'LANG_PRICING_GET_IT_TEXT' => 'Buchen',

    // class.LocationsController.php
    'LANG_LOCATIONS_BUSINESS_HOURS_TEXT' => 'Business Hours',
    'LANG_LOCATION_FEES_TEXT' => 'Zusatzgebühren',
    ...
    'LANG_ITEM_MODEL_MINIMUM_ALLOWED_AGE_TEXT' => 'Mindestalter des Fahrers',
    'LANG_ITEM_MODEL_MAXIMUM_ALLOWED_AGE_TEXT' => 'Maximum Driver Age',
    'LANG_ITEM_MODEL_MIN_ALLOWED_AGE_TEXT' => 'Mindestalter des Fahrers',
    ...
    'LANG_ITEM_MODEL_ADDITIONAL_INFORMATION_TEXT' => 'Zusätzliche Informationen',
    ...
    'LANG_ITEM_MODEL_VISIT_PAGE_TEXT' => 'Fahrzeugbeschreibung anzeigen',
    ...
    'LANG_ORDER_S_CANCELLED_SUCCESSFULLY_TEXT' => 'Buchung %s abgebrochen.',
    'LANG_ORDER_NOT_CANCELLED_CODE_S_DOES_NOT_EXIST_TEXT' => 'Buchung wurde nicht abgebrochen. Reservation code %s - does not exist.',

    // template.Step8EditBooking.php
    'LANG_SEARCH_CHANGE_ORDER_TEXT' => 'Ändern
Buchung',
    'LANG_SEARCH_CHANGE_ORDER2_TEXT' => 'Buchung ändern',
    'LANG_ORDER_NO_CODE_ERROR_TEXT' => 'Bitte geben Sie eine gültige Buchungsnummer ein!',

    // Errors
    'LANG_ERROR_REQUIRED_FIELD_TEXT' => 'Pflichtfeld',
    'LANG_ERROR_IS_EMPTY_TEXT' => 'ist leer',
    'LANG_ERROR_SLIDER_CANT_BE_DISPLAYED_TEXT' => 'Slider can\'t be displayed',
    'LANG_CUSTOMER_DETAILS_NOT_FOUND_ERROR_TEXT' => 'Es wurde kein Kunde mit den angegebenen Informationen gefunden. Bitte erstellen Sie einen neuen Account.',
    'LANG_ERROR_CUSTOMER_DETAILS_NO_ERROR_TEXT' => 'keine Fehler',
    'LANG_CUSTOMER_EXCEEDED_LOOKUP_ATTEMPTS_ERROR_TEXT' => 'Sie haben die Anzahl von möglichen Anfragen überschritten. Bitte tragen Sie ihre Kundeninformationen manuell in das Formular ein.',
    'LANG_ERROR_ORDER_DOES_NOT_EXIST_TEXT' => 'existiert nicht',
    'LANG_ITEM_MODELS_PLEASE_SELECT_AT_LEAST_ONE_ITEM_MODEL_ERROR_TEXT' => 'Bitte wählen Sie mindestens ein Fahrzeug',
    'LANG_ITEMS_PLEASE_SELECT_AT_LEAST_ONE_ITEM_ERROR_TEXT' => 'Bitte wählen Sie mindestens ein Fahrzeug',
    'LANG_ERROR_SEARCH_ENGINE_DISABLED_TEXT' => 'Das Online Buchungssystem ist zur Zeit deaktiviert. Bitte versuchen Sie es später nochmal.',
    'LANG_SEARCH_OUT_BEFORE_IN_ERROR_TEXT' => 'Das Rückgabedatum muss nach dem Abholdatum sein. Bitte wählen Sie ein gültiges Abhol- und Rückgabedatum.',
    'LANG_SEARCH_MINIMUM_DURATION_CANT_BE_LESS_THAN_S_ERROR_TEXT' => 'Das Minimum der Anzahl Nächte darf nicht kleiner sein als %s.',
    'LANG_SEARCH_ERROR_PLEASE_MODIFY_YOUR_SEARCH_CRITERIA_TEXT' => 'Bitte ändern Sie ihre Suchkriterien.',
    'LANG_ERROR_PICKUP_IS_NOT_POSSIBLE_ON_TEXT' => 'Die Abholung ist nicht möglich am',
    'LANG_ERROR_PLEASE_MODIFY_YOUR_PICKUP_TIME_BY_WEBSITE_TIME_TEXT' => 'Bitte ändern Sie das Abholdatum &amp; Zeit gemäss des aktuellen Datum &amp; Zeit des Mietstandorts.',
    'LANG_ERROR_CURRENT_DATE_TIME_TEXT' => 'Das aktuelle Datum &amp; Uhrzeit des Standorts ist',
    'LANG_ERROR_EARLIEST_POSSIBLE_PICKUP_DATE_TIME_TEXT' => 'Das nächstmögliche Abholdatum &amp; Zeit ist',
    'LANG_ERROR_OR_NEXT_BUSINESS_HOURS_OF_PICKUP_LOCATION_TEXT' => 'oder der nächstmögliche Zeitpunkt, wenn die gewählte Filiale geöffnet ist',
    'LANG_ERROR_PICKUP_DATE_CANT_BE_LESS_THAN_RETURN_DATE_TEXT' => 'Abholdatum &amp; Zeit darf nicht früher sein als das Rückgabedatum & Zeit. Bitte wählen Sie gültiges Datum & Zeit für die Abholung & Rückgabe',
    'LANG_ERROR_PICKUP_LOCATION_IS_CLOSED_AT_THIS_DATE_TEXT' => 'Abholort %s an der Adresse %s ist zum gewählten Zeitpunkt geschlossen (%s).',
    'LANG_ERROR_PICKUP_LOCATION_IS_CLOSED_AT_THIS_TIME_TEXT' => 'Abholort %s an der Adresse %s ist zum gewählten Zeitpunkt geschlossen (%s).',
    'LANG_ERROR_RETURN_LOCATION_IS_CLOSED_AT_THIS_DATE_TEXT' => 'Rückgabeort %s an der Adresse %s ist zum gewählten Zeitpunkt geschlossen (%s).',
    'LANG_ERROR_RETURN_LOCATION_IS_CLOSED_AT_THIS_TIME_TEXT' => 'Rückgabeort %s an der Adresse %s ist zum gewählten Zeitpunkt geschlossen (%s).',
    'LANG_ERROR_AFTERHOURS_PICKUP_LOCATION_IS_CLOSED_AT_THIS_TIME_TEXT' => 'Abholort ausserhalb der Öffnungszeiten ist %s an der Adresse %s aber dieser Standort ist zur gewählten Zeit auch geschlossen.',
    'LANG_ERROR_AFTERHOURS_RETURN_LOCATION_IS_CLOSED_AT_THIS_TIME_TEXT' => 'Rückgabeort ausserhalb der Öffnungszeiten ist %s an der Adresse %s aber dieser Standort ist zur gewählten Zeit auch geschlossen.',
    'LANG_ERROR_LOCATION_OPEN_HOURS_ARE_TEXT' => 'Die Öffnungszeiten dieser Filiale am %s, %s sind %s.',
    'LANG_ERROR_LOCATION_WEEKLY_OPEN_HOURS_ARE_TEXT' => 'Die Öffnungszeiten dieser Filiale unter der Woche sind:',
    'LANG_ERROR_AFTERHOURS_PICKUP_LOCATION_OPEN_HOURS_ARE_TEXT' => 'Abholzeiten ausserhalb der regulären Öffnungszeiten sind %s.',
    'LANG_ERROR_AFTERHOURS_RETURN_LOCATION_OPEN_HOURS_ARE_TEXT' => 'Rückgabezeiten ausserhalb der regulären Öffnungszeiten sind %s.',
    'LANG_ERROR_AFTERHOURS_PICKUP_IS_NOT_ALLOWED_AT_LOCATION_TEXT' => 'Eine Abholung ausserhalb der Öffnungszeiten ist in dieser Filiale nicht möglich.',
    'LANG_ERROR_AFTERHOURS_RETURN_IS_NOT_ALLOWED_AT_LOCATION_TEXT' => 'Eine Rückgabe ausserhalb der Öffnungszeiten ist in dieser Filiale nicht möglich.',
    'LANG_SEARCH_MAXIMUM_DURATION_CANT_BE_MORE_THAN_S_ERROR_TEXT' => 'Der maximale Buchungszeitraum beträgt %s.',
    'LANG_ORDER_INVALID_CODE_ERROR_TEXT' => 'Ungültige Buchungsnummer oder diese Buchung existiert nicht mehr.',
    'LANG_ERROR_INVALID_SECURITY_CODE_TEXT' => 'Der Sicherheitscode ist nicht gültig.',
    ...
    'LANG_ORDER_NO_S_PICKED_UP_ERROR_TEXT' => 'Die Buchung No. %s wurde bereits abgeschlossen und kann nicht mehr editiert werden.',
    'LANG_ORDER_NO_S_CANCELLED_ERROR_TEXT' => 'Die Buchung No. %s wurde storniert.',
    'LANG_ORDER_NO_S_REFUNDED_ERROR_TEXT' => 'Die Buchung No. %s wurde bereits Rückerstattet und steht nicht mehr zur Verfügung.',
    'LANG_ERROR_PAYMENT_METHOD_IS_NOT_YET_IMPLEMENTED_TEXT' => 'Fehler: Sie haben versucht mit einer Bezahlmethode zu bezahlen die in diesem System nicht verfügbar ist.',
    ...
    'LANG_PAYMENT_METHOD_DEFAULT_PAYPAL_DESCRIPTION_TEXT' => 'Sichere Sofortbezahlung',
    'LANG_PAYMENT_METHOD_DEFAULT_STRIPE_TEXT' => 'Credit Card (via Stripe.com)',
    'LANG_PAYMENT_METHOD_DEFAULT_BANK_TEXT' => 'Banküberweisung',
    'LANG_PAYMENT_METHOD_DEFAULT_BANK_DETAILS_TEXT' => 'Ihre Bank Details',
    'LANG_PAYMENT_METHOD_DEFAULT_PAY_OVER_THE_PHONE_TEXT' => 'Pay over the Phone',
    'LANG_PAYMENT_METHOD_DEFAULT_PAY_ON_ARRIVAL_TEXT' => 'Bezahlung bei Fahrzeugübernahme',
    'LANG_PAYMENT_METHOD_DEFAULT_PAY_ON_ARRIVAL_DETAILS_TEXT' => 'Kreditkarte wird benötigt',
    'LANG_EMAIL_DEFAULT_DEAR_TEXT' => 'Lieber',
    'LANG_EMAIL_DEFAULT_REGARDS_TEXT' => 'Grüsse',
    'LANG_EMAIL_DEFAULT_TITLE_ORDER_DETAILS_TEXT' => 'Details zur Reservation - no. [RESERVATION_CODE]',
    'LANG_EMAIL_DEFAULT_TITLE_ORDER_CONFIRMED_TEXT' => 'Reservation no. [RESERVATION_CODE] - bestätigt',
    'LANG_EMAIL_DEFAULT_TITLE_ORDER_CANCELLED_TEXT' => 'Reservation no. [RESERVATION_CODE] - abgebrochen',
    'LANG_EMAIL_DEFAULT_ADM_TITLE_ORDER_DETAILS_TEXT' => 'Benachrichtigung: neue Reservierung - [RESERVATION_CODE]',
    'LANG_EMAIL_DEFAULT_ADM_TITLE_ORDER_CONFIRMED_TEXT' => 'Benachrichtigung: Reservierung bezahlt - [RESERVATION_CODE]',
    'LANG_EMAIL_DEFAULT_ADM_TITLE_ORDER_CANCELLED_TEXT' => 'Benachrichtigung: Reservierung abgebrochen - [RESERVATION_CODE]',
    'LANG_EMAIL_DEFAULT_BODY_ORDER_RECEIVED_TEXT' => 'Wir haben Ihre Reservierung erhalten.',
    'LANG_EMAIL_DEFAULT_BODY_ORDER_DETAILS_TEXT' => 'Ihre Buchungsdetails:',
    'LANG_EMAIL_DEFAULT_BODY_PAYMENT_RECEIVED_TEXT' => 'Wir haben Ihre Bezahlung erhalten. Ihre Reservierung ist bestätigt.',
    'LANG_EMAIL_DEFAULT_BODY_ORDER_CANCELLED_TEXT' => 'Ihre Reservierung no. [RESERVATION_CODE] wurde abgebrochen.',
    'LANG_EMAIL_DEFAULT_ADM_BODY_ORDER_RECEIVED_TEXT' => 'Neue Reservierung no. [RESERVATION_CODE] von [CUSTOMER_NAME] erhalten.',
    'LANG_EMAIL_DEFAULT_ADM_BODY_ORDER_DETAILS_TEXT' => 'Reservierung Details:',
    'LANG_EMAIL_DEFAULT_ADM_BODY_ORDER_PAID_TEXT' => 'Reservierung no. [RESERVATION_CODE] wurde von Kunde [CUSTOMER_NAME] bezahlt.',
    'LANG_EMAIL_DEFAULT_ADM_BODY_ORDER_CANCELLED_TEXT' => 'Reservierung no. [RESERVATION_CODE] für [CUSTOMER_NAME] wurde abgebrochen.',
    'LANG_EMAIL_DEFAULT_ADM_BODY_CANCELLED_ORDER_DETAILS_TEXT' => 'Details zu den abgebrochenen Buchungen:',
    ...
    'LANG_SEARCH_PICKUP_DATE_SELECT_ERROR_TEXT' => 'Bitte wählen Sie ein Abholdatum!',
    ...
    'LANG_SEARCH_RETURN_DATE_SELECT_ERROR_TEXT' => 'Bitte wählen Sie ein Rückgabedatum!',
    ...
    'LANG_SEARCH_TRY_DIFFERENT_DATE_OR_CRITERIA_ERROR_TEXT' => 'Keine Fahrzeuge verfügbar. Bitte ändern Sie den Zeitraum oder ändern Sie die Suchkriterien.',
...
(New WP User)',
    ...
    'LANG_SETTINGS_DEFAULT_PAYMENT_CANCELLED_PAGE_TITLE_TEXT' => 'Bezahlvorgang abgebrochen',
    'LANG_SETTINGS_DEFAULT_PAYMENT_CANCELLED_PAGE_CONTENT_TEXT' => 'Der Bezahlvorgang wurde abgebrochen. Die Reservierung konnte nicht durchgeführt werden.',
    'LANG_SETTINGS_DEFAULT_ORDER_CONFIRMED_PAGE_TITLE_TEXT' => 'Reservation bestätigt',
    'LANG_SETTINGS_DEFAULT_ORDER_CONFIRMED_PAGE_CONTENT_TEXT' => 'Vielen Dank. Der Bezahlvorgang war erfolgreich. Ihre Reservierung ist bestätigt.',
    'LANG_SETTINGS_DEFAULT_TERMS_AND_CONDITIONS_PAGE_TITLE_TEXT' => 'Nutzungsbedingungen der Fahrzeugvermietung',
    ...
    'LANG_TRANSACTION_ID_TEXT' => 'Transaktionsnummer',
    'LANG_TRANSACTION_ID_EXTERNAL_ID_AND_LEGAL_COUNTRY_TEXT' => 'Transaction Id, External Id & Legal Country',
    'LANG_TRANSACTION_EXTERNAL_ID_TEXT' => 'External Transaktionsnummer',
    ...
    'LANG_TRANSACTION_PAYER_EMAIL_TEXT' => 'Kunden E-Mail',
