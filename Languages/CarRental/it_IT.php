...
return array(
    ...
    // Admin - Global
    'LANG_ORDERS_VIEW_TEXT' => 'Visualizza prenotazione',
    'LANG_ORDERS_VIEW_UNPAID_TEXT' => 'Visualizza prenotazioni non pagate',
    'LANG_ORDERS_NONE_YET_TEXT' => 'Nessuna prenotazione',
    'LANG_ORDER_DETAILS_TEXT' => 'Dettagli prenotazione',
    'LANG_CUSTOMER_DETAILS_FROM_DB_TEXT' => 'Dettagli cliente (Latest version from database)',
    'LANG_ORDER_STATUS_TEXT' => 'Stato prenotazione',
    'LANG_ORDER_STATUS_UPCOMING_TEXT' => 'Upcoming',
    'LANG_ORDER_STATUS_DEPARTED_TEXT' => 'Partita',
    'LANG_ORDER_STATUS_COMPLETED_EARLY_TEXT' => 'Completed Early',
    'LANG_ORDER_STATUS_COMPLETED_TEXT' => 'Completed',
    'LANG_ORDER_STATUS_ACTIVE_TEXT' => 'Attiva',
    'LANG_ORDER_STATUS_CANCELLED_TEXT' => 'Cancellato',
    'LANG_ORDER_STATUS_PAID_TEXT' => 'Pagato',
    'LANG_ORDER_STATUS_UNPAID_TEXT' => 'Non pagato',
    'LANG_ORDER_STATUS_REFUNDED_TEXT' => 'Rimborsato',
    'LANG_INVOICE_PRINT_TEXT' => 'Stampa fattura',
    'LANG_CUSTOMER_BACK_TO_ORDERS_LIST_TEXT' => 'Torna alla lista prenotazioni clienti',
    ...
    'LANG_PRICING_REGULAR_PRICE_TEXT' => 'Prezzo normale',
    'LANG_PRICE_TYPE_TEXT' => 'Tipo di prezzo',
    ...
    'LANG_CALENDAR_NO_CALENDARS_FOUND_TEXT' => 'Nessun calendario per le date inserite',
    'LANG_PAGE_SELECT_TEXT' => ' - Choose page - ',
    'LANG_SELECT_EMAIL_TYPE_TEXT' => '--- Selezione tipo di Email ---',
...
and when plugin is network-enabled in multisite mode',
    ...
    'LANG_ITEM_NOT_AVAILABLE_FOR_ORDERING_TEXT' => 'Questo veicolo non &egrave; disponibile for reservation.',

    // Manufacturer Element
    'LANG_MANUFACTURER_TEXT' => 'Marchio Auto',
    'LANG_MANUFACTURER_ID_TEXT' => 'Marchio Auto Id',
    'LANG_MANUFACTURER_IDS_TEXT' => 'Marchio Auto Ids',
    'LANG_MANUFACTURER_SELECT_TEXT' => 'Marchio Auto:',
    'LANG_MANUFACTURER_SELECT2_TEXT' => '- Select Marchio Auto -', // MB
    'LANG_MANUFACTURER_ADD_EDIT_TEXT' => 'Add / Edit Marchio Auto',

    // Class Element
    'LANG_CLASS_TEXT' => 'Classe',
    'LANG_CLASS_ID_TEXT' => 'Classe Id',
    'LANG_CLASS_IDS_TEXT' => 'Classe Ids',
    'LANG_CLASS_SELECT_TEXT' => 'Classe:',
    'LANG_CLASS_SELECT2_TEXT' => '- Select Classe -', // MB
    'LANG_CLASS_ADD_NEW_TEXT' => 'Add New Classe',
    'LANG_CLASS_LIST_TEXT' => 'Classe List',
    ...
    'LANG_LOCATION_STATUS_OPEN_TEXT' => 'Aperto',
    'LANG_LOCATION_STATUS_CLOSED_TEXT' => 'Chiuso',
    ...
    // Ext - Popular
    'LANG_ITEM_MODEL_TEXT' => 'Modello Auto',
    'LANG_EXTRA_TEXT' => 'Extra',
    'LANG_RENTAL_OPTION_TEXT' => 'Opzione noleggio',
    'LANG_ITEM_MODELS_TEXT' => 'Auto model',
    'LANG_ITEMS_TEXT' => 'Auto',
    'LANG_EXTRAS_TEXT' => 'Opzioni noleggio',
    'LANG_RENTAL_OPTIONS_TEXT' => 'Opzioni noleggio',
    'LANG_ITEM_MODEL_SHOW_TEXT' => 'Visualizza vettura model',
    'LANG_COUPON_TEXT' => 'Coupon',

    // Search Element
    'LANG_SEARCH_TEXT' => 'Cerca',
    'LANG_SEARCH_DEFAULT_SEARCH_PAGE_URL_SLUG_TEXT' => 'search', // Latin letters only
    'LANG_TAX_WITH_TEXT' => 'con IVA',
    'LANG_TAX_WITHOUT_TEXT' => 'privo IVA',
    'LANG_TAX_SHORT_TEXT' => 'IVA',
    'LANG_DEPOSIT_TEXT' => 'Deposito',
    'LANG_DISCOUNT_TEXT' => 'Sconto',
    'LANG_PREPAYMENT_TEXT' => 'Importo prepagato',
    'LANG_ITEM_MODELS_NONE_AVAILABLE_TEXT' => 'Nessun veicolo diponibile',
    'LANG_ITEM_MODELS_NONE_AVAILABLE_IN_THIS_CLASS_TEXT' => 'Nessun veicolo diponibile per questa classe',
    'LANG_ITEMS_NONE_AVAILABLE_TEXT' => 'Nessun veicolo diponibile',
    'LANG_ITEMS_NONE_AVAILABLE_IN_THIS_CLASS_TEXT' => 'Nessun veicolo diponibile per questa classe',
    'LANG_EXTRAS_NONE_AVAILABLE_TEXT' => 'Nessun optional diponibile',
    ...
    'LANG_ORDER_MARK_PAID_TEXT' => 'Segna come pagato',
    'LANG_ORDER_MARK_COMPLETED_EARLY_TEXT' => 'Mark Completed Early',
    'LANG_ORDER_REFUND_TEXT' => 'Rimborso pagamento',
    'LANG_LOCATION_SELECT2_TEXT' => '-- Seleziona Luogo --',
    'LANG_LOCATIONS_ALL_TEXT' => 'All Locations',
    'LANG_PRICING_DAILY_TEXT' => 'Giornaliero',
    'LANG_PRICING_HOURLY_TEXT' => 'Orario',
    'LANG_PRICING_PER_ORDER2_TEXT' => 'Per prenotazione',
    'LANG_PRICING_COMBINED_DAILY_AND_HOURLY_TEXT' => 'Combinato - Giornaliero e Orario',
    'LANG_PRICING_PER_ORDER_TEXT' => 'prenotazione',
    ...
    'LANG_PRICING_PER_DAY_TEXT' => 'giorno',
    'LANG_PRICING_PER_DAY_SHORT_TEXT' => 'g.',
    'LANG_PRICING_PER_NIGHT_TEXT' => 'night',
    'LANG_PRICING_PER_NIGHT_SHORT_TEXT' => 'n.',
    'LANG_PRICING_PER_HOUR_TEXT' => 'ora',
    ...
    'LANG_ORDER_TEXT' => 'Prenotazione',
    'LANG_PICKUP_TEXT' => 'Ritiro',
    'LANG_RETURN_TEXT' => 'Consegna',
    'LANG_INFORMATION_TEXT' => 'Informazioni',
    'LANG_CITY_AND_LOCATION_TEXT' => 'Città e Luogo:',
    'LANG_SEARCH_PICKUP_CITY_AND_LOCATION_SELECT_TEXT' => 'Città e Luogo per il ritiro:',
    'LANG_SEARCH_PICKUP_CITY_AND_LOCATION_SELECT2_TEXT' => '- Città e Luogo per il ritiro -', // MB
    'LANG_SEARCH_RETURN_CITY_AND_LOCATION_SELECT_TEXT' => 'Città e Luogo per la riconsegna:',
    'LANG_SEARCH_RETURN_CITY_AND_LOCATION_SELECT2_TEXT' => '- Città e Luogo per la riconsegna -', // MB
    'LANG_ORDER_PERIOD_SELECT_TEXT' => 'Periodo di prenotazione:',
    'LANG_ORDER_PERIOD_SELECT2_TEXT' => ' - Select Period -', // MB
    'LANG_COUPON_CODE_TEXT' => 'Coupon code',
    'LANG_ORDER_CODE_INPUT_TEXT' => 'Ho un numero prenotazione:',
    'LANG_ORDER_CODE_INPUT2_TEXT' => '- Ho un numero prenotazione -', // MB
    'LANG_COUPON_CODE_INPUT_TEXT' => 'I have coupon code:',
    'LANG_COUPON_CODE_INPUT2_TEXT' => '- I have coupon code -', // MB
    'LANG_LOCATION_PICKUP_TEXT' => 'Luogo di ritiro',
    'LANG_LOCATION_RETURN_TEXT' => 'Luogo di riconsegna',
    'LANG_ALL_BODY_TYPES_DROPDOWN_TEXT' => '---- Tutti i tipi ----',
    'LANG_ALL_TRANSMISSION_TYPES_DROPDOWN_TEXT' => '---- Tutte le trasmissioni ----',
    'LANG_SELECT_PICKUP_LOCATION_TEXT' => '-- Seleziona il luogo di ritiro --',
    'LANG_SELECT_RETURN_LOCATION_TEXT' => '-- Seleziona il luogo di riconsegna --',
    'LANG_PICKUP_DATE_TEXT' => 'Data di ritiro',
    'LANG_RETURN_DATE_TEXT' => 'Data di riconsegna',
    'LANG_ORDER_NO_PERIOD_SELECTED_ERROR_TEXT' => 'Per favore inserisci la data Check Out!',
    ...
    'LANG_LOCATION_PICKUP_SELECT_ERROR_TEXT' => 'Per favore selezione il luogo del ritiro!',
    'LANG_LOCATION_RETURN_SELECT_ERROR_TEXT' => 'Per favore selezione il luogo per la riconsegna!',
    'LANG_SHOW_ITEM_DESCRIPTION_TEXT' => 'Mostra la descrizione auto',
    'LANG_ORDER_UPDATE_MY_ORDER_TEXT' => 'Aggiornare la mia prenotazione',
    'LANG_CANCEL_ORDER_TEXT' => 'Cancella la mia prenotazione',
    'LANG_ORDER_CHANGE_DATE_TIME_AND_LOCATION_TEXT' => 'Cambia data, Ora e Luogo',
    'LANG_ORDER_CHANGE_ORDERED_ITEM_MODELS_TEXT' => 'Cambia Veicolo',
    'LANG_ORDER_CHANGE_ORDERED_ITEMS_TEXT' => 'Cambia Veicolo',
    'LANG_CHANGE_EXTRAS_TEXT' => 'Cambia Opzioni',
    'LANG_CHANGE_RENTAL_OPTIONS_TEXT' => 'Opzioni di noleggio',
    'LANG_IN_THIS_LOCATION_TEXT' => 'In questa filiale',
    'LANG_AFTERHOURS_PICKUP_IS_NOT_ALLOWED_TEXT' => 'Non consentito',
    'LANG_AFTERHOURS_RETURN_IS_NOT_ALLOWED_TEXT' => 'Not consentito',

    // Search step no. 3 - search results
    'LANG_DISTANCE_AWAY_TEXT' => '%s away',
    'LANG_ORDER_DATA_TEXT' => 'Dettagli prenotazione',
    'LANG_ORDER_CODE_TEXT' => 'Prenotazione n.',
    'LANG_ORDER_CODE2_TEXT' => 'Prenotazione n.', // Uppercase lowercase
    'LANG_ORDER_EDIT_TEXT' => 'modifica',
    'LANG_ORDER_VIEW_DETAILS_TEXT' => 'View Reservation Details',
    'LANG_ORDER_PICKUP_TEXT' => 'Ritiro',
    'LANG_ORDER_BUSINESS_HOURS_TEXT' => 'Orario di lavoro',
    'LANG_ORDER_FEE_TEXT' => 'Tassa',
    'LANG_ORDER_RETURN_TEXT' => 'Restituzione',
    'LANG_ORDER_NIGHTLY_RATE_TEXT' => 'dopo ore',
    'LANG_ORDER_AFTERHOURS_TEXT' => 'dopo ore',
    'LANG_ORDER_EARLY_TEXT' => 'Early',
    'LANG_ORDER_LATE_TEXT' => 'Late',
    'LANG_ORDER_AFTERHOURS_PICKUP_TEXT' => 'Ritiro fuori orario',
    'LANG_ORDER_AFTERHOURS_PICKUP_IMPOSSIBLE_TEXT' => 'Impossibile',
    'LANG_ORDER_AFTERHOURS_RETURN_TEXT' => 'Restituzione fuori orario',
    'LANG_ORDER_AFTERHOURS_RETURN_IMPOSSIBLE_TEXT' => 'Impossibile',
    'LANG_SEARCH_RESULTS_TEXT' => 'Risultati ricerca',

    // Search step no. 6 - booking options
    'LANG_SELECT_RENTAL_OPTIONS_TEXT' => 'Scegli gli optional',
    'LANG_SELECTED_ITEMS_TEXT' => 'Veicolo selezionato',
    'LANG_FOR_DEPENDANT_ITEM_TEXT' => ' (for %s)',
    'LANG_NO_EXTRAS_AVAILABLE_CLICK_CONTINUE_TEXT' => 'Non sono diponibili altri optional. Clicca sul pulsante continua',

    // Search step no. 5 - booking details
    'LANG_PICKUP_DATE_AND_TIME_TEXT' => 'Data e ora per il ritiro',
    'LANG_RETURN_DATE_AND_TIME_TEXT' => 'Data e ora per la riconsegna',
    'LANG_UNIT_PRICE_TEXT' => 'Prezzo unità',
    'LANG_LOCATION_PICKUP_FEE_TEXT' => 'Spesa ritiro',
    'LANG_LOCATION_PICKUP_FEE2_TEXT' => 'Spesa ritiro', // Uppercase lowercase
    'LANG_LOCATION_RETURN_FEE_TEXT' => 'Spesa restituzione',
    'LANG_LOCATION_RETURN_FEE2_TEXT' => 'Spesa restituzione', // Uppercase lowercase
    'LANG_LOCATION_NIGHTLY_RATE_APPLIED_TEXT' => '(Prezzo notturno applicato)',
    'LANG_ITEMS_QUANTITY_SUFFIX_TEXT' => 'veicolo(i)',
    'LANG_EXTRAS_QUANTITY_SUFFIX_TEXT' => 'extra(s)',
    'LANG_PAY_NOW_OR_AT_PICKUP_TEXT' => 'Paga ora / al ritiro',
    'LANG_PAYMENT_PAY_NOW_TEXT' => 'Paga ora',
    'LANG_PAYMENT_PAY_AT_PICKUP_TEXT' => 'Paga al ritiro',
    ...
    'LANG_ORDER_RENTAL_DETAILS_TEXT' => 'Dettagli del noleggio',
    'LANG_PAYMENT_GROSS_TOTAL_TEXT' => 'Subtotale',
    'LANG_PAYMENT_GRAND_TOTAL_TEXT' => 'Totale',
    'LANG_CUSTOMER_DETAILS_TEXT' => 'Dettaglio clienti',
    'LANG_CUSTOMER_SEARCH_FOR_EXISTING_TEXT' => 'Dettagli cliente esistente',
    'LANG_CUSTOMER_EXISTING_TEXT' => 'Cliente esistente',
    ...
    'LANG_CUSTOMER_FETCH_DETAILS_TEXT' => 'Dettagli consegna',
    'LANG_CUSTOMER_OR_ENTER_DETAILS_TEXT' => 'O',
    'LANG_CUSTOMER_TEXT' => 'Cliente',
    'LANG_CUSTOMER_SELECT_TEXT' => 'Select Customer',
    'LANG_CITY_TEXT' => 'Città ',
    'LANG_STATE_TEXT' => 'Stato',
    'LANG_COUNTRY_TEXT' => 'Città ',
    'LANG_ADDITIONAL_COMMENTS_TEXT' => 'Note',
    'LANG_CUSTOMER_ID_TEXT' => 'ID Cliente',
    ...
    'LANG_PAYMENT_PAY_BY_SHORT_TEXT' => 'Pagamento',
    'LANG_SEARCH_I_AGREE_WITH_TERMS_AND_CONDITIONS_TEXT' => 'Accetto i termini e condizioni',
    'LANG_TERMS_AND_CONDITIONS_TEXT' => 'Termini e condizioni',
    'LANG_FIELD_REQUIRED_TEXT' => 'Questo campo &egrave; richiesto',

    // Search step no. 6 - process booking
    'LANG_PAYMENT_DETAILS_TEXT' => 'Dettagli pagamento',
    'LANG_PAYMENT_OPTION_TEXT' => 'Opzioni pagamento',
    'LANG_PAYMENT_PROCESSING_TEXT' => 'Elaboro il Pagamento...',
    'LANG_ORDER_PLEASE_WAIT_UNTIL_WILL_BE_PROCESSED_TEXT' => 'Attendere prego, il vostro ordine verrà elaborato...',

    // display-booking-confirm.php
    'LANG_STEP5_PAY_ONLINE_TEXT' => 'pagato online',
    'LANG_STEP5_PAY_AT_PICKUP_TEXT' => 'Paga al ritiro',
    'LANG_ORDER_RECEIVED_YOUR_CODE_S_TEXT' => 'La ta prenotazione &egrave; confermata. Prenotazione n. %s.',
    'LANG_ORDER_CONFIRMED_YOUR_CODE_S_TEXT' => 'La ta prenotazione &egrave; confermata. Prenotazione n. %s.',
    'LANG_ORDER_UPDATED_YOUR_CODE_S_TEXT' => 'La ta prenotazione &egrave; confermata. Prenotazione n. %s.',
    'LANG_INVOICE_SENT_TO_YOUR_EMAIL_ADDRESS_TEXT' => 'Ricevuta inviata al tuo indirizzo e-mail',

    // display-booking-failure.php
    'LANG_ORDER_FAILURE_TEXT' => 'Prenotazione fallita',
    'LANG_SEARCH_ALL_ITEM_MODELS_TEXT' => 'Cerca tutti i veicoli',
    ...
    'LANG_DAY_PRICE_TEXT' => 'Prezzo al giorno',
    'LANG_HOUR_PRICE_TEXT' => 'Prezzo per ora',
    'LANG_NO_ITEM_MODELS_IN_THIS_CATEGORY_TEXT' => 'Non abbiamo veicoli in questa categoria',
    'LANG_PRICE_FOR_DAY_FROM_TEXT' => 'Prezzo per un giorno a partire da',
    'LANG_PRICE_FOR_HOUR_FROM_TEXT' => 'Prezzo per un ora a partire da',
    'LANG_PRICE_WITH_APPLIED_TEXT' => 'con applicato',
    'LANG_WITH_APPLIED_DISCOUNT_TEXT' => 'sconto',

    // class.ItemsAvailability.php
    'LANG_MONTH_DAY_TEXT' => 'Giorno',
    'LANG_MONTH_DAYS_TEXT' => 'Days',
    'LANG_ITEMS_AVAILABILITY_FOR_TEXT' => 'Disponibilità veicoli',
    ...
    'LANG_ITEMS_AVAILABILITY_THIS_MONTH_TEXT' => 'Disponibilità veicoli questo mese',
    'LANG_ITEMS_AVAILABILITY_NEXT_MONTH_TEXT' => 'Disponibilità veicoli prossimo mese',
    'LANG_ITEM_MODEL_ID_TEXT' => 'ID:',
    'LANG_TOTAL_ITEMS_TEXT' => 'Veicoli totali:',

    // class.ExtrasAvailability.php
    'LANG_EXTRAS_AVAILABILITY_FOR_TEXT' => 'Disponibilità Extra per',
    ...
    'LANG_EXTRAS_AVAILABILITY_THIS_MONTH_TEXT' => 'Disponibilità Extra questo mese',
    'LANG_EXTRAS_AVAILABILITY_NEXT_MONTH_TEXT' => 'Disponibilità Extra prossimo mese',
    'LANG_EXTRA_ID_TEXT' => 'ID',
    'LANG_TOTAL_EXTRAS_TEXT' => 'Extra totali:',

    // class.ItemModelsController.php
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME1_TEXT' => 'Benzina',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL1_TEXT' => 'Benzina',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME2_TEXT' => 'Cambio',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL2_TEXT' => 'Cambio',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME3_TEXT' => 'Consumo',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL3_TEXT' => 'Consumo',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME4_TEXT' => 'Capacità passeggeri',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL4_TEXT' => 'Capacità passeggeri',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME5_TEXT' => 'Cilindrata',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL5_TEXT' => 'Cilindrata',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME6_TEXT' => 'Bagagli Max',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL6_TEXT' => 'Bagagli Max',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME7_TEXT' => 'Sportelli',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL7_TEXT' => 'Sportelli',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_NAME8_TEXT' => 'Chilometraggio',
    'LANG_ATTRIBUTE_GROUP_DEFAULT_LABEL8_TEXT' => 'Chilometraggio',
    'LANG_PRICING_PRICE_FROM_TEXT' => 'Prezzo da',
    'LANG_PRICING_INQUIRE_TEXT' => 'Call',
    'LANG_PRICING_GET_A_QUOTE_TEXT' => 'Get a quote',
    'LANG_FEATURES_TEXT' => 'Caratteristiche',
    'LANG_PRICING_GET_IT_TEXT' => 'Prenota',

    // class.LocationsController.php
    'LANG_LOCATIONS_BUSINESS_HOURS_TEXT' => 'Business Hours',
    'LANG_LOCATION_FEES_TEXT' => 'Spese per il luogo',
    ...
    'LANG_ITEM_MODEL_MINIMUM_ALLOWED_AGE_TEXT' => 'Età minima per la guida',
    'LANG_ITEM_MODEL_MAXIMUM_ALLOWED_AGE_TEXT' => 'Maximum Driver Age',
    'LANG_ITEM_MODEL_MIN_ALLOWED_AGE_TEXT' => 'Età minima per la guida',
    ...
    'LANG_ITEM_MODEL_ADDITIONAL_INFORMATION_TEXT' => 'Informazioni aggiuntive',
    ...
    'LANG_ITEM_MODEL_VISIT_PAGE_TEXT' => 'Visualizza la descrizione veicolo',
    ...
    'LANG_ORDER_S_CANCELLED_SUCCESSFULLY_TEXT' => 'La prenotazione %s cancellata con successo.',
    'LANG_ORDER_NOT_CANCELLED_CODE_S_DOES_NOT_EXIST_TEXT' => 'La prenotazione non &egrave; stata cancellata. Reservation code %s - does not exist.',

    // template.Step8EditBooking.php
    'LANG_SEARCH_CHANGE_ORDER_TEXT' => 'prenotazione
prenotazione',
    'LANG_SEARCH_CHANGE_ORDER2_TEXT' => 'Modifica prenotazione',
    'LANG_ORDER_NO_CODE_ERROR_TEXT' => 'Per favore inserisci il numero prenotazione!',

    // Errors
    'LANG_ERROR_REQUIRED_FIELD_TEXT' => 'Campo richiesto',
    'LANG_ERROR_IS_EMPTY_TEXT' => '&egrave; vuoto',
    'LANG_ERROR_SLIDER_CANT_BE_DISPLAYED_TEXT' => 'Slider can\'t be displayed',
    'LANG_CUSTOMER_DETAILS_NOT_FOUND_ERROR_TEXT' => 'Dettagli non trovati. Per favore iscriviti',
    'LANG_ERROR_CUSTOMER_DETAILS_NO_ERROR_TEXT' => 'Nessun errore',
    ...
    'LANG_ERROR_ORDER_DOES_NOT_EXIST_TEXT' => 'non esiste',
    'LANG_ITEM_MODELS_PLEASE_SELECT_AT_LEAST_ONE_ITEM_MODEL_ERROR_TEXT' => 'Per favore seleziona almeno una vettura',
    'LANG_ITEMS_PLEASE_SELECT_AT_LEAST_ONE_ITEM_ERROR_TEXT' => 'Per favore seleziona almeno una vettura',
    'LANG_ERROR_SEARCH_ENGINE_DISABLED_TEXT' => 'Prenotazione online al momento non disponibile. Per favore prova più tardi.',
    'LANG_SEARCH_OUT_BEFORE_IN_ERROR_TEXT' => 'Hai inserito in criterio di ricerca non corretto. Per favore riprova con criteri di ricerca validi.',
    'LANG_SEARCH_MINIMUM_DURATION_CANT_BE_LESS_THAN_S_ERROR_TEXT' => 'Il numero minimo di notti non deve essere inferiore a %s.',
    'LANG_SEARCH_ERROR_PLEASE_MODIFY_YOUR_SEARCH_CRITERIA_TEXT' => 'Si prega di modificare i criteri di ricerca.',
    'LANG_ERROR_PICKUP_IS_NOT_POSSIBLE_ON_TEXT' => 'Prenotazione non possibile per la data di arrivo:',
    'LANG_ERROR_PLEASE_MODIFY_YOUR_PICKUP_TIME_BY_WEBSITE_TIME_TEXT' => 'Si prega di modificare i criteri di ricerca in base alla prenotazione, posizione, data corrente e ora.',
    'LANG_ERROR_CURRENT_DATE_TIME_TEXT' => 'Luogo di prenotazione corrente, data e ora:',
    'LANG_ERROR_EARLIEST_POSSIBLE_PICKUP_DATE_TIME_TEXT' => 'La prima data utile per il ritiro &egrave;',
    ...
    'LANG_ERROR_PICKUP_DATE_CANT_BE_LESS_THAN_RETURN_DATE_TEXT' => 'La data di ritiro e l&rsquo;ora non possono essere inferiori alla data e ora per la restituzione. Per favore selezione una data e ora corretta per il ritiro e la restituzione',
    'LANG_ERROR_PICKUP_LOCATION_IS_CLOSED_AT_THIS_DATE_TEXT' => 'Il ritiro presso questa filiale %s a questo indirizzo %s &egrave; chiuso in questo Data (%s).',
    'LANG_ERROR_PICKUP_LOCATION_IS_CLOSED_AT_THIS_TIME_TEXT' => 'Il ritiro presso questa filiale %s a questo indirizzo %s &egrave; chiuso in questo momento (%s).',
    'LANG_ERROR_RETURN_LOCATION_IS_CLOSED_AT_THIS_DATE_TEXT' => 'La restituzione presso questa filiale %s a questo indirizzo %s &egrave; chiusa in questo data (%s).',
    'LANG_ERROR_RETURN_LOCATION_IS_CLOSED_AT_THIS_TIME_TEXT' => 'La restituzione presso questa filiale %s a questo indirizzo %s &egrave; chiusa in questo momento (%s).',
    'LANG_ERROR_AFTERHOURS_PICKUP_LOCATION_IS_CLOSED_AT_THIS_TIME_TEXT' => 'Il ritiro presso questa filiale %s all&rsquo; indirizzo %s ma questa filiale &egrave; chiusa in questo momento.',
    'LANG_ERROR_AFTERHOURS_RETURN_LOCATION_IS_CLOSED_AT_THIS_TIME_TEXT' => 'La restituzione presso questa filiale %s all&rsquo; indirizzo %s ma questa filiale &egrave; chiusa in questo momento.',
    'LANG_ERROR_LOCATION_OPEN_HOURS_ARE_TEXT' => 'Gli orari di apertura di questa filiale los %s, %s sono %s.',
    'LANG_ERROR_LOCATION_WEEKLY_OPEN_HOURS_ARE_TEXT' => 'This location open hours during the week are:',
    'LANG_ERROR_AFTERHOURS_PICKUP_LOCATION_OPEN_HOURS_ARE_TEXT' => 'Gli orari per il ritiro fuori orario di questa filiale sono %s.',
    'LANG_ERROR_AFTERHOURS_RETURN_LOCATION_OPEN_HOURS_ARE_TEXT' => 'Gli orari per il ritirola restituzione fuori orario di questa filiale sono %s.',
    'LANG_ERROR_AFTERHOURS_PICKUP_IS_NOT_ALLOWED_AT_LOCATION_TEXT' => 'Il ritiro fuori orario non &egrave; possibile in questo luogo.',
    'LANG_ERROR_AFTERHOURS_RETURN_IS_NOT_ALLOWED_AT_LOCATION_TEXT' => 'La restituzione fuori orario non &egrave; possibile in questo luogo.',
    'LANG_SEARCH_MAXIMUM_DURATION_CANT_BE_MORE_THAN_S_ERROR_TEXT' => 'La durata massima della prenotazione non può essere più lunga di %s.',
    'LANG_ORDER_INVALID_CODE_ERROR_TEXT' => 'Codice prenotazione errato oppure questa prenotazione non esiste.',
    ...
    'LANG_ORDER_NO_S_PICKED_UP_ERROR_TEXT' => 'Prenotazione No. %s già contrassegnata come partito, e non &egrave; disponibile per ulteriori modifiche.',
    'LANG_ORDER_NO_S_CANCELLED_ERROR_TEXT' => 'Prenotazione No. %s &egrave; stata cancellata.',
    'LANG_ORDER_NO_S_REFUNDED_ERROR_TEXT' => 'Prenotazione No. %s &egrave; stata già rimborsata e non è pi&ugrave; disponibile.',
    'LANG_ERROR_PAYMENT_METHOD_IS_NOT_YET_IMPLEMENTED_TEXT' => 'Errore: Stai provando a pagara con un metodo non disponibile per il sistema.',
    'LANG_ORDER_OTHER_ERROR_TEXT' => 'Altro errore prenotazione. Se continui a vedere questo messaggio, contattare l&rsquo;amministratore del sito.',
    ...
    'LANG_PAYMENT_METHOD_DEFAULT_BANK_TEXT' => 'Bonifico bancario',
    'LANG_PAYMENT_METHOD_DEFAULT_BANK_DETAILS_TEXT' => 'I tuoi dettagli bancari',
    'LANG_PAYMENT_METHOD_DEFAULT_PAY_OVER_THE_PHONE_TEXT' => 'Paga via telefono',
    'LANG_PAYMENT_METHOD_DEFAULT_PAY_ON_ARRIVAL_TEXT' => 'Paga al ritiro',
    'LANG_PAYMENT_METHOD_DEFAULT_PAY_ON_ARRIVAL_DETAILS_TEXT' => 'Carta di credito richiesta',
    'LANG_EMAIL_DEFAULT_DEAR_TEXT' => 'Caro',
    'LANG_EMAIL_DEFAULT_REGARDS_TEXT' => 'Saluti',
    ...
    'LANG_SEARCH_PICKUP_DATE_SELECT_ERROR_TEXT' => 'Per favore inserisci la data di ritiro!',
    ...
    'LANG_SEARCH_RETURN_DATE_SELECT_ERROR_TEXT' => 'Per favore inserisci la data riconsegna!',
    ...
    'LANG_SEARCH_TRY_DIFFERENT_DATE_OR_CRITERIA_ERROR_TEXT' => 'Nessuna vettura disponibile. Per favore prova una data diversa o modifica i criteri di ricerca.',
...
(New WP User)',
    ...
    'LANG_SETTINGS_DEFAULT_TERMS_AND_CONDITIONS_PAGE_TITLE_TEXT' => 'Termini di utilizzo per il noleggio auto',
    'LANG_SETTINGS_DEFAULT_TERMS_AND_CONDITIONS_PAGE_CONTENT_TEXT' => 'È necessario seguire le linee guida e i termini per il noleggio.',
    ...
    'LANG_TRANSACTION_ID_TEXT' => 'ID transazione',
    'LANG_TRANSACTION_ID_EXTERNAL_ID_AND_LEGAL_COUNTRY_TEXT' => 'Transaction Id, External Id & Legal Country',
    'LANG_TRANSACTION_EXTERNAL_ID_TEXT' => 'External ID transazione',
    ...
    'LANG_TRANSACTION_PAYER_EMAIL_TEXT' => 'E-mail pagatore',
