...
final class ItemModelsAvailabilityResultsController extends AbstractController
{
    ...
    public function printContent()
    {
        ...
        $arrItemModelsAvailabilityCalendars = array();
        for($localMonthDiff = 0; $localMonthDiff <= $localTotalMonths; $localMonthDiff++)
        {
            ...
            $arrItemModelsAvailabilityCalendars[] = $objItemModelsAvailabilityCalendar->getMonthlyCalendar(-1, -1, -1, -1, -1, -1, -1, -1, $localSelectedYear, $localSelectedMonth);
        }
        // Calendar table: End

        // Set the view variables
        $this->view->backToCurrentAvailabilityURL = 'admin.php?page='.$this->conf->getExtURL_Prefix().'order-manager&tab=item-models-availability';
        ...
        $this->view->arrItemModelsAvailabilityCalendars = $arrItemModelsAvailabilityCalendars;

        // Print the template
        $templateRelPathAndFileName = 'Order'.DIRECTORY_SEPARATOR.'ItemModelsAvailabilitySearchResultsTabs.php';
